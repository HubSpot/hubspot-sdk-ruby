    ...
    class Cms
      class MediaBridge
        class Events
          ...
          #
          # @param media_type [Symbol, HubspotSDK::Models::Cms::MediaBridge::EventCreateAttentionSpanEventParams::MediaType]
          ...
          # @param derived_values [HubspotSDK::Models::Cms::MediaBridge::EventCreateAttentionSpanEventParams::DerivedValues]
          ...
          #
          # @return [HubspotSDK::Models::Cms::MediaBridge::EventCreateAttentionSpanEventResponse]
          #
          ...
          def create_attention_span_event(params)
            ...
            @client.request(
              ...
              body: parsed,
              model: HubspotSDK::Models::Cms::MediaBridge::EventCreateAttentionSpanEventResponse,
              options: options
            )
          end
          ...
          #
          # @param media_type [Symbol, HubspotSDK::Models::Cms::MediaBridge::EventCreateMediaPlayedEventParams::MediaType]
          # @param occurred_timestamp [Integer]
          # @param session_id [String]
          # @param state [Symbol, HubspotSDK::Models::Cms::MediaBridge::EventCreateMediaPlayedEventParams::State]
          # @param _hsenc [String]
          # @param contact_id [Integer]
          # @param contact_utk [String]
          # @param external_id [String]
          ...
          # @param request_options [HubspotSDK::RequestOptions, Hash{Symbol=>Object}, nil]
          #
          # @return [HubspotSDK::Models::Cms::MediaBridge::EventCreateMediaPlayedEventResponse]
          #
          ...
          def create_media_played_event(params)
            ...
            @client.request(
              ...
              body: parsed,
              model: HubspotSDK::Models::Cms::MediaBridge::EventCreateMediaPlayedEventResponse,
              options: options
            )
          end
          ...
          # @param request_options [HubspotSDK::RequestOptions, Hash{Symbol=>Object}, nil]
          #
          # @return [HubspotSDK::Models::Cms::MediaBridge::EventCreateMediaPlayedPercentEventResponse]
          #
          ...
          def create_media_played_percent_event(params)
            ...
            @client.request(
              ...
              body: parsed,
              model: HubspotSDK::Models::Cms::MediaBridge::EventCreateMediaPlayedPercentEventResponse,
              options: options
            )
          end
