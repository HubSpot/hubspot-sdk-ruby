...
module HubSpotSDK
  module Resources
    class Cms
      class Pages
        class SitePages
          # @return [HubSpotSDK::Resources::Cms::Pages::SitePages::AbTest]
          attr_reader :ab_test

          # @return [HubSpotSDK::Resources::Cms::Pages::SitePages::Batch]
          attr_reader :batch

          # @return [HubSpotSDK::Resources::Cms::Pages::SitePages::Draft]
          attr_reader :draft

          # @return [HubSpotSDK::Resources::Cms::Pages::SitePages::MultiLanguage]
          attr_reader :multi_language

          # @return [HubSpotSDK::Resources::Cms::Pages::SitePages::Revisions]
