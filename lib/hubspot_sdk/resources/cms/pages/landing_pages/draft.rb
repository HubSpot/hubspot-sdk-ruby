      ...
      class Pages
        class LandingPages
          class Draft
            ...
            # {HubSpotSDK::Models::Cms::Pages::LandingPages::DraftUpdateParams} for more
            # details.
            #
            ...
            #
            # @see HubSpotSDK::Models::Cms::Pages::LandingPages::DraftUpdateParams
            def update(object_id_, params)
              parsed, options = HubSpotSDK::Cms::Pages::LandingPages::DraftUpdateParams.dump_request(params)
              @client.request(
                method: :patch,
            ...
            # Some parameter documentations has been truncated, see
            # {HubSpotSDK::Models::Cms::Pages::LandingPages::DraftGetParams} for more details.
            #
            ...
            # @return [HubSpotSDK::Models::Cms::PagesPage]
            #
            # @see HubSpotSDK::Models::Cms::Pages::LandingPages::DraftGetParams
            ...
            # @return [nil]
            #
            # @see HubSpotSDK::Models::Cms::Pages::LandingPages::DraftPushLiveParams
            ...
            #
            # @overload reset(object_id_, request_options: {})
            #
            ...
            # @return [nil]
            #
            # @see HubSpotSDK::Models::Cms::Pages::LandingPages::DraftResetParams
            def reset(object_id_, params = {})
              @client.request(
                method: :post,
