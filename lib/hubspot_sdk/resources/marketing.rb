...
module HubspotSDK
  module Resources
    class Marketing
      ...
      # @return [HubspotSDK::Resources::Marketing::Forms]
      attr_reader :forms

      # @return [HubspotSDK::Resources::Marketing::SingleSend]
      attr_reader :single_send

      # @return [HubspotSDK::Resources::Marketing::Subscriptions]
      ...
      def initialize(client:)
        ...
        @forms = HubspotSDK::Resources::Marketing::Forms.new(client: client)
        @single_send = HubspotSDK::Resources::Marketing::SingleSend.new(client: client)
        @subscriptions = HubspotSDK::Resources::Marketing::Subscriptions.new(client: client)
