    ...
    class Marketing
      class MarketingEvents
        class Participations
          ...
          # {HubSpotSDK::Models::Marketing::MarketingEvents::ParticipationGetByExternalAccountAndEventIDParams}
          # for more details.
          #
          ...
          #
          # @see HubSpotSDK::Models::Marketing::MarketingEvents::ParticipationGetByExternalAccountAndEventIDParams
          ...
          # @return [HubSpotSDK::Models::Marketing::AttendanceCounters]
          #
          # @see HubSpotSDK::Models::Marketing::MarketingEvents::ParticipationGetByIDParams
          ...
          #
          # @see HubSpotSDK::Models::Marketing::MarketingEvents::ParticipationListBreakdownByContactParams
          ...
          # @return [HubSpotSDK::Internal::Page<HubSpotSDK::Models::Marketing::ParticipationBreakdown>]
          #
          # @see HubSpotSDK::Models::Marketing::MarketingEvents::ParticipationListBreakdownByExternalAccountAndEventIDParams
          ...
          # Some parameter documentations has been truncated, see
          # {HubSpotSDK::Models::Marketing::MarketingEvents::ParticipationListBreakdownByIDParams}
          # for more details.
          #
          # Read Marketing event's participations breakdown with optional filters by
          ...
          # @return [HubSpotSDK::Internal::Page<HubSpotSDK::Models::Marketing::ParticipationBreakdown>]
          #
          # @see HubSpotSDK::Models::Marketing::MarketingEvents::ParticipationListBreakdownByIDParams
