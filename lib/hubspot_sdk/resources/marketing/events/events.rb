    ...
    class Marketing
      class Events
        class Events
          ...
          #
          # @see HubspotSDK::Models::Marketing::Events::EventCancelByExternalEventIDParams
          def cancel_by_external_event_id(external_event_id, params)
            parsed, options = HubspotSDK::Marketing::Events::EventCancelByExternalEventIDParams.dump_request(params)
          ...
          # @return [HubspotSDK::Models::Marketing::MarketingEventDefaultResponse]
          #
          # @see HubspotSDK::Models::Marketing::Events::EventCompleteByExternalEventIDParams
          def complete_by_external_event_id(external_event_id, params)
            query_params = [:external_account_id]
            parsed, options =
              HubspotSDK::Marketing::Events::EventCompleteByExternalEventIDParams.dump_request(params)
