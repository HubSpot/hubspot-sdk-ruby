    ...
    class Marketing
      class Events
        class ListAssociations
          ...
          #
          # @see HubspotSDK::Models::Marketing::Events::ListAssociationListParams
          ...
          # @return [nil]
          #
          # @see HubspotSDK::Models::Marketing::Events::ListAssociationDeleteParams
          def delete(list_id, params)
            parsed, options = HubspotSDK::Marketing::Events::ListAssociationDeleteParams.dump_request(params)
            marketing_event_id =
          ...
          # @return [nil]
          #
          # @see HubspotSDK::Models::Marketing::Events::ListAssociationAssociateParams
          def associate(list_id, params)
            parsed, options = HubspotSDK::Marketing::Events::ListAssociationAssociateParams.dump_request(params)
            marketing_event_id =
              parsed.delete(:marketing_event_id) do
                raise ArgumentError.new("missing required path argument #{_1}")
              end
          ...
          # @return [nil]
          #
          # @see HubspotSDK::Models::Marketing::Events::ListAssociationAssociateByExternalAccountParams
          def associate_by_external_account(list_id, params)
            parsed, options =
              HubspotSDK::Marketing::Events::ListAssociationAssociateByExternalAccountParams.dump_request(params)
            external_account_id =
          ...
          # @return [nil]
          #
          # @see HubspotSDK::Models::Marketing::Events::ListAssociationDeleteByExternalAccountParams
          def delete_by_external_account(list_id, params)
            parsed, options =
              HubspotSDK::Marketing::Events::ListAssociationDeleteByExternalAccountParams.dump_request(params)
            external_account_id =
              parsed.delete(:external_account_id) do
                raise ArgumentError.new("missing required path argument #{_1}")
              end
          ...
          # @return [HubspotSDK::Models::Marketing::CollectionResponseWithTotalPublicList]
          #
          # @see HubspotSDK::Models::Marketing::Events::ListAssociationListByExternalAccountParams
          def list_by_external_account(external_event_id, params)
            parsed, options =
              HubspotSDK::Marketing::Events::ListAssociationListByExternalAccountParams.dump_request(params)
            external_account_id =
              parsed.delete(:external_account_id) do
                raise ArgumentError.new("missing required path argument #{_1}")
              end
