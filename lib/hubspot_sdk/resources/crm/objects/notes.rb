    ...
    class Crm
      class Objects
        class Notes
          ...
          # {HubspotSDK::Models::Crm::Objects::NoteUpdateParams} for more details.
          #
          ...
          #
          # @overload update(note_id, properties:, id_property: nil, request_options: {})
          #
          # @param note_id [String] Path param
          #
          ...
          def update(note_id, params)
            ...
            @client.request(
              method: :patch,
              path: ["crm/objects/2026-03/notes/%1$s", note_id],
          ...
          #
          # @overload delete(note_id, request_options: {})
          #
          ...
          # query param.
          #
          # @overload get(note_id, archived: nil, associations: nil, id_property: nil, properties: nil, properties_with_history: nil, request_options: {})
          #
          # @param note_id [String]
          #
          # @param archived [Boolean] Whether to return only results that have been archived.
