    ...
    class Crm
      class Objects
        class GenericObjects
          # @return [HubspotSDK::Resources::Crm::Objects::GenericObjects::Batch]
          attr_reader :batch
          ...
          #
          # @see HubspotSDK::Models::Crm::Objects::GenericObjectCreateParams
          def create(object_type, params)
            parsed, options = HubspotSDK::Crm::Objects::GenericObjectCreateParams.dump_request(params)
            @client.request(
              method: :post,
          ...
          # {HubspotSDK::Models::Crm::Objects::GenericObjectUpdateParams} for more details.
          #
          ...
          # @return [HubspotSDK::Models::Crm::SimplePublicObject]
          #
          # @see HubspotSDK::Models::Crm::Objects::GenericObjectUpdateParams
          def update(object_id_, params)
            query_params = [:id_property]
            parsed, options = HubspotSDK::Crm::Objects::GenericObjectUpdateParams.dump_request(params)
          ...
          # Some parameter documentations has been truncated, see
          # {HubspotSDK::Models::Crm::Objects::GenericObjectListParams} for more details.
          #
          ...
          #
          # @see HubspotSDK::Models::Crm::Objects::GenericObjectListParams
          def list(object_type, params = {})
            parsed, options = HubspotSDK::Crm::Objects::GenericObjectListParams.dump_request(params)
          ...
          # @return [nil]
          #
          # @see HubspotSDK::Models::Crm::Objects::GenericObjectDeleteParams
          def delete(object_id_, params)
            parsed, options = HubspotSDK::Crm::Objects::GenericObjectDeleteParams.dump_request(params)
            object_type =
              parsed.delete(:object_type) do
                raise ArgumentError.new("missing required path argument #{_1}")
              end
          ...
          # Some parameter documentations has been truncated, see
          # {HubspotSDK::Models::Crm::Objects::GenericObjectGetParams} for more details.
          #
          ...
          #
          # @see HubspotSDK::Models::Crm::Objects::GenericObjectGetParams
          def get(object_id_, params)
            parsed, options = HubspotSDK::Crm::Objects::GenericObjectGetParams.dump_request(params)
            query = HubspotSDK::Internal::Util.encode_query_params(parsed)
            object_type =
              parsed.delete(:object_type) do
                raise ArgumentError.new("missing required path argument #{_1}")
          ...
          #
          # @see HubspotSDK::Models::Crm::Objects::GenericObjectSearchParams
          def search(object_type, params)
            parsed, options = HubspotSDK::Crm::Objects::GenericObjectSearchParams.dump_request(params)
            @client.request(
              method: :post,
          ...
          def initialize(client:)
            @client = client
            @batch = HubspotSDK::Resources::Crm::Objects::GenericObjects::Batch.new(client: client)
          end
        end
      end
    end
