    ...
    class Crm
      class Objects
        class Quotes
          ...
          #
          # @see HubSpotSDK::Models::Crm::Objects::QuoteCreateParams
          def create(params)
            parsed, options = HubSpotSDK::Crm::Objects::QuoteCreateParams.dump_request(params)
            @client.request(
              method: :post,
          ...
          # {HubSpotSDK::Models::Crm::Objects::QuoteUpdateParams} for more details.
          #
          ...
          #
          # @overload update(quote_id, properties:, id_property: nil, request_options: {})
          #
          # @param quote_id [String] Path param
          #
          ...
          # @return [HubSpotSDK::Models::Crm::SimplePublicObject]
          #
          # @see HubSpotSDK::Models::Crm::Objects::QuoteUpdateParams
          def update(quote_id, params)
            query_params = [:id_property]
            parsed, options = HubSpotSDK::Crm::Objects::QuoteUpdateParams.dump_request(params)
            query = HubSpotSDK::Internal::Util.encode_query_params(parsed.slice(*query_params))
            @client.request(
              method: :patch,
              path: ["crm/objects/2026-03/quotes/%1$s", quote_id],
          ...
          # Some parameter documentations has been truncated, see
          # {HubSpotSDK::Models::Crm::Objects::QuoteListParams} for more details.
          #
          ...
          #
          # @see HubSpotSDK::Models::Crm::Objects::QuoteListParams
          def list(params = {})
            parsed, options = HubSpotSDK::Crm::Objects::QuoteListParams.dump_request(params)
          ...
          # @return [nil]
          #
          # @see HubSpotSDK::Models::Crm::Objects::QuoteDeleteParams
          ...
          # Some parameter documentations has been truncated, see
          # {HubSpotSDK::Models::Crm::Objects::QuoteGetParams} for more details.
          #
          ...
          # query param.
          #
          # @overload get(quote_id, archived: nil, associations: nil, id_property: nil, properties: nil, properties_with_history: nil, request_options: {})
          #
          # @param quote_id [String]
          #
          # @param archived [Boolean] Whether to return only results that have been archived.
          ...
          #
          # @see HubSpotSDK::Models::Crm::Objects::QuoteGetParams
          def get(quote_id, params = {})
            parsed, options = HubSpotSDK::Crm::Objects::QuoteGetParams.dump_request(params)
            query = HubSpotSDK::Internal::Util.encode_query_params(parsed)
            @client.request(
              method: :get,
              path: ["crm/objects/2026-03/quotes/%1$s", quote_id],
          ...
          #
          # @see HubSpotSDK::Models::Crm::Objects::QuoteSearchParams
          def search(params)
            parsed, options = HubSpotSDK::Crm::Objects::QuoteSearchParams.dump_request(params)
            @client.request(
              method: :post,
