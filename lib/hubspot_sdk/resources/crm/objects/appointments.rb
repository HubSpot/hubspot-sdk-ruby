...
module HubspotSDK
  module Resources
    class CRM
      class Objects
        class Appointments
          # @return [HubspotSDK::Resources::CRM::Objects::Appointments::Batch]
          attr_reader :batch
          ...
          #
          # @see HubspotSDK::Models::CRM::Objects::AppointmentCreateParams
          def create(params)
            parsed, options = HubspotSDK::CRM::Objects::AppointmentCreateParams.dump_request(params)
            @client.request(
              method: :post,
              path: "crm/v3/objects/0-421",
              body: parsed,
          ...
          # an empty string.
          #
          # @overload update(appointment_id, properties:, id_property: nil, request_options: {})
          #
          # @param appointment_id [String] Path param:
          #
          ...
          #
          # @see HubspotSDK::Models::CRM::Objects::AppointmentUpdateParams
          def update(appointment_id, params)
            parsed, options = HubspotSDK::CRM::Objects::AppointmentUpdateParams.dump_request(params)
            query_params = [:id_property]
            @client.request(
              method: :patch,
              path: ["crm/v3/objects/0-421/%1$s", appointment_id],
          ...
          # {HubspotSDK::Models::CRM::Objects::AppointmentListParams} for more details.
          #
          # Read a page of appointments. Control what is returned via the `properties` query
          # param.
          #
          ...
          #
          # @see HubspotSDK::Models::CRM::Objects::AppointmentListParams
          def list(params = {})
            parsed, options = HubspotSDK::CRM::Objects::AppointmentListParams.dump_request(params)
            @client.request(
              method: :get,
              path: "crm/v3/objects/0-421",
          ...
          #
          # @overload delete(appointment_id, request_options: {})
          #
          ...
          # @return [nil]
          #
          # @see HubspotSDK::Models::CRM::Objects::AppointmentDeleteParams
          def delete(appointment_id, params = {})
            @client.request(
              method: :delete,
              path: ["crm/v3/objects/0-421/%1$s", appointment_id],
              model: NilClass,
          ...
          # Some parameter documentations has been truncated, see
          # {HubspotSDK::Models::CRM::Objects::AppointmentGetParams} for more details.
          #
          # Read an Object identified by `{appointmentId}`. `{appointmentId}` refers to the
          ...
          #
          # @overload get(appointment_id, archived: nil, associations: nil, id_property: nil, properties: nil, properties_with_history: nil, request_options: {})
          #
          # @param appointment_id [String]
          #
          # @param archived [Boolean] Whether to return only results that have been archived.
          ...
          #
          # @see HubspotSDK::Models::CRM::Objects::AppointmentGetParams
          def get(appointment_id, params = {})
            parsed, options = HubspotSDK::CRM::Objects::AppointmentGetParams.dump_request(params)
            @client.request(
              method: :get,
              path: ["crm/v3/objects/0-421/%1$s", appointment_id],
          ...
          #
          # @see HubspotSDK::Models::CRM::Objects::AppointmentSearchParams
          def search(params = {})
            parsed, options = HubspotSDK::CRM::Objects::AppointmentSearchParams.dump_request(params)
            @client.request(
              method: :post,
              path: "crm/v3/objects/0-421/search",
              body: parsed,
          ...
          def initialize(client:)
            @client = client
            @batch = HubspotSDK::Resources::CRM::Objects::Appointments::Batch.new(client: client)
          end
        end
      end
    end
