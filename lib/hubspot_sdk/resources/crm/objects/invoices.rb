    ...
    class Crm
      class Objects
        class Invoices
          ...
          def delete(params)
            parsed, options = HubspotSDK::Crm::Objects::InvoiceDeleteParams.dump_request(params)
            @client.request(
              method: :post,
          ...
          #
          # @see HubspotSDK::Models::Crm::Objects::InvoiceUpsertParams
          def upsert(params)
            parsed, options = HubspotSDK::Crm::Objects::InvoiceUpsertParams.dump_request(params)
            @client.request(
              method: :post,
