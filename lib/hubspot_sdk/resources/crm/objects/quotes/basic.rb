      ...
      class Objects
        class Quotes
          class Basic
            ...
            #
            # @see HubspotSDK::Models::Crm::Objects::Quotes::BasicCreateParams
            def create(params)
              parsed, options = HubspotSDK::Crm::Objects::Quotes::BasicCreateParams.dump_request(params)
              @client.request(
                method: :post,
            ...
            # @return [HubspotSDK::Models::Crm::BatchResponseSimplePublicObject]
            #
            # @see HubspotSDK::Models::Crm::Objects::Quotes::BasicUpdateParams
            def update(params)
              parsed, options = HubspotSDK::Crm::Objects::Quotes::BasicUpdateParams.dump_request(params)
              @client.request(
                method: :post,
            ...
            # @return [nil]
            #
            # @see HubspotSDK::Models::Crm::Objects::Quotes::BasicDeleteParams
            def delete(params)
              parsed, options = HubspotSDK::Crm::Objects::Quotes::BasicDeleteParams.dump_request(params)
              @client.request(
                method: :post,
            ...
            # {HubspotSDK::Models::Crm::Objects::Quotes::BasicGetParams} for more details.
            #
            ...
            # @return [HubspotSDK::Models::Crm::BatchResponseSimplePublicObject]
            #
            # @see HubspotSDK::Models::Crm::Objects::Quotes::BasicGetParams
            def get(params)
              query_params = [:archived]
              parsed, options = HubspotSDK::Crm::Objects::Quotes::BasicGetParams.dump_request(params)
            ...
            #
            # @see HubspotSDK::Models::Crm::Objects::Quotes::BasicUpsertParams
            def upsert(params)
              parsed, options = HubspotSDK::Crm::Objects::Quotes::BasicUpsertParams.dump_request(params)
              @client.request(
                method: :post,
