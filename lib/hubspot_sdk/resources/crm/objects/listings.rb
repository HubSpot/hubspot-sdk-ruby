    ...
    class Crm
      class Objects
        class Listings
          ...
          def delete(params)
            parsed, options = HubspotSDK::Crm::Objects::ListingDeleteParams.dump_request(params)
            @client.request(
              method: :post,
          ...
          #
          # @see HubspotSDK::Models::Crm::Objects::ListingUpsertParams
          def upsert(params)
            parsed, options = HubspotSDK::Crm::Objects::ListingUpsertParams.dump_request(params)
            @client.request(
              method: :post,
