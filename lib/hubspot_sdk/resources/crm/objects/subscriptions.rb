    ...
    class Crm
      class Objects
        class Subscriptions
          ...
          #
          # @overload update(subscription_id, properties:, id_property: nil, request_options: {})
          #
          # @param subscription_id [String] Path param
          #
          ...
          # associations.
          #
          # @overload get(subscription_id, archived: nil, associations: nil, id_property: nil, properties: nil, properties_with_history: nil, request_options: {})
          #
          # @param subscription_id [String]
          #
          # @param archived [Boolean] Whether to return only results that have been archived.
