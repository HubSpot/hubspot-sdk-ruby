      ...
      class Objects
        class Invoices
          class Batch
            ...
            #
            # @see HubSpotSDK::Models::Crm::Objects::Invoices::BatchCreateParams
            def create(params)
              parsed, options = HubSpotSDK::Crm::Objects::Invoices::BatchCreateParams.dump_request(params)
              @client.request(
                method: :post,
            ...
            # @return [HubSpotSDK::Models::Crm::BatchResponseSimplePublicObject]
            #
            # @see HubSpotSDK::Models::Crm::Objects::Invoices::BatchUpdateParams
            def update(params)
              parsed, options = HubSpotSDK::Crm::Objects::Invoices::BatchUpdateParams.dump_request(params)
              @client.request(
                method: :post,
            ...
            # @return [nil]
            #
            # @see HubSpotSDK::Models::Crm::Objects::Invoices::BatchDeleteParams
            def delete(params)
              parsed, options = HubSpotSDK::Crm::Objects::Invoices::BatchDeleteParams.dump_request(params)
              @client.request(
                method: :post,
            ...
            # {HubSpotSDK::Models::Crm::Objects::Invoices::BatchGetParams} for more details.
            #
            ...
            # @return [HubSpotSDK::Models::Crm::BatchResponseSimplePublicObject]
            #
            # @see HubSpotSDK::Models::Crm::Objects::Invoices::BatchGetParams
            def get(params)
              query_params = [:archived]
              parsed, options = HubSpotSDK::Crm::Objects::Invoices::BatchGetParams.dump_request(params)
            ...
            #
            # @see HubSpotSDK::Models::Crm::Objects::Invoices::BatchUpsertParams
            def upsert(params)
              parsed, options = HubSpotSDK::Crm::Objects::Invoices::BatchUpsertParams.dump_request(params)
              @client.request(
                method: :post,
