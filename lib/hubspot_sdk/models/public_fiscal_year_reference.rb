...
module HubspotSDK
  module Models
    class PublicFiscalYearReference < HubspotSDK::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, HubspotSDK::Models::PublicFiscalYearReference::ReferenceType]
      required :reference_type,
               enum: -> { HubspotSDK::PublicFiscalYearReference::ReferenceType },
      ...
      #   @param day [Integer]
      #   @param month [Integer]
      #   @param reference_type [Symbol, HubspotSDK::Models::PublicFiscalYearReference::ReferenceType]
      #   @param hour [Integer]
      #   @param millisecond [Integer]
      #   @param minute [Integer]
      #   @param second [Integer]

      # @see HubspotSDK::Models::PublicFiscalYearReference#reference_type
