...
module HubSpotSDK
  module Models
    class SnapshotStatusResponse < HubSpotSDK::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, HubSpotSDK::Models::SnapshotStatusResponse::Status]
      required :status, enum: -> { HubSpotSDK::SnapshotStatusResponse::Status }
      ...
      #
      #   @return [Symbol, HubSpotSDK::Models::SnapshotStatusResponse::ErrorCode, nil]
      optional :error_code, enum: -> { HubSpotSDK::SnapshotStatusResponse::ErrorCode }, api_name: :errorCode
      ...
      #   {HubSpotSDK::Models::SnapshotStatusResponse} for more details.
      #
      ...
      #
      #   @param status [Symbol, HubSpotSDK::Models::SnapshotStatusResponse::Status] The current status of the snapshot. Valid values include 'PENDING', 'IN_PROGRESS
      #
      #   @param completed_at [Integer] The timestamp indicating when the snapshot operation was completed, represented
      #
      #   @param error_code [Symbol, HubSpotSDK::Models::SnapshotStatusResponse::ErrorCode] A code representing the error that occurred, if any. Possible values are 'TIMEOU
      #
      ...
      # 'IN_PROGRESS', 'COMPLETED', 'FAILED', and 'EXPIRED'.
      #
      # @see HubSpotSDK::Models::SnapshotStatusResponse#status
      module Status
      ...
      # 'TIMEOUT', 'VALIDATION_ERROR', 'INTERNAL_ERROR', and 'PERMISSION_DENIED'.
      #
      # @see HubSpotSDK::Models::SnapshotStatusResponse#error_code
      module ErrorCode
        extend HubSpotSDK::Internal::Type::Enum
