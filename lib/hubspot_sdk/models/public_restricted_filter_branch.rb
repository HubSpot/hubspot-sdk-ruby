  ...
  module Models
    class PublicRestrictedFilterBranch < HubspotSDK::Internal::Type::BaseModel
      ...
      required :filter_branches,
               -> {
                 HubspotSDK::Internal::Type::ArrayOf[union: HubspotSDK::PublicRestrictedFilterBranch::FilterBranch]
               },
      ...
      #
      #   @return [Symbol, HubspotSDK::Models::PublicRestrictedFilterBranch::FilterBranchType]
      required :filter_branch_type,
               enum: -> { HubspotSDK::PublicRestrictedFilterBranch::FilterBranchType },
      ...
      required :filters,
               -> { HubspotSDK::Internal::Type::ArrayOf[union: HubspotSDK::PublicRestrictedFilterBranch::Filter] }
      ...
      #   @param filter_branch_type [Symbol, HubspotSDK::Models::PublicRestrictedFilterBranch::FilterBranchType]
      ...
      # @see HubspotSDK::Models::PublicRestrictedFilterBranch#filter_branch_type
