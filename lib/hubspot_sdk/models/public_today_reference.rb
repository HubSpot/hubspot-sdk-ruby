...
module HubspotSDK
  module Models
    class PublicTodayReference < HubspotSDK::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, HubspotSDK::Models::PublicTodayReference::ReferenceType]
      required :reference_type,
               enum: -> { HubspotSDK::PublicTodayReference::ReferenceType },
      ...
      #   @param reference_type [Symbol, HubspotSDK::Models::PublicTodayReference::ReferenceType]
      #   @param hour [Integer]
      #   @param millisecond [Integer]
      #   @param minute [Integer]
      #   @param second [Integer]

      # @see HubspotSDK::Models::PublicTodayReference#reference_type
