  ...
  module Models
    class PublicNotAnyFilterBranch < HubspotSDK::Internal::Type::BaseModel
      ...
      required :filter_branches,
               -> {
                 HubspotSDK::Internal::Type::ArrayOf[union: HubspotSDK::PublicNotAnyFilterBranch::FilterBranch]
               },
      ...
      #
      #   @return [Symbol, HubspotSDK::Models::PublicNotAnyFilterBranch::FilterBranchType]
      required :filter_branch_type,
               enum: -> { HubspotSDK::PublicNotAnyFilterBranch::FilterBranchType },
      ...
      required :filters,
               -> { HubspotSDK::Internal::Type::ArrayOf[union: HubspotSDK::PublicNotAnyFilterBranch::Filter] }
      ...
      #   @param filter_branch_type [Symbol, HubspotSDK::Models::PublicNotAnyFilterBranch::FilterBranchType]
      ...
      # @see HubspotSDK::Models::PublicNotAnyFilterBranch#filter_branch_type
