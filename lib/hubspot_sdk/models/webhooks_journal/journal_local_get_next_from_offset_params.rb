...
module HubSpotSDK
  module Models
    module WebhooksJournal
      # @see HubSpotSDK::Resources::WebhooksJournal::JournalLocal#get_next_from_offset
      class JournalLocalGetNextFromOffsetParams < HubSpotSDK::Internal::Type::BaseModel
