  ...
  module Models
    class PublicAssociationFilterBranch < HubspotSDK::Internal::Type::BaseModel
      ...
      required :filter_branches,
               -> {
                 HubspotSDK::Internal::Type::ArrayOf[union: HubspotSDK::PublicAssociationFilterBranch::FilterBranch]
               },
      ...
      #
      #   @return [Symbol, HubspotSDK::Models::PublicAssociationFilterBranch::FilterBranchType]
      required :filter_branch_type,
               enum: -> { HubspotSDK::PublicAssociationFilterBranch::FilterBranchType },
      ...
      required :filters,
               -> { HubspotSDK::Internal::Type::ArrayOf[union: HubspotSDK::PublicAssociationFilterBranch::Filter] }
      ...
      #   @param filter_branch_type [Symbol, HubspotSDK::Models::PublicAssociationFilterBranch::FilterBranchType]
      ...
      # @see HubspotSDK::Models::PublicAssociationFilterBranch#filter_branch_type
