...
module HubspotSDK
  module Models
    class PublicFiscalQuarterReference < HubspotSDK::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, HubspotSDK::Models::PublicFiscalQuarterReference::ReferenceType]
      required :reference_type,
               enum: -> { HubspotSDK::PublicFiscalQuarterReference::ReferenceType },
      ...
      #   @param day [Integer]
      #   @param month [Integer]
      #   @param reference_type [Symbol, HubspotSDK::Models::PublicFiscalQuarterReference::ReferenceType]
      #   @param hour [Integer]
      #   @param millisecond [Integer]
      #   @param minute [Integer]
      #   @param second [Integer]

      # @see HubspotSDK::Models::PublicFiscalQuarterReference#reference_type
