    ...
    module Conversations
      class ConversationsPublicConversationsMessage < HubspotSDK::Internal::Type::BaseModel
        ...
        required :attachments,
                 -> { HubspotSDK::Internal::Type::ArrayOf[union: HubspotSDK::Conversations::ConversationsPublicConversationsMessage::Attachment] }
        ...
        # @!attribute direction
        #
        #   @return [Symbol, HubspotSDK::Models::Conversations::ConversationsPublicConversationsMessage::Direction]
        required :direction,
                 enum: -> { HubspotSDK::Conversations::ConversationsPublicConversationsMessage::Direction }
        ...
        #
        #   @return [Symbol, HubspotSDK::Models::Conversations::ConversationsPublicConversationsMessage::TruncationStatus]
        ...
        # @!attribute type
        #
        #   @return [Symbol, HubspotSDK::Models::Conversations::ConversationsPublicConversationsMessage::Type]
        required :type, enum: -> { HubspotSDK::Conversations::ConversationsPublicConversationsMessage::Type }
        ...
        #   @param direction [Symbol, HubspotSDK::Models::Conversations::ConversationsPublicConversationsMessage::Direction]
        ...
        #   @param text [String]
        #   @param truncation_status [Symbol, HubspotSDK::Models::Conversations::ConversationsPublicConversationsMessage::TruncationStatus]
        #   @param type [Symbol, HubspotSDK::Models::Conversations::ConversationsPublicConversationsMessage::Type]
        ...
        # @see HubspotSDK::Models::Conversations::ConversationsPublicConversationsMessage#direction
        module Direction
        ...
        # @see HubspotSDK::Models::Conversations::ConversationsPublicConversationsMessage#truncation_status
        ...
        # @see HubspotSDK::Models::Conversations::ConversationsPublicConversationsMessage#type
        module Type
          extend HubspotSDK::Internal::Type::Enum
