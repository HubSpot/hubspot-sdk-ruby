  ...
  module Models
    module Conversations
      ...
      class CustomChannelUpdateParams < HubspotSDK::Internal::Type::BaseModel
        ...
        # @!method initialize(capabilities:, channel_description:, channel_logo_url:, channel_account_connection_redirect_url: nil, name: nil, webhook_url: nil, request_options: {})
