  ...
  module Models
    module Files
      class ImportFromURLInput < HubspotSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, HubspotSDK::Models::Files::ImportFromURLInput::DuplicateValidationScope, nil]
        optional :duplicate_validation_scope,
        ...
        #
        #   @return [Symbol, HubspotSDK::Models::Files::ImportFromURLInput::DuplicateValidationStrategy, nil]
        optional :duplicate_validation_strategy,
        ...
        #
        #   @return [Boolean, nil]
        optional :overwrite, HubspotSDK::Internal::Type::Boolean
        ...
        # @!method initialize(access:, url:, duplicate_validation_scope: nil, duplicate_validation_strategy: nil, expires_at: nil, folder_id: nil, folder_path: nil, name: nil, overwrite: nil, ttl: nil)
