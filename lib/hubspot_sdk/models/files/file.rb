  ...
  module Models
    module Files
      class File < HubspotSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, HubspotSDK::Models::Files::File::Access]
        required :access, enum: -> { HubspotSDK::Files::File::Access }
        ...
        #
        #   @return [String, nil]
        optional :source_group, String, api_name: :sourceGroup
        ...
        # @!method initialize(id:, access:, archived:, created_at:, updated_at:, archived_at: nil, default_hosting_url: nil, encoding: nil, expires_at: nil, extension: nil, file_md5: nil, height: nil, is_usable_in_content: nil, name: nil, parent_folder_id: nil, path: nil, size: nil, source_group: nil, type: nil, url: nil, width: nil)
