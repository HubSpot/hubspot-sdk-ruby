  ...
  module Models
    module Crm
      class BatchResponseVoid < HubspotSDK::Internal::Type::BaseModel
        ...
        #   {HubspotSDK::Models::Crm::BatchResponseVoid} for more details.
        #
        #   @param completed_at [Time] Time operation completed
        #
        #   @param results [Array<Object>]
        #
        #   @param started_at [Time] The timestamp when the batch processing began, in ISO 8601 format.
        #
        #   @param status [Symbol, HubspotSDK::Models::Crm::BatchResponseVoid::Status] The status of the batch processing request: "PENDING", "PROCESSING", "CANCELED",
        #
