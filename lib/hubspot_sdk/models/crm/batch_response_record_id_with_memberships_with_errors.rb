  ...
  module Models
    module Crm
      class BatchResponseRecordIDWithMembershipsWithErrors < HubSpotSDK::Internal::Type::BaseModel
        ...
        # @!attribute status
        #
        #   @return [Symbol, HubSpotSDK::Models::Crm::BatchResponseRecordIDWithMembershipsWithErrors::Status]
        ...
        #   @param status [Symbol, HubSpotSDK::Models::Crm::BatchResponseRecordIDWithMembershipsWithErrors::Status]
        ...
        # @see HubSpotSDK::Models::Crm::BatchResponseRecordIDWithMembershipsWithErrors#status
        module Status
