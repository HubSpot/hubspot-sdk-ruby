  ...
  module Models
    module Crm
      ...
      class PipelineStage < HubSpotSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, HubSpotSDK::Models::Crm::PipelineStage::WritePermissions]
        ...
        # @!method initialize(id:, archived:, created_at:, display_order:, label:, metadata:, updated_at:, write_permissions:, archived_at: nil)
