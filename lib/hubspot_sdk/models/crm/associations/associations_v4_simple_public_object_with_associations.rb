...
module HubspotSDK
  module Models
    module Crm
      module Associations
        class AssociationsV4SimplePublicObjectWithAssociations < HubspotSDK::Internal::Type::BaseModel
          # @!attribute id
          ...
          # @!method initialize(id:, archived:, created_at:, properties:, updated_at:, archived_at: nil, associations: nil, object_write_trace_id: nil, properties_with_history: nil)
          #   Some parameter documentations has been truncated, see
          #   {HubspotSDK::Models::Crm::Associations::AssociationsV4SimplePublicObjectWithAssociations}
          #   for more details.
          #
