      ...
      module Associations
        module Schema
          class BatchResponsePublicAssociationDefinitionConfigurationUpdateResultWithErrors < HubspotSDK::Internal::Type::BaseModel
            ...
            # @!attribute status
            #
            #   @return [Symbol, HubspotSDK::Models::CRM::Associations::Schema::BatchResponsePublicAssociationDefinitionConfigurationUpdateResultWithErrors::Status]
            required :status,
                     enum: -> { HubspotSDK::CRM::Associations::Schema::BatchResponsePublicAssociationDefinitionConfigurationUpdateResultWithErrors::Status }
            ...
            #   @param status [Symbol, HubspotSDK::Models::CRM::Associations::Schema::BatchResponsePublicAssociationDefinitionConfigurationUpdateResultWithErrors::Status]
            ...
            # @see HubspotSDK::Models::CRM::Associations::Schema::BatchResponsePublicAssociationDefinitionConfigurationUpdateResultWithErrors#status
            module Status
