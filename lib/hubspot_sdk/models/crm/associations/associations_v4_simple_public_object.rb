...
module HubspotSDK
  module Models
    module Crm
      module Associations
        class AssociationsV4SimplePublicObject < HubspotSDK::Internal::Type::BaseModel
          # @!attribute id
          ...
          # @!method initialize(id:, archived:, created_at:, properties:, updated_at:, archived_at: nil, object_write_trace_id: nil, properties_with_history: nil)
          #   Some parameter documentations has been truncated, see
          #   {HubspotSDK::Models::Crm::Associations::AssociationsV4SimplePublicObject} for
          #   more details.
          #
