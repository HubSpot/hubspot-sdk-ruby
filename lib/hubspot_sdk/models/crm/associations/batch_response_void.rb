    ...
    module Crm
      module Associations
        class BatchResponseVoid < HubspotSDK::Internal::Type::BaseModel
          ...
          # @!attribute status
          #
          #   @return [Symbol, HubspotSDK::Models::Crm::Associations::BatchResponseVoid::Status]
          required :status, enum: -> { HubspotSDK::Crm::Associations::BatchResponseVoid::Status }
          ...
          #   @param status [Symbol, HubspotSDK::Models::Crm::Associations::BatchResponseVoid::Status]
          ...
          # @see HubspotSDK::Models::Crm::Associations::BatchResponseVoid#status
          module Status
