  ...
  module Models
    module Crm
      class AssociationSpec < HubspotSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, HubspotSDK::Models::Crm::AssociationSpec::AssociationCategory]
        required :association_category,
                 enum: -> { HubspotSDK::Crm::AssociationSpec::AssociationCategory },
        ...
        #   objects.
        #
        #   @param association_category [Symbol, HubspotSDK::Models::Crm::AssociationSpec::AssociationCategory] The category of the association, such as "HUBSPOT_DEFINED".
        #
        #   @param association_type_id [Integer] The ID representing the specific type of association.

        # The category of the association, such as "HUBSPOT_DEFINED".
        #
        # @see HubspotSDK::Models::Crm::AssociationSpec#association_category
