  ...
  module Models
    module Crm
      class BatchResponsePropertyWithErrors < HubSpotSDK::Internal::Type::BaseModel
        ...
        # @!attribute status
        #
        #   @return [Symbol, HubSpotSDK::Models::Crm::BatchResponsePropertyWithErrors::Status]
        required :status, enum: -> { HubSpotSDK::Crm::BatchResponsePropertyWithErrors::Status }
        ...
        # @see HubSpotSDK::Models::Crm::BatchResponsePropertyWithErrors#status
        module Status
