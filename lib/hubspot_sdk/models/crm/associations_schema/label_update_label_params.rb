  ...
  module Models
    module Crm
      module AssociationsSchema
        # @see HubspotSDK::Resources::Crm::AssociationsSchema::Labels#update_label
        class LabelUpdateLabelParams < HubspotSDK::Models::Crm::PublicAssociationDefinitionUpdateRequest
