...
module HubspotSDK
  module Models
    module Crm
      module Objects
        # @see HubspotSDK::Resources::Crm::Objects::Meetings#update
        class MeetingUpdateParams < HubspotSDK::Models::Crm::SimplePublicObjectInput
          ...
          # @!method initialize(meeting_id:, id_property: nil, request_options: {})
