...
module HubSpotSDK
  module Models
    module Crm
      module Objects
        # @see HubSpotSDK::Resources::Crm::Objects::Contacts#get
        class ContactGetParams < HubSpotSDK::Internal::Type::BaseModel
          ...
          # @!method initialize(contact_id:, archived: nil, associations: nil, id_property: nil, properties: nil, properties_with_history: nil, request_options: {})
