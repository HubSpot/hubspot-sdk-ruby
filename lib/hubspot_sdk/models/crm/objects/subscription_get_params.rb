...
module HubSpotSDK
  module Models
    module Crm
      module Objects
        # @see HubSpotSDK::Resources::Crm::Objects::Subscriptions#get
        class SubscriptionGetParams < HubSpotSDK::Internal::Type::BaseModel
          ...
          # @!method initialize(subscription_id:, archived: nil, associations: nil, id_property: nil, properties: nil, properties_with_history: nil, request_options: {})
