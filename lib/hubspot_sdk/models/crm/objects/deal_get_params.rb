...
module HubspotSDK
  module Models
    module Crm
      module Objects
        # @see HubspotSDK::Resources::Crm::Objects::Deals#get
        class DealGetParams < HubspotSDK::Internal::Type::BaseModel
          ...
          # @!method initialize(deal_id:, archived: nil, associations: nil, id_property: nil, properties: nil, properties_with_history: nil, request_options: {})
