...
module HubSpotSDK
  module Models
    module Crm
      module Objects
        # @see HubSpotSDK::Resources::Crm::Objects::LineItems#get
        class LineItemGetParams < HubSpotSDK::Internal::Type::BaseModel
          ...
          # @!method initialize(line_item_id:, archived: nil, associations: nil, id_property: nil, properties: nil, properties_with_history: nil, request_options: {})
