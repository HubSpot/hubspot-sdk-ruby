    ...
    module Crm
      module Objects
        module PartnerClients
          # @see HubspotSDK::Resources::Crm::Objects::PartnerClients::Associations#delete
          class AssociationDeleteParams < HubspotSDK::Internal::Type::BaseModel
            ...
            # @!method initialize(partner_client_id:, to_object_type:, to_object_id:, request_options: {})
