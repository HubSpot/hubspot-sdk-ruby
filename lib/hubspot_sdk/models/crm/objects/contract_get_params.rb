...
module HubspotSDK
  module Models
    module Crm
      module Objects
        # @see HubspotSDK::Resources::Crm::Objects::Contracts#get
        class ContractGetParams < HubspotSDK::Internal::Type::BaseModel
          ...
          # @!method initialize(contract_id:, archived: nil, associations: nil, id_property: nil, properties: nil, properties_with_history: nil, request_options: {})
