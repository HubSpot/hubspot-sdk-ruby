...
module HubspotSDK
  module Models
    module Crm
      module Objects
        # @see HubspotSDK::Resources::Crm::Objects::Communications#get
        class CommunicationGetParams < HubspotSDK::Internal::Type::BaseModel
          ...
          # @!method initialize(communication_id:, archived: nil, associations: nil, id_property: nil, properties: nil, properties_with_history: nil, request_options: {})
