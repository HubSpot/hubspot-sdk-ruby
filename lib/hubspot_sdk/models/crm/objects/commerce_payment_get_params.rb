...
module HubSpotSDK
  module Models
    module Crm
      module Objects
        # @see HubSpotSDK::Resources::Crm::Objects::CommercePayments#get
        class CommercePaymentGetParams < HubSpotSDK::Internal::Type::BaseModel
          ...
          # @!method initialize(commerce_payment_id:, archived: nil, associations: nil, id_property: nil, properties: nil, properties_with_history: nil, request_options: {})
