...
module HubspotSDK
  module Models
    module Crm
      module Objects
        # @see HubspotSDK::Resources::Crm::Objects::Taxes#get
        class TaxGetParams < HubspotSDK::Internal::Type::BaseModel
          ...
          # @!method initialize(tax_id:, archived: nil, associations: nil, id_property: nil, properties: nil, properties_with_history: nil, request_options: {})
