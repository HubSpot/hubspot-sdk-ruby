...
module HubspotSDK
  module Models
    module Crm
      module Objects
        # @see HubspotSDK::Resources::Crm::Objects::PartnerServices#get
        class PartnerServiceGetParams < HubspotSDK::Internal::Type::BaseModel
          ...
          # @!method initialize(partner_service_id:, archived: nil, associations: nil, id_property: nil, properties: nil, properties_with_history: nil, request_options: {})
