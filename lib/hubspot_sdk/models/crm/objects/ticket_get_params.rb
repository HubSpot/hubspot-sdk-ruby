...
module HubSpotSDK
  module Models
    module Crm
      module Objects
        # @see HubSpotSDK::Resources::Crm::Objects::Tickets#get
        class TicketGetParams < HubSpotSDK::Internal::Type::BaseModel
          ...
          # @!method initialize(ticket_id:, archived: nil, associations: nil, id_property: nil, properties: nil, properties_with_history: nil, request_options: {})
