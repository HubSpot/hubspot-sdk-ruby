...
module HubSpotSDK
  module Models
    module Crm
      module Objects
        # @see HubSpotSDK::Resources::Crm::Objects::GoalTargets#get
        class GoalTargetGetParams < HubSpotSDK::Internal::Type::BaseModel
          ...
          # @!method initialize(goal_target_id:, archived: nil, associations: nil, id_property: nil, properties: nil, properties_with_history: nil, request_options: {})
