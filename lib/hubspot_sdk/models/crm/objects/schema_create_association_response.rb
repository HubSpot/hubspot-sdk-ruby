...
module HubspotSDK
  module Models
    module CRM
      module Objects
        # @see HubspotSDK::Resources::CRM::Objects::Schemas#create_association
        class SchemaCreateAssociationResponse < HubspotSDK::Internal::Type::BaseModel
          ...
          #   "ONE_TO_MANY".
          #
          #   @return [Symbol, HubspotSDK::Models::CRM::Objects::SchemaCreateAssociationResponse::Cardinality]
          required :cardinality,
                   enum: -> { HubspotSDK::Models::CRM::Objects::SchemaCreateAssociationResponse::Cardinality }

          # @!attribute category
          #   The category of the association. Can be: "HUBSPOT_DEFINED", "USER_DEFINED", or
          #   "INTEGRATOR_DEFINED"
          #
          #   @return [Symbol, HubspotSDK::Models::CRM::Objects::SchemaCreateAssociationResponse::Category]
          required :category,
                   enum: -> { HubspotSDK::Models::CRM::Objects::SchemaCreateAssociationResponse::Category }
          ...
          #   or "ONE_TO_MANY".
          #
          #   @return [Symbol, HubspotSDK::Models::CRM::Objects::SchemaCreateAssociationResponse::InverseCardinality]
          required :inverse_cardinality,
                   enum: -> { HubspotSDK::Models::CRM::Objects::SchemaCreateAssociationResponse::InverseCardinality },
          ...
          #
          #   @return [Symbol, HubspotSDK::Models::CRM::Objects::SchemaCreateAssociationResponse::FromObjectType, nil]
          optional :from_object_type,
                   enum: -> { HubspotSDK::Models::CRM::Objects::SchemaCreateAssociationResponse::FromObjectType },
          ...
          #
          #   @return [Symbol, HubspotSDK::Models::CRM::Objects::SchemaCreateAssociationResponse::ToObjectType, nil]
          optional :to_object_type,
                   enum: -> { HubspotSDK::Models::CRM::Objects::SchemaCreateAssociationResponse::ToObjectType },
          ...
          #   {HubspotSDK::Models::CRM::Objects::SchemaCreateAssociationResponse} for more
          #   details.
          #
          ...
          #
          #   @param cardinality [Symbol, HubspotSDK::Models::CRM::Objects::SchemaCreateAssociationResponse::Cardinality] The cardinality from the source object's perspective, either "ONE_TO_ONE" or "ON
          #
          #   @param category [Symbol, HubspotSDK::Models::CRM::Objects::SchemaCreateAssociationResponse::Category] The category of the association. Can be: "HUBSPOT_DEFINED", "USER_DEFINED", or "
          #
          ...
          #
          #   @param inverse_cardinality [Symbol, HubspotSDK::Models::CRM::Objects::SchemaCreateAssociationResponse::InverseCardinality] The cardinality from the destination object's perspective, either "ONE_TO_ONE" o
          #
          ...
          #
          #   @param from_object_type [Symbol, HubspotSDK::Models::CRM::Objects::SchemaCreateAssociationResponse::FromObjectType] The name of the source object type (e.g,. "DEAL" or "QUOTE").
          #
          ...
          #
          #   @param to_object_type [Symbol, HubspotSDK::Models::CRM::Objects::SchemaCreateAssociationResponse::ToObjectType] The name of the destination object type (e.g,. "DEAL" or "QUOTE").

          # The cardinality from the source object's perspective, either "ONE_TO_ONE" or
          # "ONE_TO_MANY".
          #
          # @see HubspotSDK::Models::CRM::Objects::SchemaCreateAssociationResponse#cardinality
          module Cardinality
          ...
          # "INTEGRATOR_DEFINED"
          #
          # @see HubspotSDK::Models::CRM::Objects::SchemaCreateAssociationResponse#category
          module Category
            extend HubspotSDK::Internal::Type::Enum
          ...
          # or "ONE_TO_MANY".
          #
          # @see HubspotSDK::Models::CRM::Objects::SchemaCreateAssociationResponse#inverse_cardinality
          ...
          # The name of the source object type (e.g,. "DEAL" or "QUOTE").
          #
          # @see HubspotSDK::Models::CRM::Objects::SchemaCreateAssociationResponse#from_object_type
          ...
          # The name of the destination object type (e.g,. "DEAL" or "QUOTE").
          #
          # @see HubspotSDK::Models::CRM::Objects::SchemaCreateAssociationResponse#to_object_type
          module ToObjectType
            extend HubspotSDK::Internal::Type::Enum
