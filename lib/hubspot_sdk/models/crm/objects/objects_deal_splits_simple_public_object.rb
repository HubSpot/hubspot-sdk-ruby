    ...
    module Crm
      module Objects
        class ObjectsDealSplitsSimplePublicObject < HubspotSDK::Internal::Type::BaseModel
          ...
          # @!method initialize(id:, created_at:, properties:, updated_at:, archived: nil, archived_at: nil, properties_with_history: nil)
          #   Some parameter documentations has been truncated, see
          #   {HubspotSDK::Models::Crm::Objects::ObjectsDealSplitsSimplePublicObject} for more
          #   details.
          #
      ...
      ObjectsDealSplitsSimplePublicObject = Objects::ObjectsDealSplitsSimplePublicObject
    end
  end
end
