    ...
    module Crm
      module Extensions
        ...
        class IntegratorCardPayloadResponse < HubspotSDK::Internal::Type::BaseModel
          ...
          #
          #   @param total_count [Integer] The total number of cards that are sent in this response.
          #
          #   @param all_items_link_url [String] URL to a page the integrator has built that displays all details for the object
          #
          #   @param card_label [String] The label to be used for the `allItemsLinkUrl` link (e.g. 'See more tickets') an
          #
