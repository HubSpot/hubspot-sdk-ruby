  ...
  module Models
    module Crm
      class CrmFilter < HubSpotSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, HubSpotSDK::Models::Crm::CrmFilter::Operator]
        required :operator, enum: -> { HubSpotSDK::Crm::CrmFilter::Operator }
        ...
        #
        #   @param operator [Symbol, HubSpotSDK::Models::Crm::CrmFilter::Operator] The comparison operator used in the filter, such as "EQ" or "GT".
        #
        ...
        # The comparison operator used in the filter, such as "EQ" or "GT".
        #
        # @see HubSpotSDK::Models::Crm::CrmFilter#operator
        module Operator
