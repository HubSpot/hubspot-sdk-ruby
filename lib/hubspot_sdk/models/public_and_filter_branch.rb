  ...
  module Models
    class PublicAndFilterBranch < HubspotSDK::Internal::Type::BaseModel
      ...
      required :filter_branches,
               -> {
                 HubspotSDK::Internal::Type::ArrayOf[union: HubspotSDK::PublicAndFilterBranch::FilterBranch]
               },
      ...
      #
      #   @return [Symbol, HubspotSDK::Models::PublicAndFilterBranch::FilterBranchType]
      required :filter_branch_type,
               enum: -> { HubspotSDK::PublicAndFilterBranch::FilterBranchType },
      ...
      required :filters,
               -> { HubspotSDK::Internal::Type::ArrayOf[union: HubspotSDK::PublicAndFilterBranch::Filter] }
      ...
      #   @param filter_branch_type [Symbol, HubspotSDK::Models::PublicAndFilterBranch::FilterBranchType]
      ...
      # @see HubspotSDK::Models::PublicAndFilterBranch#filter_branch_type
