...
module HubSpotSDK
  module Models
    class PropertyValue < HubSpotSDK::Internal::Type::BaseModel
      ...
      #
      #   @param is_large_value [Boolean] Indicates if the value exceeds normal size limits.
      #
      #   @param name [String] The unique property name.
      #
      #   @param persistence_timestamp [Integer] When the value was persisted to database, in epoch milliseconds.
      #
      ...
      #
      #   @param use_timestamp_as_persistence_timestamp [Boolean] Flag indicating whether to use the timestamp field as the persistence timestamp.
      #
      ...
      module Source
        ...
        DI_WRITE_TO_CRM = :DI_WRITE_TO_CRM
        EMAIL = :EMAIL
