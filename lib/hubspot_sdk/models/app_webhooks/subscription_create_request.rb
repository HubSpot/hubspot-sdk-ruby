  ...
  module Models
    module AppWebhooks
      class SubscriptionCreateRequest < HubspotSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, HubspotSDK::Models::AppWebhooks::SubscriptionCreateRequest::EventType]
        required :event_type,
                 enum: -> { HubspotSDK::AppWebhooks::SubscriptionCreateRequest::EventType },
                 api_name: :eventType
        ...
        #   {HubspotSDK::Models::AppWebhooks::SubscriptionCreateRequest} for more details.
        #
        ...
        # `deletedForPrivacy`, or `propertyChange`.
        #
        # @see HubspotSDK::Models::AppWebhooks::SubscriptionCreateRequest#event_type
        module EventType
