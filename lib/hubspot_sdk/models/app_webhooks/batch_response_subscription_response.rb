...
module HubspotSDK
  module Models
    module AppWebhooks
      # @see HubspotSDK::Resources::AppWebhooks#batch_update_subscriptions
      class BatchResponseSubscriptionResponse < HubspotSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, HubspotSDK::Models::AppWebhooks::BatchResponseSubscriptionResponse::Status]
        required :status, enum: -> { HubspotSDK::AppWebhooks::BatchResponseSubscriptionResponse::Status }
        ...
        #   {HubspotSDK::Models::AppWebhooks::BatchResponseSubscriptionResponse} for more
        #   details.
        #
        #   @param completed_at [Time] The date and time when the batch operation was completed.
        #
        #   @param results [Array<HubspotSDK::Models::AppWebhooks::SubscriptionResponse>] The list of results from the batch operation.
        #
        #   @param started_at [Time] The date and time when the batch operation started.
        #
        #   @param status [Symbol, HubspotSDK::Models::AppWebhooks::BatchResponseSubscriptionResponse::Status] The current status of the batch operation, which can be PENDING, PROCESSING, CAN
        #
        ...
        # CANCELED, or COMPLETE.
        #
        # @see HubspotSDK::Models::AppWebhooks::BatchResponseSubscriptionResponse#status
        module Status
