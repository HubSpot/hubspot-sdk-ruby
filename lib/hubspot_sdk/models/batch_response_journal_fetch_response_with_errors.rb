...
module HubSpotSDK
  module Models
    class BatchResponseJournalFetchResponseWithErrors < HubSpotSDK::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, HubSpotSDK::Models::BatchResponseJournalFetchResponseWithErrors::Status]
      required :status, enum: -> { HubSpotSDK::BatchResponseJournalFetchResponseWithErrors::Status }
      ...
      #   {HubSpotSDK::Models::BatchResponseJournalFetchResponseWithErrors} for more
      #   details.
      #
      #   @param completed_at [Time] The date and time when the batch process was completed, in ISO 8601 format.
      #
      #   @param results [Array<HubSpotSDK::Models::JournalFetchResponse>] An array of journal fetch responses, each representing a result from the batch p
      #
      #   @param started_at [Time] The date and time when the batch process started, in ISO 8601 format.
      #
      #   @param status [Symbol, HubSpotSDK::Models::BatchResponseJournalFetchResponseWithErrors::Status] The current status of the batch process. Valid values include 'PENDING', 'PROCES
      #
      ...
      # 'PROCESSING', 'CANCELED', and 'COMPLETE'.
      #
      # @see HubSpotSDK::Models::BatchResponseJournalFetchResponseWithErrors#status
      module Status
