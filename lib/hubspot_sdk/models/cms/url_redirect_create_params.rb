...
module HubspotSDK
  module Models
    module Cms
      ...
      class URLRedirectCreateParams < HubspotSDK::Internal::Type::BaseModel
        ...
        # @!method initialize(destination:, redirect_style:, route_prefix:, is_match_full_url: nil, is_match_query_string: nil, is_only_after_not_found: nil, is_pattern: nil, is_protocol_agnostic: nil, is_trailing_slash_optional: nil, precedence: nil, request_options: {})
