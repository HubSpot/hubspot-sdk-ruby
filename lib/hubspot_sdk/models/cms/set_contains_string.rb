    ...
    module Cms
      class SetContainsString < HubSpotSDK::Internal::Type::BaseModel
        ...
        required :string_to_check,
                 union: -> { HubSpotSDK::Cms::SetContainsString::StringToCheck },
        ...
        optional :inputs,
                 -> { HubSpotSDK::Internal::Type::ArrayOf[union: HubSpotSDK::Cms::SetContainsString::Input] }
        ...
        # @see HubSpotSDK::Models::Cms::SetContainsString#string_to_check
