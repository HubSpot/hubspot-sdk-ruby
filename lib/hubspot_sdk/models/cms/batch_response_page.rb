  ...
  module Models
    module Cms
      class BatchResponsePage < HubSpotSDK::Internal::Type::BaseModel
        ...
        #
        #   @param results [Array<HubSpotSDK::Models::Cms::PagesPage>] Results of batch operation.
        #
        #   @param started_at [Time] Time of batch operation start.
        #
        #   @param status [Symbol, HubSpotSDK::Models::Cms::BatchResponsePage::Status] Status of batch operation.
        #
