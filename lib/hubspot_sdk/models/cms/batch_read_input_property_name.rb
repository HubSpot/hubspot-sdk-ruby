  ...
  module Models
    module Cms
      class BatchReadInputPropertyName < HubspotSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, HubspotSDK::Models::Cms::BatchReadInputPropertyName::DataSensitivity]
        required :data_sensitivity,
                 enum: -> { HubspotSDK::Cms::BatchReadInputPropertyName::DataSensitivity },
        ...
        #   @param data_sensitivity [Symbol, HubspotSDK::Models::Cms::BatchReadInputPropertyName::DataSensitivity]
        #   @param inputs [Array<HubspotSDK::Models::PropertyName>]

        # @see HubspotSDK::Models::Cms::BatchReadInputPropertyName#data_sensitivity
