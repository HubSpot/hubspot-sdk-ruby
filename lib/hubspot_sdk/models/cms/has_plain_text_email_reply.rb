  ...
  module Models
    module Cms
      class HasPlainTextEmailReply < HubSpotSDK::Internal::Type::BaseModel
        # @!attribute operator
        #
        #   @return [Symbol, HubSpotSDK::Models::Cms::HasPlainTextEmailReply::Operator]
        required :operator, enum: -> { HubSpotSDK::Cms::HasPlainTextEmailReply::Operator }
        ...
        optional :inputs,
                 -> { HubSpotSDK::Internal::Type::ArrayOf[union: HubSpotSDK::Cms::HasPlainTextEmailReply::Input] }
        ...
        #   @param operator [Symbol, HubSpotSDK::Models::Cms::HasPlainTextEmailReply::Operator]
        ...
        # @see HubSpotSDK::Models::Cms::HasPlainTextEmailReply#operator
        module Operator
