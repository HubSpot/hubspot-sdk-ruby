    ...
    module Cms
      class Substring < HubSpotSDK::Internal::Type::BaseModel
        ...
        required :string_to_check,
                 union: -> { HubSpotSDK::Cms::Substring::StringToCheck },
        ...
        optional :inputs, -> { HubSpotSDK::Internal::Type::ArrayOf[union: HubSpotSDK::Cms::Substring::Input] }
        ...
        # @see HubSpotSDK::Models::Cms::Substring#string_to_check
