...
module HubspotSDK
  module Models
    module Cms
      class CreateAudioObjectRequest < HubspotSDK::Internal::Type::BaseModel
        # @!attribute media_type
        #
        #   @return [Symbol, HubspotSDK::Models::Cms::CreateAudioObjectRequest::MediaType]
        required :media_type,
                 enum: -> { HubspotSDK::Cms::CreateAudioObjectRequest::MediaType },
                 api_name: :mediaType
        ...
        #   @param media_type [Symbol, HubspotSDK::Models::Cms::CreateAudioObjectRequest::MediaType]
        #   @param title [String]
        ...
        # @see HubspotSDK::Models::Cms::CreateAudioObjectRequest#media_type
        module MediaType
