  ...
  module Models
    module Cms
      class IsBlank < HubSpotSDK::Internal::Type::BaseModel
        # @!attribute operator
        #
        #   @return [Symbol, HubSpotSDK::Models::Cms::IsBlank::Operator]
        required :operator, enum: -> { HubSpotSDK::Cms::IsBlank::Operator }
        ...
        optional :inputs, -> { HubSpotSDK::Internal::Type::ArrayOf[union: HubSpotSDK::Cms::IsBlank::Input] }
        ...
        #   @param operator [Symbol, HubSpotSDK::Models::Cms::IsBlank::Operator]
        ...
        # @see HubSpotSDK::Models::Cms::IsBlank#operator
        module Operator
