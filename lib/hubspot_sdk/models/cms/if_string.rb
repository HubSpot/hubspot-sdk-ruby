    ...
    module Cms
      class IfString < HubSpotSDK::Internal::Type::BaseModel
        ...
        required :if_expression,
                 union: -> {
                   HubSpotSDK::Cms::IfString::IfExpression
                 },
        ...
        optional :else_expression,
                 union: -> { HubSpotSDK::Cms::IfString::ElseExpression },
        ...
        optional :inputs, -> { HubSpotSDK::Internal::Type::ArrayOf[union: HubSpotSDK::Cms::IfString::Input] }
        ...
        # @see HubSpotSDK::Models::Cms::IfString#if_expression
        module IfExpression
        ...
        # @see HubSpotSDK::Models::Cms::IfString#else_expression
