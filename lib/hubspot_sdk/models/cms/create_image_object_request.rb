...
module HubspotSDK
  module Models
    module Cms
      class CreateImageObjectRequest < HubspotSDK::Internal::Type::BaseModel
        # @!attribute media_type
        #
        #   @return [Symbol, HubspotSDK::Models::Cms::CreateImageObjectRequest::MediaType]
        required :media_type,
                 enum: -> { HubspotSDK::Cms::CreateImageObjectRequest::MediaType },
                 api_name: :mediaType
        ...
        #   @param media_type [Symbol, HubspotSDK::Models::Cms::CreateImageObjectRequest::MediaType]
        #   @param title [String]
        ...
        # @see HubspotSDK::Models::Cms::CreateImageObjectRequest#media_type
        module MediaType
