  ...
  module Models
    module Cms
      class MoreThanOrEqual < HubSpotSDK::Internal::Type::BaseModel
        # @!attribute operator
        #
        #   @return [Symbol, HubSpotSDK::Models::Cms::MoreThanOrEqual::Operator]
        required :operator, enum: -> { HubSpotSDK::Cms::MoreThanOrEqual::Operator }
        ...
        optional :inputs,
                 -> { HubSpotSDK::Internal::Type::ArrayOf[union: HubSpotSDK::Cms::MoreThanOrEqual::Input] }
        ...
        #   @param operator [Symbol, HubSpotSDK::Models::Cms::MoreThanOrEqual::Operator]
        ...
        # @see HubSpotSDK::Models::Cms::MoreThanOrEqual#operator
        module Operator
