    ...
    module Cms
      class AddTime < HubspotSDK::Internal::Type::BaseModel
        ...
        required :string_to_check,
                 union: -> {
                   HubspotSDK::Cms::AddTime::StringToCheck
                 },
        ...
        optional :inputs, -> { HubspotSDK::Internal::Type::ArrayOf[union: HubspotSDK::Cms::AddTime::Input] }
        ...
        # @see HubspotSDK::Models::Cms::AddTime#string_to_check
