    ...
    module Cms
      class BeginsWith < HubspotSDK::Internal::Type::BaseModel
        ...
        required :string_to_check,
                 union: -> { HubspotSDK::Cms::BeginsWith::StringToCheck },
        ...
        optional :inputs, -> { HubspotSDK::Internal::Type::ArrayOf[union: HubspotSDK::Cms::BeginsWith::Input] }
        ...
        # @see HubspotSDK::Models::Cms::BeginsWith#string_to_check
