    ...
    module Cms
      class SubtractTime < HubspotSDK::Internal::Type::BaseModel
        ...
        required :string_to_check,
                 union: -> { HubspotSDK::Cms::SubtractTime::StringToCheck },
        ...
        optional :inputs, -> { HubspotSDK::Internal::Type::ArrayOf[union: HubspotSDK::Cms::SubtractTime::Input] }
        ...
        # @see HubspotSDK::Models::Cms::SubtractTime#string_to_check
