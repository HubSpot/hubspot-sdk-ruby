  ...
  module Models
    module Cms
      class TimeBetween < HubspotSDK::Internal::Type::BaseModel
        # @!attribute operator
        #
        #   @return [Symbol, HubspotSDK::Models::Cms::TimeBetween::Operator]
        required :operator, enum: -> { HubspotSDK::Cms::TimeBetween::Operator }
        ...
        optional :inputs, -> { HubspotSDK::Internal::Type::ArrayOf[union: HubspotSDK::Cms::TimeBetween::Input] }
        ...
        #   @param operator [Symbol, HubspotSDK::Models::Cms::TimeBetween::Operator]
        ...
        # @see HubspotSDK::Models::Cms::TimeBetween#operator
        module Operator
