...
module HubspotSDK
  module Models
    module Cms
      class CreateOtherObjectRequest < HubspotSDK::Internal::Type::BaseModel
        # @!attribute media_type
        #
        #   @return [Symbol, HubspotSDK::Models::Cms::CreateOtherObjectRequest::MediaType]
        required :media_type,
                 enum: -> { HubspotSDK::Cms::CreateOtherObjectRequest::MediaType },
                 api_name: :mediaType
        ...
        #   @param media_type [Symbol, HubspotSDK::Models::Cms::CreateOtherObjectRequest::MediaType]
        #   @param title [String]
        ...
        # @see HubspotSDK::Models::Cms::CreateOtherObjectRequest#media_type
        module MediaType
