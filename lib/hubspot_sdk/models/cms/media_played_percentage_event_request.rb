  ...
  module Models
    module Cms
      class MediaPlayedPercentageEventRequest < HubspotSDK::Internal::Type::BaseModel
        ...
        # @!method initialize(media_type:, occurred_timestamp:, played_percent:, session_id:, _hsenc: nil, contact_id: nil, contact_utk: nil, external_id: nil, media_bridge_id: nil, media_name: nil, media_url: nil, page_id: nil, page_name: nil, page_url: nil)
