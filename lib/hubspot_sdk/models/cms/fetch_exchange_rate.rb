...
module HubspotSDK
  module Models
    module Cms
      class FetchExchangeRate < HubspotSDK::Internal::Type::BaseModel
        # @!attribute operator
        #
        #   @return [Symbol, HubspotSDK::Models::Cms::FetchExchangeRate::Operator]
        required :operator, enum: -> { HubspotSDK::Cms::FetchExchangeRate::Operator }
        ...
        optional :inputs,
                 -> { HubspotSDK::Internal::Type::ArrayOf[union: HubspotSDK::Cms::FetchExchangeRate::Input] }
        ...
        #   @param operator [Symbol, HubspotSDK::Models::Cms::FetchExchangeRate::Operator]
        ...
        # @see HubspotSDK::Models::Cms::FetchExchangeRate#operator
        module Operator
