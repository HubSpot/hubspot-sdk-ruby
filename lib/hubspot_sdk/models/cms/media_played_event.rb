  ...
  module Models
    module Cms
      ...
      class MediaPlayedEvent < HubspotSDK::Internal::Type::BaseModel
        ...
        # @!method initialize(contact_id:, media_bridge_id:, media_bridge_object_coordinates:, media_bridge_object_type_id:, media_name:, media_type:, occurred_timestamp:, portal_id:, provider_id:, session_id:, state:, external_play_context: nil, iframe_url: nil, media_url: nil, page_id: nil, page_name: nil, page_object_coordinates: nil, page_url: nil)
