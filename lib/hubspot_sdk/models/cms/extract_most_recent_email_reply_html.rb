  ...
  module Models
    module Cms
      class ExtractMostRecentEmailReplyHTML < HubSpotSDK::Internal::Type::BaseModel
        # @!attribute operator
        #
        #   @return [Symbol, HubSpotSDK::Models::Cms::ExtractMostRecentEmailReplyHTML::Operator]
        required :operator, enum: -> { HubSpotSDK::Cms::ExtractMostRecentEmailReplyHTML::Operator }
        ...
        optional :inputs,
                 -> { HubSpotSDK::Internal::Type::ArrayOf[union: HubSpotSDK::Cms::ExtractMostRecentEmailReplyHTML::Input] }
        ...
        #   @param operator [Symbol, HubSpotSDK::Models::Cms::ExtractMostRecentEmailReplyHTML::Operator]
        ...
        # @see HubSpotSDK::Models::Cms::ExtractMostRecentEmailReplyHTML#operator
        module Operator
