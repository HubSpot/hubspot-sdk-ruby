  ...
  module Models
    module Cms
      class MoreThan < HubspotSDK::Internal::Type::BaseModel
        # @!attribute operator
        #
        #   @return [Symbol, HubspotSDK::Models::Cms::MoreThan::Operator]
        required :operator, enum: -> { HubspotSDK::Cms::MoreThan::Operator }
        ...
        optional :inputs, -> { HubspotSDK::Internal::Type::ArrayOf[union: HubspotSDK::Cms::MoreThan::Input] }
        ...
        #   @param operator [Symbol, HubspotSDK::Models::Cms::MoreThan::Operator]
        ...
        # @see HubspotSDK::Models::Cms::MoreThan#operator
        module Operator
