    ...
    module Cms
      class IfNumber < HubSpotSDK::Internal::Type::BaseModel
        ...
        required :if_expression,
                 union: -> {
                   HubSpotSDK::Cms::IfNumber::IfExpression
                 },
        ...
        optional :else_expression,
                 union: -> { HubSpotSDK::Cms::IfNumber::ElseExpression },
        ...
        optional :inputs, -> { HubSpotSDK::Internal::Type::ArrayOf[union: HubSpotSDK::Cms::IfNumber::Input] }
        ...
        # @see HubSpotSDK::Models::Cms::IfNumber#if_expression
        module IfExpression
        ...
        # @see HubSpotSDK::Models::Cms::IfNumber#else_expression
