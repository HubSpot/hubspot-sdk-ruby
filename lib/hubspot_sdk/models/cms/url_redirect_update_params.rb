  ...
  module Models
    module Cms
      ...
      class URLRedirectUpdateParams < HubspotSDK::Internal::Type::BaseModel
        ...
        # @!method initialize(id:, destination:, is_match_full_url:, is_match_query_string:, is_only_after_not_found:, is_pattern:, is_protocol_agnostic:, is_trailing_slash_optional:, precedence:, redirect_style:, route_prefix:, created: nil, updated: nil, request_options: {})
