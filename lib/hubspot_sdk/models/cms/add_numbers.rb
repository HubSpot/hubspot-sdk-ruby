  ...
  module Models
    module Cms
      class AddNumbers < HubSpotSDK::Internal::Type::BaseModel
        ...
        # @!attribute operator
        #
        #   @return [Symbol, HubSpotSDK::Models::Cms::AddNumbers::Operator]
        required :operator, enum: -> { HubSpotSDK::Cms::AddNumbers::Operator }
        ...
        optional :inputs, -> { HubSpotSDK::Internal::Type::ArrayOf[union: HubSpotSDK::Cms::AddNumbers::Input] }
        ...
        #   @param operator [Symbol, HubSpotSDK::Models::Cms::AddNumbers::Operator]
        ...
        # @see HubSpotSDK::Models::Cms::AddNumbers#operator
        module Operator
