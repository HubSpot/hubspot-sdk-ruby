  ...
  module Models
    module Cms
      class SubtractNumbers < HubSpotSDK::Internal::Type::BaseModel
        ...
        # @!attribute operator
        #
        #   @return [Symbol, HubSpotSDK::Models::Cms::SubtractNumbers::Operator]
        required :operator, enum: -> { HubSpotSDK::Cms::SubtractNumbers::Operator }
        ...
        optional :inputs,
                 -> { HubSpotSDK::Internal::Type::ArrayOf[union: HubSpotSDK::Cms::SubtractNumbers::Input] }
        ...
        #   @param operator [Symbol, HubSpotSDK::Models::Cms::SubtractNumbers::Operator]
        ...
        # @see HubSpotSDK::Models::Cms::SubtractNumbers#operator
        module Operator
