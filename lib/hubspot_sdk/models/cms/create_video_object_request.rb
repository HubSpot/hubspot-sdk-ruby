...
module HubspotSDK
  module Models
    module Cms
      class CreateVideoObjectRequest < HubspotSDK::Internal::Type::BaseModel
        # @!attribute media_type
        #
        #   @return [Symbol, HubspotSDK::Models::Cms::CreateVideoObjectRequest::MediaType]
        required :media_type,
                 enum: -> { HubspotSDK::Cms::CreateVideoObjectRequest::MediaType },
                 api_name: :mediaType
        ...
        # @!method initialize(media_type:, title:, bearer_token: nil, details_page_link: nil, duration: nil, external_id: nil, file_url: nil, oembed_url: nil, poster_url: nil, thumbnail_url: nil, transcript_url: nil)
        #   @param media_type [Symbol, HubspotSDK::Models::Cms::CreateVideoObjectRequest::MediaType]
        #   @param title [String]
        ...
        # @see HubspotSDK::Models::Cms::CreateVideoObjectRequest#media_type
        module MediaType
