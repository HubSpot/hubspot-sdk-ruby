    ...
    module Cms
      module MediaBridge
        ...
        class IntegratorSettingUpdateEventVisibilitySettingsResponse < HubspotSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, HubspotSDK::Models::Cms::MediaBridge::IntegratorSettingUpdateEventVisibilitySettingsResponse::EventType]
          required :event_type,
                   enum: -> { HubspotSDK::Models::Cms::MediaBridge::IntegratorSettingUpdateEventVisibilitySettingsResponse::EventType },
                   api_name: :eventType
          ...
          #   @param event_type [Symbol, HubspotSDK::Models::Cms::MediaBridge::IntegratorSettingUpdateEventVisibilitySettingsResponse::EventType]
          #   @param updated_at [Integer]
          #   @param show_in_reporting [Boolean]
          #   @param show_in_timeline [Boolean]
          #   @param show_in_workflows [Boolean]

          # @see HubspotSDK::Models::Cms::MediaBridge::IntegratorSettingUpdateEventVisibilitySettingsResponse#event_type
          module EventType
