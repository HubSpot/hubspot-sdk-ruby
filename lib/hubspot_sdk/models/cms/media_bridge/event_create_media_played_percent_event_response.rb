  ...
  module Models
    module Cms
      module MediaBridge
        ...
        class EventCreateMediaPlayedPercentEventResponse < HubspotSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, HubspotSDK::Models::Cms::MediaBridge::EventCreateMediaPlayedPercentEventResponse::MediaType]
          required :media_type,
                   enum: -> { HubspotSDK::Models::Cms::MediaBridge::EventCreateMediaPlayedPercentEventResponse::MediaType },
                   api_name: :mediaType
          ...
          #
          #   @param media_type [Symbol, HubspotSDK::Models::Cms::MediaBridge::EventCreateMediaPlayedPercentEventResponse::MediaType]
          #
          ...
          # @see HubspotSDK::Models::Cms::MediaBridge::EventCreateMediaPlayedPercentEventResponse#media_type
          module MediaType
