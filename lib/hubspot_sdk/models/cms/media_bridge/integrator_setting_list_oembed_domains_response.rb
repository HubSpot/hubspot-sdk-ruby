    ...
    module Cms
      module MediaBridge
        ...
        class IntegratorSettingListOembedDomainsResponse < HubspotSDK::Internal::Type::BaseModel
          # @!attribute results
          #
          #   @return [Array<HubspotSDK::Models::Cms::MediaBridge::IntegratorSettingListOembedDomainsResponse::Result>]
          required :results,
                   -> { HubspotSDK::Internal::Type::ArrayOf[HubspotSDK::Models::Cms::MediaBridge::IntegratorSettingListOembedDomainsResponse::Result] }
          ...
          #   @param results [Array<HubspotSDK::Models::Cms::MediaBridge::IntegratorSettingListOembedDomainsResponse::Result>]
          ...
          class Result < HubspotSDK::Internal::Type::BaseModel
            ...
            # @!attribute endpoints
            #
            #   @return [HubspotSDK::Models::Cms::MediaBridge::IntegratorSettingListOembedDomainsResponse::Result::Endpoints]
            required :endpoints,
            ...
            #   @param endpoints [HubspotSDK::Models::Cms::MediaBridge::IntegratorSettingListOembedDomainsResponse::Result::Endpoints]
            #   @param portal_id [Integer]
            #   @param updated_at [Integer]

            # @see HubspotSDK::Models::Cms::MediaBridge::IntegratorSettingListOembedDomainsResponse::Result#endpoints
