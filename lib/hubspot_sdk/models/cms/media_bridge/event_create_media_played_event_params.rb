    ...
    module Cms
      module MediaBridge
        ...
        class EventCreateMediaPlayedEventParams < HubspotSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, HubspotSDK::Models::Cms::MediaBridge::EventCreateMediaPlayedEventParams::MediaType]
          required :media_type,
                   enum: -> { HubspotSDK::Cms::MediaBridge::EventCreateMediaPlayedEventParams::MediaType },
                   api_name: :mediaType
          ...
          # @!attribute state
          #
          #   @return [Symbol, HubspotSDK::Models::Cms::MediaBridge::EventCreateMediaPlayedEventParams::State]
          required :state, enum: -> { HubspotSDK::Cms::MediaBridge::EventCreateMediaPlayedEventParams::State }
          ...
          # @!method initialize(media_type:, occurred_timestamp:, session_id:, state:, _hsenc: nil, contact_id: nil, contact_utk: nil, external_id: nil, iframe_url: nil, media_bridge_id: nil, media_name: nil, media_url: nil, page_id: nil, page_name: nil, page_url: nil, request_options: {})
