...
module HubspotSDK
  module Models
    module Cms
      module MediaBridge
        # @see HubspotSDK::Resources::Cms::MediaBridge::IntegratorSettings#get_oembed_domain
        class IntegratorSettingGetOembedDomainResponse < HubspotSDK::Internal::Type::BaseModel
          # @!attribute id
          #
          #   @return [Integer]
          required :id, Integer
          ...
          # @!attribute endpoints
          #
          #   @return [HubspotSDK::Models::Cms::MediaBridge::IntegratorSettingGetOembedDomainResponse::Endpoints]
          required :endpoints,
                   -> { HubspotSDK::Models::Cms::MediaBridge::IntegratorSettingGetOembedDomainResponse::Endpoints }
          ...
          #   @param endpoints [HubspotSDK::Models::Cms::MediaBridge::IntegratorSettingGetOembedDomainResponse::Endpoints]
          #   @param portal_id [Integer]
          #   @param updated_at [Integer]

          # @see HubspotSDK::Models::Cms::MediaBridge::IntegratorSettingGetOembedDomainResponse#endpoints
