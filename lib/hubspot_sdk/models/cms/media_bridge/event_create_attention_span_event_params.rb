...
module HubspotSDK
  module Models
    module Cms
      module MediaBridge
        # @see HubspotSDK::Resources::Cms::MediaBridge::Events#create_attention_span_event
        class EventCreateAttentionSpanEventParams < HubspotSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, HubspotSDK::Models::Cms::MediaBridge::EventCreateAttentionSpanEventParams::MediaType]
          required :media_type,
                   enum: -> { HubspotSDK::Cms::MediaBridge::EventCreateAttentionSpanEventParams::MediaType },
                   api_name: :mediaType
          ...
          #
          #   @return [HubspotSDK::Models::Cms::MediaBridge::EventCreateAttentionSpanEventParams::DerivedValues, nil]
          ...
          # @!method initialize(media_type:, occurred_timestamp:, raw_data_map:, session_id:, _hsenc: nil, contact_id: nil, contact_utk: nil, derived_values: nil, external_id: nil, media_bridge_id: nil, media_name: nil, media_url: nil, page_id: nil, page_name: nil, page_url: nil, raw_data_string: nil, request_options: {})
