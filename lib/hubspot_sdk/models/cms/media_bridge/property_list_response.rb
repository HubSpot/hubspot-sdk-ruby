    ...
    module Cms
      module MediaBridge
        ...
        class PropertyListResponse < HubspotSDK::Internal::Type::BaseModel
          # @!attribute results
          #
          #   @return [Array<HubspotSDK::Models::Cms::MediaBridge::PropertyListResponse::Result>]
          required :results,
                   -> { HubspotSDK::Internal::Type::ArrayOf[HubspotSDK::Models::Cms::MediaBridge::PropertyListResponse::Result] }

          # @!method initialize(results:)
          #   @param results [Array<HubspotSDK::Models::Cms::MediaBridge::PropertyListResponse::Result>]
          ...
          class Result < HubspotSDK::Internal::Type::BaseModel
            ...
            # @!attribute options
            #
            #   @return [Array<HubspotSDK::Models::Cms::MediaBridge::PropertyListResponse::Result::Option>]
            required :options,
                     -> { HubspotSDK::Internal::Type::ArrayOf[HubspotSDK::Models::Cms::MediaBridge::PropertyListResponse::Result::Option] }
            ...
            #
            #   @return [Symbol, HubspotSDK::Models::Cms::MediaBridge::PropertyListResponse::Result::DataSensitivity, nil]
            optional :data_sensitivity,
                     enum: -> { HubspotSDK::Models::Cms::MediaBridge::PropertyListResponse::Result::DataSensitivity },
                     api_name: :dataSensitivity

            # @!attribute date_display_hint
            #
            #   @return [Symbol, HubspotSDK::Models::Cms::MediaBridge::PropertyListResponse::Result::DateDisplayHint, nil]
            optional :date_display_hint,
                     enum: -> { HubspotSDK::Models::Cms::MediaBridge::PropertyListResponse::Result::DateDisplayHint },
            ...
            #   @param label [String]
            #   @param name [String]
            #   @param options [Array<HubspotSDK::Models::Cms::MediaBridge::PropertyListResponse::Result::Option>]
            #   @param type [String]
            ...
            #   @param data_sensitivity [Symbol, HubspotSDK::Models::Cms::MediaBridge::PropertyListResponse::Result::DataSensitivity]
            #   @param date_display_hint [Symbol, HubspotSDK::Models::Cms::MediaBridge::PropertyListResponse::Result::DateDisplayHint]
            ...
            # @see HubspotSDK::Models::Cms::MediaBridge::PropertyListResponse::Result#data_sensitivity
            ...
            # @see HubspotSDK::Models::Cms::MediaBridge::PropertyListResponse::Result#date_display_hint
