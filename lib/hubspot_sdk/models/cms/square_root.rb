  ...
  module Models
    module Cms
      class SquareRoot < HubSpotSDK::Internal::Type::BaseModel
        # @!attribute operator
        #
        #   @return [Symbol, HubSpotSDK::Models::Cms::SquareRoot::Operator]
        required :operator, enum: -> { HubSpotSDK::Cms::SquareRoot::Operator }
        ...
        optional :inputs, -> { HubSpotSDK::Internal::Type::ArrayOf[union: HubSpotSDK::Cms::SquareRoot::Input] }
        ...
        #   @param operator [Symbol, HubSpotSDK::Models::Cms::SquareRoot::Operator]
        ...
        # @see HubSpotSDK::Models::Cms::SquareRoot#operator
        module Operator
