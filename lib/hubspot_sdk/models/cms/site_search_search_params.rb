  ...
  module Models
    module Cms
      ...
      class SiteSearchSearchParams < HubspotSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [Float, nil]
        optional :boost_limit, Float

        # @!attribute boost_recent
        ...
        #
        #   @return [Float, nil]
        optional :popularity_boost, Float
        ...
        # @!method initialize(autocomplete: nil, boost_limit: nil, boost_recent: nil, domain: nil, group_id: nil, hubdb_query: nil, language: nil, length: nil, limit: nil, match_prefix: nil, offset: nil, path_prefix: nil, popularity_boost: nil, property: nil, q: nil, table_id: nil, type: nil, request_options: {})
