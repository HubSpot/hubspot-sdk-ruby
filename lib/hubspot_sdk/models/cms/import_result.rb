  ...
  module Models
    module Cms
      class ImportResult < HubSpotSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [Array<HubSpotSDK::Models::ErrorData>]
        required :errors, -> { HubSpotSDK::Internal::Type::ArrayOf[HubSpotSDK::ErrorData] }
        ...
        #
        #   @param errors [Array<HubSpotSDK::Models::ErrorData>] List of errors during import
        #
