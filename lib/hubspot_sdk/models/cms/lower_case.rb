  ...
  module Models
    module Cms
      class LowerCase < HubspotSDK::Internal::Type::BaseModel
        # @!attribute operator
        #
        #   @return [Symbol, HubspotSDK::Models::Cms::LowerCase::Operator]
        required :operator, enum: -> { HubspotSDK::Cms::LowerCase::Operator }
        ...
        optional :inputs, -> { HubspotSDK::Internal::Type::ArrayOf[union: HubspotSDK::Cms::LowerCase::Input] }
        ...
        #   @param operator [Symbol, HubspotSDK::Models::Cms::LowerCase::Operator]
        ...
        # @see HubspotSDK::Models::Cms::LowerCase#operator
        module Operator
