  ...
  module Models
    module Cms
      class Date < HubspotSDK::Internal::Type::BaseModel
        # @!attribute operator
        #
        #   @return [Symbol, HubspotSDK::Models::Cms::Date::Operator]
        required :operator, enum: -> { HubspotSDK::Cms::Date::Operator }
        ...
        optional :inputs, -> { HubspotSDK::Internal::Type::ArrayOf[union: HubspotSDK::Cms::Date::Input] }
        ...
        #   @param operator [Symbol, HubspotSDK::Models::Cms::Date::Operator]
        ...
        # @see HubspotSDK::Models::Cms::Date#operator
        module Operator
