  ...
  module Models
    module Cms
      class UpdateDocumentObjectRequest < HubspotSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, HubspotSDK::Models::Cms::UpdateDocumentObjectRequest::MediaType]
        required :media_type,
                 enum: -> { HubspotSDK::Cms::UpdateDocumentObjectRequest::MediaType },
                 api_name: :mediaType
        ...
        #   @param media_type [Symbol, HubspotSDK::Models::Cms::UpdateDocumentObjectRequest::MediaType]
        ...
        # @see HubspotSDK::Models::Cms::UpdateDocumentObjectRequest#media_type
        module MediaType
