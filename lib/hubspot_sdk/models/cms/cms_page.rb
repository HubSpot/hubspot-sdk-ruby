  ...
  module Models
    module Cms
      ...
      class CmsPage < HubspotSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, HubspotSDK::Models::Cms::CmsPage::AbStatus]
        required :ab_status, enum: -> { HubspotSDK::Cms::CmsPage::AbStatus }, api_name: :abStatus
        ...
        #   SITE_PAGE.
        #
        #   @return [Symbol, HubspotSDK::Models::Cms::CmsPage::ContentTypeCategory]
        required :content_type_category,
                 enum: -> { HubspotSDK::Cms::CmsPage::ContentTypeCategory },
        ...
        #
        #   @return [Symbol, HubspotSDK::Models::Cms::CmsPage::CurrentState]
        required :current_state, enum: -> { HubspotSDK::Cms::CmsPage::CurrentState }, api_name: :currentState
        ...
        #
        #   @return [Symbol, HubspotSDK::Models::Cms::CmsPage::Language]
        required :language, enum: -> { HubspotSDK::Cms::CmsPage::Language }
        ...
        #   {HubspotSDK::Models::Cms::CmsPage} for more details.
        #
        #   @param id [String] The unique ID of the page.
        #
        #   @param ab_status [Symbol, HubspotSDK::Models::Cms::CmsPage::AbStatus] The status of the AB test associated with this page, if applicable
        #
        ...
        #
        #   @param content_type_category [Symbol, HubspotSDK::Models::Cms::CmsPage::ContentTypeCategory] An ENUM descibing the type of this object. Should be either LANDING_PAGE or SITE
        #
        ...
        #
        #   @param current_state [Symbol, HubspotSDK::Models::Cms::CmsPage::CurrentState] A generated ENUM descibing the current state of this page.
        #
        ...
        #
        #   @param language [Symbol, HubspotSDK::Models::Cms::CmsPage::Language] The explicitly defined ISO 639 language code of the page. If null, the page will
        #
        ...
        # The status of the AB test associated with this page, if applicable
        #
        # @see HubspotSDK::Models::Cms::CmsPage#ab_status
        module AbStatus
        ...
        # SITE_PAGE.
        #
        # @see HubspotSDK::Models::Cms::CmsPage#content_type_category
        ...
        # A generated ENUM descibing the current state of this page.
        #
        # @see HubspotSDK::Models::Cms::CmsPage#current_state
        module CurrentState
          extend HubspotSDK::Internal::Type::Enum
        ...
        # default to the language of the Domain.
        #
        # @see HubspotSDK::Models::Cms::CmsPage#language
        module Language
          extend HubspotSDK::Internal::Type::Enum
