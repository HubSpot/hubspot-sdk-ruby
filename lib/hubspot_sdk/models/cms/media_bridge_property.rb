  ...
  module Models
    module Cms
      ...
      class MediaBridgeProperty < HubSpotSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, HubSpotSDK::Models::Cms::MediaBridgeProperty::DataSensitivity]
        required :data_sensitivity,
                 enum: -> { HubSpotSDK::Cms::MediaBridgeProperty::DataSensitivity },
                 api_name: :dataSensitivity

        # @!attribute date_display_hint
        #
        #   @return [Symbol, HubSpotSDK::Models::Cms::MediaBridgeProperty::DateDisplayHint]
        required :date_display_hint,
                 enum: -> { HubSpotSDK::Cms::MediaBridgeProperty::DateDisplayHint },
        ...
        #   "all_unique_versions".
        #
        #   @return [Symbol, HubSpotSDK::Models::Cms::MediaBridgeProperty::DisplayMode]
        required :display_mode,
                 enum: -> { HubSpotSDK::Cms::MediaBridgeProperty::DisplayMode },
                 api_name: :displayMode
        ...
        #   "probability".
        #
        #   @return [Symbol, HubSpotSDK::Models::Cms::MediaBridgeProperty::NumberDisplayHint]
        required :number_display_hint,
                 enum: -> { HubSpotSDK::Cms::MediaBridgeProperty::NumberDisplayHint },
        ...
        #
        #   @return [Symbol, HubSpotSDK::Models::Cms::MediaBridgeProperty::OptionSortStrategy]
        required :option_sort_strategy,
                 enum: -> { HubSpotSDK::Cms::MediaBridgeProperty::OptionSortStrategy },
        ...
        #
        #   @return [Symbol, HubSpotSDK::Models::Cms::MediaBridgeProperty::ReferencedObjectType]
        required :referenced_object_type,
                 enum: -> { HubSpotSDK::Cms::MediaBridgeProperty::ReferencedObjectType },
        ...
        #
        #   @return [Symbol, HubSpotSDK::Models::Cms::MediaBridgeProperty::SearchTextAnalysisMode]
        required :search_text_analysis_mode,
                 enum: -> { HubSpotSDK::Cms::MediaBridgeProperty::SearchTextAnalysisMode },
        ...
        #
        #   @return [Symbol, HubSpotSDK::Models::Cms::MediaBridgeProperty::TextDisplayHint]
        required :text_display_hint,
                 enum: -> { HubSpotSDK::Cms::MediaBridgeProperty::TextDisplayHint },
                 api_name: :textDisplayHint

        # @!attribute type
        #   The data type of the property, such as string or number.
        #
        #   @return [Symbol, HubSpotSDK::Models::Cms::MediaBridgeProperty::Type]
        required :type, enum: -> { HubSpotSDK::Cms::MediaBridgeProperty::Type }
        ...
        #   {HubSpotSDK::Models::Cms::MediaBridgeProperty} for more details.
        #
        #   A HubSpot property
        #
        ...
        #
        #   @param data_sensitivity [Symbol, HubSpotSDK::Models::Cms::MediaBridgeProperty::DataSensitivity] Indicates the sensitivity level of the property, such as "non_sensitive", "sensi
        #
        #   @param date_display_hint [Symbol, HubSpotSDK::Models::Cms::MediaBridgeProperty::DateDisplayHint]
        #
        #   @param deleted [Boolean] Whether the property has been deleted.
        #
        #   @param description [String] A summary of the property's purpose.
        #
        #   @param display_mode [Symbol, HubSpotSDK::Models::Cms::MediaBridgeProperty::DisplayMode] The mode in which the property is displayed. Can be: "current_value" or "all_uni
        #
        ...
        #
        #   @param number_display_hint [Symbol, HubSpotSDK::Models::Cms::MediaBridgeProperty::NumberDisplayHint] Hint for how a number property is displayed and validated in HubSpot's UI. Can b
        #
        ...
        #
        #   @param option_sort_strategy [Symbol, HubSpotSDK::Models::Cms::MediaBridgeProperty::OptionSortStrategy] Specifies how to sort property options. Can be either "DISPLAY_ORDER" to defer t
        #
        ...
        #
        #   @param referenced_object_type [Symbol, HubSpotSDK::Models::Cms::MediaBridgeProperty::ReferencedObjectType] Deprecated. Use externalOptionsReferenceType instead.
        #
        #   @param searchable_in_global_search [Boolean] Whether the property is searchable globaly.
        #
        #   @param search_text_analysis_mode [Symbol, HubSpotSDK::Models::Cms::MediaBridgeProperty::SearchTextAnalysisMode]
        #
        ...
        #
        #   @param text_display_hint [Symbol, HubSpotSDK::Models::Cms::MediaBridgeProperty::TextDisplayHint] Hint for how the text is displayed and validated in HubSpot's UI. Can be: "unfor
        #
        #   @param type [Symbol, HubSpotSDK::Models::Cms::MediaBridgeProperty::Type] The data type of the property, such as string or number.
        #
        ...
        # "sensitive", or "highly_sensitive".
        #
        # @see HubSpotSDK::Models::Cms::MediaBridgeProperty#data_sensitivity
        ...
        # @see HubSpotSDK::Models::Cms::MediaBridgeProperty#date_display_hint
        ...
        # "all_unique_versions".
        #
        # @see HubSpotSDK::Models::Cms::MediaBridgeProperty#display_mode
        module DisplayMode
          extend HubSpotSDK::Internal::Type::Enum
        ...
        # "probability".
        #
        # @see HubSpotSDK::Models::Cms::MediaBridgeProperty#number_display_hint
        ...
        # to the displayOrder field, or "ALPHABETICAL".
        #
        # @see HubSpotSDK::Models::Cms::MediaBridgeProperty#option_sort_strategy
        ...
        # Deprecated. Use externalOptionsReferenceType instead.
        #
        # @see HubSpotSDK::Models::Cms::MediaBridgeProperty#referenced_object_type
        ...
        # @see HubSpotSDK::Models::Cms::MediaBridgeProperty#search_text_analysis_mode
        ...
        # "ip_address", "physical_address", or "postal_code".
        #
        # @see HubSpotSDK::Models::Cms::MediaBridgeProperty#text_display_hint
        ...
        # The data type of the property, such as string or number.
        #
        # @see HubSpotSDK::Models::Cms::MediaBridgeProperty#type
        module Type
          extend HubSpotSDK::Internal::Type::Enum
