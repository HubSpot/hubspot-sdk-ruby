...
module HubspotSDK
  module Models
    module Cms
      module Blogs
        # @see HubspotSDK::Resources::Cms::Blogs::Tags#create_batch
        class BatchResponseTag < HubspotSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, HubspotSDK::Models::Cms::Blogs::BatchResponseTag::Status]
          required :status, enum: -> { HubspotSDK::Cms::Blogs::BatchResponseTag::Status }
          ...
          #
          #   @param results [Array<HubspotSDK::Models::Cms::Blogs::Tag>] Results of batch operation.
          #
          #   @param started_at [Time] Time of batch operation start.
          #
          #   @param status [Symbol, HubspotSDK::Models::Cms::Blogs::BatchResponseTag::Status] Status of batch operation.
          #
          ...
          # Status of batch operation.
          #
          # @see HubspotSDK::Models::Cms::Blogs::BatchResponseTag#status
          module Status
