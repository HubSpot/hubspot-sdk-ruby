...
module HubSpotSDK
  module Models
    module Cms
      module Blogs
        class BatchResponseBlogPostWithErrors < HubSpotSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, HubSpotSDK::Models::Cms::Blogs::BatchResponseBlogPostWithErrors::Status]
          required :status, enum: -> { HubSpotSDK::Cms::Blogs::BatchResponseBlogPostWithErrors::Status }
          ...
          #
          #   @param status [Symbol, HubSpotSDK::Models::Cms::Blogs::BatchResponseBlogPostWithErrors::Status] Status of batch operation.
          #
          ...
          # Status of batch operation.
          #
          # @see HubSpotSDK::Models::Cms::Blogs::BatchResponseBlogPostWithErrors#status
          module Status
