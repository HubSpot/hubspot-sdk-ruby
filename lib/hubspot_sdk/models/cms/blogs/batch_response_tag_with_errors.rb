    ...
    module Cms
      module Blogs
        class BatchResponseTagWithErrors < HubspotSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, HubspotSDK::Models::Cms::Blogs::BatchResponseTagWithErrors::Status]
          required :status, enum: -> { HubspotSDK::Cms::Blogs::BatchResponseTagWithErrors::Status }
          ...
          #
          #   @param status [Symbol, HubspotSDK::Models::Cms::Blogs::BatchResponseTagWithErrors::Status] Status of batch operation.
          #
          ...
          # Status of batch operation.
          #
          # @see HubspotSDK::Models::Cms::Blogs::BatchResponseTagWithErrors#status
          module Status
