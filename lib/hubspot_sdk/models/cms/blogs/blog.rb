    ...
    module Cms
      module Blogs
        ...
        class Blog < HubspotSDK::Internal::Type::BaseModel
          ...
          # @!method initialize(id:, absolute_url:, allow_comments:, created:, deleted_at:, description:, html_title:, language:, name:, public_access_rules:, public_access_rules_enabled:, public_title:, slug:, translated_from_id:, updated:)
