  ...
  module Models
    class PublicNotAllFilterBranch < HubspotSDK::Internal::Type::BaseModel
      ...
      required :filter_branches,
               -> {
                 HubspotSDK::Internal::Type::ArrayOf[union: HubspotSDK::PublicNotAllFilterBranch::FilterBranch]
               },
      ...
      #
      #   @return [Symbol, HubspotSDK::Models::PublicNotAllFilterBranch::FilterBranchType]
      required :filter_branch_type,
               enum: -> { HubspotSDK::PublicNotAllFilterBranch::FilterBranchType },
      ...
      required :filters,
               -> { HubspotSDK::Internal::Type::ArrayOf[union: HubspotSDK::PublicNotAllFilterBranch::Filter] }
      ...
      #   @param filter_branch_type [Symbol, HubspotSDK::Models::PublicNotAllFilterBranch::FilterBranchType]
      ...
      # @see HubspotSDK::Models::PublicNotAllFilterBranch#filter_branch_type
