...
module HubspotSDK
  module Models
    module Marketing
      class RadioField < HubspotSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, HubspotSDK::Models::Marketing::RadioField::FieldType]
        required :field_type, enum: -> { HubspotSDK::Marketing::RadioField::FieldType }, api_name: :fieldType
        ...
        # @!method initialize(default_values:, dependent_fields:, field_type:, hidden:, label:, name:, object_type_id:, options:, required:, description: nil, placeholder: nil)
        #   Some parameter documentations has been truncated, see
        #   {HubspotSDK::Models::Marketing::RadioField} for more details.
        #
        ...
        #
        #   @param field_type [Symbol, HubspotSDK::Models::Marketing::RadioField::FieldType] Determines how the field will be displayed and validated.
        #
        ...
        # Determines how the field will be displayed and validated.
        #
        # @see HubspotSDK::Models::Marketing::RadioField#field_type
        module FieldType
