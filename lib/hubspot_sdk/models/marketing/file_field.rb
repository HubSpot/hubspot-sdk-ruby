...
module HubspotSDK
  module Models
    module Marketing
      class FileField < HubspotSDK::Internal::Type::BaseModel
        # @!attribute allow_multiple_files
        #   Whether to allow the upload of multiple files.
        #
        #   @return [Boolean]
        required :allow_multiple_files, HubspotSDK::Internal::Type::Boolean, api_name: :allowMultipleFiles
        ...
        #
        #   @return [Symbol, HubspotSDK::Models::Marketing::FileField::FieldType]
        required :field_type, enum: -> { HubspotSDK::Marketing::FileField::FieldType }, api_name: :fieldType
        ...
        # @!method initialize(allow_multiple_files:, dependent_fields:, field_type:, hidden:, label:, name:, object_type_id:, required:, default_value: nil, description: nil, placeholder: nil)
        #   Some parameter documentations has been truncated, see
        #   {HubspotSDK::Models::Marketing::FileField} for more details.
        #
        #   A form field used for uploading one or more files.
        #
        #   @param allow_multiple_files [Boolean] Whether to allow the upload of multiple files.
        #
        ...
        #
        #   @param field_type [Symbol, HubspotSDK::Models::Marketing::FileField::FieldType] Determines how the field will be displayed and validated.
        #
        ...
        # Determines how the field will be displayed and validated.
        #
        # @see HubspotSDK::Models::Marketing::FileField#field_type
        module FieldType
