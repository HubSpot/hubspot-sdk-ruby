  ...
  module Models
    module Marketing
      class MultiLineTextField < HubspotSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, HubspotSDK::Models::Marketing::MultiLineTextField::FieldType]
        required :field_type,
                 enum: -> { HubspotSDK::Marketing::MultiLineTextField::FieldType },
                 api_name: :fieldType
        ...
        #   {HubspotSDK::Models::Marketing::MultiLineTextField} for more details.
        #
        ...
        #
        #   @param field_type [Symbol, HubspotSDK::Models::Marketing::MultiLineTextField::FieldType] Determines how the field will be displayed and validated.
        #
        ...
        # Determines how the field will be displayed and validated.
        #
        # @see HubspotSDK::Models::Marketing::MultiLineTextField#field_type
        module FieldType
