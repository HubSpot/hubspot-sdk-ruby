...
module HubspotSDK
  module Models
    module Marketing
      ...
      class HubSpotFormDefinition < HubspotSDK::Internal::Type::BaseModel
        # @!attribute id
        #
        #   @return [String]
        required :id, String
        ...
        # @!attribute form_type
        #
        #   @return [Symbol, HubspotSDK::Models::Marketing::HubSpotFormDefinition::FormType]
        required :form_type,
                 enum: -> { HubspotSDK::Marketing::HubSpotFormDefinition::FormType },
                 api_name: :formType
        ...
        required :legal_consent_options,
                 union: -> { HubspotSDK::Marketing::HubSpotFormDefinition::LegalConsentOptions },
        ...
        # @!method initialize(id:, archived:, configuration:, created_at:, display_options:, field_groups:, form_type:, legal_consent_options:, name:, updated_at:, archived_at: nil)
        #   @param id [String]
        #
        ...
        #
        #   @param form_type [Symbol, HubspotSDK::Models::Marketing::HubSpotFormDefinition::FormType]
        #
        ...
        # @see HubspotSDK::Models::Marketing::HubSpotFormDefinition#form_type
        module FormType
        ...
        # @see HubspotSDK::Models::Marketing::HubSpotFormDefinition#legal_consent_options
