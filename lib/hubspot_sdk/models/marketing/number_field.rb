...
module HubspotSDK
  module Models
    module Marketing
      class NumberField < HubspotSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, HubspotSDK::Models::Marketing::NumberField::FieldType]
        required :field_type, enum: -> { HubspotSDK::Marketing::NumberField::FieldType }, api_name: :fieldType
        ...
        #
        #   @return [HubspotSDK::Models::Marketing::NumberFieldValidation, nil]
        optional :validation, -> { HubspotSDK::Marketing::NumberFieldValidation }

        # @!method initialize(dependent_fields:, field_type:, hidden:, label:, name:, object_type_id:, required:, default_value: nil, description: nil, placeholder: nil, validation: nil)
        #   Some parameter documentations has been truncated, see
        #   {HubspotSDK::Models::Marketing::NumberField} for more details.
        #
        ...
        #
        #   @param field_type [Symbol, HubspotSDK::Models::Marketing::NumberField::FieldType] Determines how the field will be displayed and validated.
        #
        ...
        #
        #   @param validation [HubspotSDK::Models::Marketing::NumberFieldValidation] Describes how a numeric value should be validated.

        # Determines how the field will be displayed and validated.
        #
        # @see HubspotSDK::Models::Marketing::NumberField#field_type
        module FieldType
