...
module HubspotSDK
  module Models
    module Marketing
      ...
      class FormDefinitionBase < HubspotSDK::Internal::Type::BaseModel
        # @!attribute id
        #
        #   @return [String]
        required :id, String
        ...
        # @!attribute form_type
        #
        #   @return [Symbol, HubspotSDK::Models::Marketing::FormDefinitionBase::FormType]
        required :form_type,
                 enum: -> {
                   HubspotSDK::Marketing::FormDefinitionBase::FormType
                 },
                 api_name: :formType
        ...
        required :legal_consent_options,
                 union: -> { HubspotSDK::Marketing::FormDefinitionBase::LegalConsentOptions },
        ...
        #
        #   @param form_type [Symbol, HubspotSDK::Models::Marketing::FormDefinitionBase::FormType]
        #
        ...
        # @see HubspotSDK::Models::Marketing::FormDefinitionBase#form_type
        module FormType
        ...
        # @see HubspotSDK::Models::Marketing::FormDefinitionBase#legal_consent_options
