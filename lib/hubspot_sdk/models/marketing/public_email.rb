  ...
  module Models
    module Marketing
      ...
      class PublicEmail < HubspotSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [HubspotSDK::Models::Marketing::PublicEmailContent]
        required :content, -> { HubspotSDK::Marketing::PublicEmailContent }

        # @!attribute from
        #   Data structure representing the from fields on the email.
        #
        #   @return [HubspotSDK::Models::Marketing::PublicEmailFromDetails]
        required :from, -> { HubspotSDK::Marketing::PublicEmailFromDetails }
        ...
        #
        #   @return [Boolean]
        required :send_on_publish, HubspotSDK::Internal::Type::Boolean, api_name: :sendOnPublish

        # @!attribute state
        #   The email state.
        #
        #   @return [Symbol, HubspotSDK::Models::Marketing::PublicEmail::State]
        required :state, enum: -> { HubspotSDK::Marketing::PublicEmail::State }
        ...
        #
        #   @return [HubspotSDK::Models::Marketing::PublicEmailToDetails]
        required :to, -> { HubspotSDK::Marketing::PublicEmailToDetails }
        ...
        # @!attribute all_email_campaign_ids
        ...
        # @!attribute campaign_utm
        #
        #   @return [String, nil]
        optional :campaign_utm, String, api_name: :campaignUtm

        # @!attribute cloned_from
        #   The ID of the email this email was cloned from.
        #
        #   @return [String, nil]
        optional :cloned_from, String, api_name: :clonedFrom
        ...
        # @!attribute email_campaign_group_id
        #
        #   @return [String, nil]
        optional :email_campaign_group_id, String, api_name: :emailCampaignGroupId
        ...
        #
        #   @return [String, nil]
        optional :feedback_survey_id, String, api_name: :feedbackSurveyId

        # @!attribute folder_id
        #
        #   @return [Integer, nil]
        optional :folder_id, Integer, api_name: :folderId
        ...
        #
        #   @return [Boolean, nil]
        optional :is_ab, HubspotSDK::Internal::Type::Boolean, api_name: :isAb
        ...
        # @!attribute preview_key
        #
        #   @return [String, nil]
        optional :preview_key, String, api_name: :previewKey

        # @!attribute primary_email_campaign_id
        #
        #   @return [String, nil]
        optional :primary_email_campaign_id, String, api_name: :primaryEmailCampaignId
        ...
        # @!attribute published_by_email
        #   Email of the user who published/sent the email.
        #
        #   @return [String, nil]
        optional :published_by_email, String, api_name: :publishedByEmail

        # @!attribute published_by_id
        #   The ID of the user who published the email.
        #
        #   @return [String, nil]
        optional :published_by_id, String, api_name: :publishedById

        # @!attribute published_by_name
        #   Name of the user who published the email.
        #
        #   @return [String, nil]
        optional :published_by_name, String, api_name: :publishedByName
        ...
        #
        #   @return [Time, nil]
        optional :unpublished_at, Time, api_name: :unpublishedAt
        ...
        # @!method initialize(id:, content:, from:, name:, send_on_publish:, state:, subcategory:, subject:, to:, active_domain: nil, all_email_campaign_ids: nil, archived: nil, business_unit_id: nil, campaign: nil, campaign_name: nil, campaign_utm: nil, cloned_from: nil, created_at: nil, created_by_id: nil, deleted_at: nil, email_campaign_group_id: nil, email_template_mode: nil, feedback_survey_id: nil, folder_id: nil, folder_id_v2: nil, is_ab: nil, is_published: nil, is_transactional: nil, jitter_send_time: nil, language: nil, preview_key: nil, primary_email_campaign_id: nil, publish_date: nil, published_at: nil, published_by_email: nil, published_by_id: nil, published_by_name: nil, rss_data: nil, stats: nil, subscription_details: nil, teams_with_access: nil, testing: nil, type: nil, unpublished_at: nil, updated_at: nil, updated_by_id: nil, users_with_access: nil, webversion: nil, workflow_names: nil)
        ...
        #
        #   @param all_email_campaign_ids [Array<String>] List of emailCampaignIds.
        #
        ...
        #
        #   @param created_by_id [String] The id of the user who created the email.
        #
        #   @param deleted_at [Time] The date and time the email was deleted at, in ISO8601 representation.
        #
        ...
        #
        #   @param is_transactional [Boolean] Returns whether the email is a transactional email or not. This is read only.
        #
        ...
        #
        #   @param primary_email_campaign_id [String]
        #
        #   @param publish_date [Time] The date and time the email is scheduled for, in ISO8601 representation. This is
        #
        #   @param published_at [Time] The date and time the email was published at, in ISO8601 representation.
        #
        #   @param published_by_email [String] Email of the user who published/sent the email.
        #
        #   @param published_by_id [String] The ID of the user who published the email.
        #
