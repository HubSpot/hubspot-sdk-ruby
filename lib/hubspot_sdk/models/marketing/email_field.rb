  ...
  module Models
    module Marketing
      class EmailField < HubspotSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, HubspotSDK::Models::Marketing::EmailField::FieldType]
        required :field_type, enum: -> { HubspotSDK::Marketing::EmailField::FieldType }, api_name: :fieldType
        ...
        #
        #   @return [HubspotSDK::Models::Marketing::EmailFieldValidation]
        required :validation, -> { HubspotSDK::Marketing::EmailFieldValidation }
        ...
        # @!method initialize(dependent_fields:, field_type:, hidden:, label:, name:, object_type_id:, required:, validation:, default_value: nil, description: nil, placeholder: nil)
        #   Some parameter documentations has been truncated, see
        #   {HubspotSDK::Models::Marketing::EmailField} for more details.
        #
        ...
        #
        #   @param field_type [Symbol, HubspotSDK::Models::Marketing::EmailField::FieldType] Determines how the field will be displayed and validated.
        #
        ...
        #
        #   @param validation [HubspotSDK::Models::Marketing::EmailFieldValidation] Describes how an email address should be validated.
        #
        ...
        # Determines how the field will be displayed and validated.
        #
        # @see HubspotSDK::Models::Marketing::EmailField#field_type
        module FieldType
