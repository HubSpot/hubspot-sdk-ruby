...
module HubspotSDK
  module Models
    module Marketing
      class SingleCheckboxField < HubspotSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, HubspotSDK::Models::Marketing::SingleCheckboxField::FieldType]
        required :field_type,
                 enum: -> { HubspotSDK::Marketing::SingleCheckboxField::FieldType },
                 api_name: :fieldType
        ...
        # @!method initialize(dependent_fields:, field_type:, hidden:, label:, name:, object_type_id:, required:, default_value: nil, description: nil)
        #   Some parameter documentations has been truncated, see
        #   {HubspotSDK::Models::Marketing::SingleCheckboxField} for more details.
        #
        ...
        #
        #   @param field_type [Symbol, HubspotSDK::Models::Marketing::SingleCheckboxField::FieldType] Determines how the field will be displayed and validated.
        #
        ...
        # Determines how the field will be displayed and validated.
        #
        # @see HubspotSDK::Models::Marketing::SingleCheckboxField#field_type
        module FieldType
