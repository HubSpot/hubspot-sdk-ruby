    ...
    module Marketing
      module Subscriptions
        class BatchResponsePublicStatusBulkResponseWithErrors < HubspotSDK::Internal::Type::BaseModel
          ...
          #   or COMPLETE.
          #
          #   @return [Symbol, HubspotSDK::Models::Marketing::Subscriptions::BatchResponsePublicStatusBulkResponseWithErrors::Status]
          required :status,
                   enum: -> { HubspotSDK::Marketing::Subscriptions::BatchResponsePublicStatusBulkResponseWithErrors::Status }
          ...
          #   {HubspotSDK::Models::Marketing::Subscriptions::BatchResponsePublicStatusBulkResponseWithErrors}
          #   for more details.
          #
          #   @param completed_at [Time] The date and time when the operation was completed.
          #
          #   @param results [Array<HubspotSDK::Models::Marketing::Subscriptions::PublicStatusBulkResponse>] An array containing the results of the operation.
          #
          #   @param started_at [Time] The date and time when the operation started.
          #
          #   @param status [Symbol, HubspotSDK::Models::Marketing::Subscriptions::BatchResponsePublicStatusBulkResponseWithErrors::Status] The current status of the operation, which can be PENDING, PROCESSING, CANCELED,
          #
          ...
          # or COMPLETE.
          #
          # @see HubspotSDK::Models::Marketing::Subscriptions::BatchResponsePublicStatusBulkResponseWithErrors#status
          module Status
