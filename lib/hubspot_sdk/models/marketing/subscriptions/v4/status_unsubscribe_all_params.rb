  ...
  module Models
    module Marketing
      module Subscriptions
        module V4
          # @see HubspotSDK::Resources::Marketing::Subscriptions::V4::Statuses#unsubscribe_all
          class StatusUnsubscribeAllParams < HubspotSDK::Internal::Type::BaseModel
            ...
            #
            #   @return [Symbol, HubspotSDK::Models::Marketing::Subscriptions::V4::StatusUnsubscribeAllParams::Channel]
            required :channel,
                     enum: -> { HubspotSDK::Marketing::Subscriptions::V4::StatusUnsubscribeAllParams::Channel }
