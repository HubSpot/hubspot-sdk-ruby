  ...
  module Models
    module Marketing
      module Subscriptions
        module V4
          # @see HubspotSDK::Resources::Marketing::Subscriptions::V4::Statuses#get_unsubscribe_all_status
          class StatusGetUnsubscribeAllStatusParams < HubspotSDK::Internal::Type::BaseModel
            ...
            #
            #   @return [Symbol, HubspotSDK::Models::Marketing::Subscriptions::V4::StatusGetUnsubscribeAllStatusParams::Channel]
            required :channel,
                     enum: -> { HubspotSDK::Marketing::Subscriptions::V4::StatusGetUnsubscribeAllStatusParams::Channel }
