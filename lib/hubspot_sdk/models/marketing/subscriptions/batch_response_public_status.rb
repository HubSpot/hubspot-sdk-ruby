    ...
    module Marketing
      module Subscriptions
        class BatchResponsePublicStatus < HubspotSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, HubspotSDK::Models::Marketing::Subscriptions::BatchResponsePublicStatus::Status]
          required :status, enum: -> { HubspotSDK::Marketing::Subscriptions::BatchResponsePublicStatus::Status }
          ...
          #   {HubspotSDK::Models::Marketing::Subscriptions::BatchResponsePublicStatus} for
          #   more details.
          #
          #   @param completed_at [Time] The date and time when the batch operation was completed.
          #
          #   @param results [Array<HubspotSDK::Models::Marketing::Subscriptions::PublicStatus>] An array containing the results of the batch operation.
          #
          #   @param started_at [Time] The date and time when the batch operation started.
          #
          #   @param status [Symbol, HubspotSDK::Models::Marketing::Subscriptions::BatchResponsePublicStatus::Status] The current status of the batch operation, which can be PENDING, PROCESSING, CAN
          #
          ...
          # CANCELED, or COMPLETE.
          #
          # @see HubspotSDK::Models::Marketing::Subscriptions::BatchResponsePublicStatus#status
          module Status
