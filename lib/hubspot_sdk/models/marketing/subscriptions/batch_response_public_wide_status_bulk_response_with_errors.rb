    ...
    module Marketing
      module Subscriptions
        class BatchResponsePublicWideStatusBulkResponseWithErrors < HubspotSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<HubspotSDK::Models::Marketing::Subscriptions::PublicWideStatusBulkResponse>]
          required :results,
                   -> { HubspotSDK::Internal::Type::ArrayOf[HubspotSDK::Marketing::Subscriptions::PublicWideStatusBulkResponse] }
          ...
          #   or COMPLETE.
          #
          #   @return [Symbol, HubspotSDK::Models::Marketing::Subscriptions::BatchResponsePublicWideStatusBulkResponseWithErrors::Status]
          required :status,
                   enum: -> { HubspotSDK::Marketing::Subscriptions::BatchResponsePublicWideStatusBulkResponseWithErrors::Status }
          ...
          #   {HubspotSDK::Models::Marketing::Subscriptions::BatchResponsePublicWideStatusBulkResponseWithErrors}
          #   for more details.
          #
          #   @param completed_at [Time] The date and time when the operation was completed.
          #
          #   @param results [Array<HubspotSDK::Models::Marketing::Subscriptions::PublicWideStatusBulkResponse>] An array containing the results of the operation.
          #
          #   @param started_at [Time] The date and time when the operation started.
          #
          #   @param status [Symbol, HubspotSDK::Models::Marketing::Subscriptions::BatchResponsePublicWideStatusBulkResponseWithErrors::Status] The current status of the operation, which can be PENDING, PROCESSING, CANCELED,
          #
          ...
          # or COMPLETE.
          #
          # @see HubspotSDK::Models::Marketing::Subscriptions::BatchResponsePublicWideStatusBulkResponseWithErrors#status
          module Status
