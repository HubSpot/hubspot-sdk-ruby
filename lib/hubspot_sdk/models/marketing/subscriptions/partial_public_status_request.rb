    ...
    module Marketing
      module Subscriptions
        class PartialPublicStatusRequest < HubspotSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, HubspotSDK::Models::Marketing::Subscriptions::PartialPublicStatusRequest::Channel]
          required :channel, enum: -> { HubspotSDK::Marketing::Subscriptions::PartialPublicStatusRequest::Channel }
          ...
          #
          #   @return [Symbol, HubspotSDK::Models::Marketing::Subscriptions::PartialPublicStatusRequest::StatusState]
          required :status_state,
                   enum: -> { HubspotSDK::Marketing::Subscriptions::PartialPublicStatusRequest::StatusState },
          ...
          #
          #   @return [Symbol, HubspotSDK::Models::Marketing::Subscriptions::PartialPublicStatusRequest::LegalBasis, nil]
          optional :legal_basis,
                   enum: -> { HubspotSDK::Marketing::Subscriptions::PartialPublicStatusRequest::LegalBasis },
                   api_name: :legalBasis
          ...
          #   {HubspotSDK::Models::Marketing::Subscriptions::PartialPublicStatusRequest} for
          #   more details.
          #
          ...
          # The type of communication channel, with 'EMAIL' as the only supported option.
          #
          # @see HubspotSDK::Models::Marketing::Subscriptions::PartialPublicStatusRequest#channel
          module Channel
          ...
          # 'UNSUBSCRIBED', or 'NOT_SPECIFIED'.
          #
          # @see HubspotSDK::Models::Marketing::Subscriptions::PartialPublicStatusRequest#status_state
          module StatusState
            extend HubspotSDK::Internal::Type::Enum
          ...
          # 'PROCESS_AND_STORE', and 'LEGITIMATE_INTEREST_OTHER'.
          #
          # @see HubspotSDK::Models::Marketing::Subscriptions::PartialPublicStatusRequest#legal_basis
          module LegalBasis
            extend HubspotSDK::Internal::Type::Enum
