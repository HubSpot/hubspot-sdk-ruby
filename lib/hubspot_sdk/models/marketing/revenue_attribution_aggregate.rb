  ...
  module Models
    module Marketing
      class RevenueAttributionAggregate < HubspotSDK::Internal::Type::BaseModel
        ...
        #   @param contacts_number [Integer]
        #   @param currency_code [Symbol, HubspotSDK::Models::Marketing::RevenueAttributionAggregate::CurrencyCode]
        #   @param deal_amount [Float]
        #   @param deals_number [Integer]
        #   @param revenue_amount [Float]
