  ...
  module Models
    module Marketing
      class PhoneField < HubspotSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, HubspotSDK::Models::Marketing::PhoneField::FieldType]
        required :field_type, enum: -> { HubspotSDK::Marketing::PhoneField::FieldType }, api_name: :fieldType
        ...
        # @!attribute use_country_code_select
        #   Whether to display a country code drop down next to the phone field.
        #
        #   @return [Boolean]
        required :use_country_code_select,
                 HubspotSDK::Internal::Type::Boolean,
                 api_name: :useCountryCodeSelect

        # @!attribute validation
        #   Describes how a phone number should be validated.
        #
        #   @return [HubspotSDK::Models::Marketing::PhoneFieldValidation]
        required :validation, -> { HubspotSDK::Marketing::PhoneFieldValidation }
        ...
        # @!method initialize(dependent_fields:, field_type:, hidden:, label:, name:, object_type_id:, required:, use_country_code_select:, validation:, default_value: nil, description: nil, placeholder: nil)
        #   Some parameter documentations has been truncated, see
        #   {HubspotSDK::Models::Marketing::PhoneField} for more details.
        #
        ...
        #
        #   @param field_type [Symbol, HubspotSDK::Models::Marketing::PhoneField::FieldType] Determines how the field will be displayed and validated.
        #
        ...
        #
        #   @param use_country_code_select [Boolean] Whether to display a country code drop down next to the phone field.
        #
        #   @param validation [HubspotSDK::Models::Marketing::PhoneFieldValidation] Describes how a phone number should be validated.
        #
        ...
        # Determines how the field will be displayed and validated.
        #
        # @see HubspotSDK::Models::Marketing::PhoneField#field_type
        module FieldType
