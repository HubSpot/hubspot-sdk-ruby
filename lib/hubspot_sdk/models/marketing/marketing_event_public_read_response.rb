...
module HubspotSDK
  module Models
    module Marketing
      # @see HubspotSDK::Resources::Marketing::Events#get_by_external_event_id
      class MarketingEventPublicReadResponse < HubspotSDK::Internal::Type::BaseModel
        ...
        # @!method initialize(id:, attendees:, cancellations:, created_at:, event_name:, event_organizer:, external_event_id:, no_shows:, registrants:, updated_at:, custom_properties: nil, end_date_time: nil, event_cancelled: nil, event_completed: nil, event_description: nil, event_type: nil, event_url: nil, object_id_: nil, start_date_time: nil)
