...
module HubspotSDK
  module Models
    module Marketing
      # @see HubspotSDK::Resources::Marketing::Events#upsert_subscriber_state_by_id
      class EventUpsertSubscriberStateByIDParams < HubspotSDK::Models::Marketing::BatchInputMarketingEventSubscriber
