...
module HubspotSDK
  module Models
    module Marketing
      module Events
        # @see HubspotSDK::Resources::Marketing::Events::Participations#list_breakdown_by_external_account_and_event_id
        class ParticipationListBreakdownByExternalAccountAndEventIDParams < HubspotSDK::Internal::Type::BaseModel
          ...
          # @!method initialize(external_account_id:, after: nil, contact_identifier: nil, limit: nil, state: nil, request_options: {})
