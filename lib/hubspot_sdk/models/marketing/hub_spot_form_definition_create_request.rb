...
module HubspotSDK
  module Models
    module Marketing
      class HubSpotFormDefinitionCreateRequest < HubspotSDK::Internal::Type::BaseModel
        # @!attribute archived
        #
        #   @return [Boolean]
        ...
        # @!attribute form_type
        #
        #   @return [Symbol, HubspotSDK::Models::Marketing::HubSpotFormDefinitionCreateRequest::FormType]
        required :form_type,
                 enum: -> { HubspotSDK::Marketing::HubSpotFormDefinitionCreateRequest::FormType },
                 api_name: :formType
        ...
        required :legal_consent_options,
                 union: -> { HubspotSDK::Marketing::HubSpotFormDefinitionCreateRequest::LegalConsentOptions },
        ...
        #
        #   @param form_type [Symbol, HubspotSDK::Models::Marketing::HubSpotFormDefinitionCreateRequest::FormType]
        #
        ...
        # @see HubspotSDK::Models::Marketing::HubSpotFormDefinitionCreateRequest#form_type
        module FormType
        ...
        # @see HubspotSDK::Models::Marketing::HubSpotFormDefinitionCreateRequest#legal_consent_options
