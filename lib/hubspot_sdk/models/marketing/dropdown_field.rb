  ...
  module Models
    module Marketing
      class DropdownField < HubspotSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, HubspotSDK::Models::Marketing::DropdownField::FieldType]
        required :field_type,
                 enum: -> {
                   HubspotSDK::Marketing::DropdownField::FieldType
                 },
                 api_name: :fieldType
        ...
        #   {HubspotSDK::Models::Marketing::DropdownField} for more details.
        #
        ...
        #
        #   @param field_type [Symbol, HubspotSDK::Models::Marketing::DropdownField::FieldType] Determines how the field will be displayed and validated.
        #
        ...
        # Determines how the field will be displayed and validated.
        #
        # @see HubspotSDK::Models::Marketing::DropdownField#field_type
        module FieldType
