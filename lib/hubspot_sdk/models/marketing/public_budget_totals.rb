  ...
  module Models
    module Marketing
      class PublicBudgetTotals < HubspotSDK::Internal::Type::BaseModel
        ...
        #   @param budget_items [Array<HubspotSDK::Models::Marketing::PublicBudgetItem>]
        #   @param currency_code [Symbol, HubspotSDK::Models::Marketing::PublicBudgetTotals::CurrencyCode]
        #   @param spend_items [Array<HubspotSDK::Models::Marketing::PublicSpendItem>]
        #   @param budget_total [Float]
        #   @param remaining_budget [Float]
        #   @param spend_total [Float]
