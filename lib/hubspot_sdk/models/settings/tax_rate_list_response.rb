  ...
  module Models
    module Settings
      ...
      class TaxRateListResponse < HubspotSDK::Internal::Type::BaseModel
        # @!attribute results
        #
        #   @return [Array<HubspotSDK::Models::Settings::TaxRateListResponse::Result>]
        required :results,
                 -> { HubspotSDK::Internal::Type::ArrayOf[HubspotSDK::Models::Settings::TaxRateListResponse::Result] }
        ...
        #   @param results [Array<HubspotSDK::Models::Settings::TaxRateListResponse::Result>]
