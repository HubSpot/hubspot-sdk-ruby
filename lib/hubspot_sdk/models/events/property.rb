  ...
  module Models
    module Events
      ...
      class Property < HubspotSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [HubspotSDK::Models::Events::PropertyModificationMetadata, nil]
        ...
        #
        #   @param options [Array<HubspotSDK::Models::Events::Option>] A list of valid options for the property. This field is required for enumerated
        #
        ...
        #
        #   @param modification_metadata [HubspotSDK::Models::Events::PropertyModificationMetadata]
        #
