...
module HubSpotSDK
  module Models
    class Condition < HubSpotSDK::Internal::Type::BaseModel
      ...
      #   'CRM_OBJECT_PROPERTY'.
      #
      #   @return [Symbol, HubSpotSDK::Models::Condition::FilterType]
      required :filter_type, enum: -> { HubSpotSDK::Condition::FilterType }, api_name: :filterType
      ...
      #
      #   @return [Symbol, HubSpotSDK::Models::Condition::Operator]
      required :operator, enum: -> { HubSpotSDK::Condition::Operator }
      ...
      #   {HubSpotSDK::Models::Condition} for more details.
      #
      #   @param filter_type [Symbol, HubSpotSDK::Models::Condition::FilterType] A string indicating the type of filter being applied. Valid value is 'CRM_OBJECT
      #
      #   @param operator [Symbol, HubSpotSDK::Models::Condition::Operator] A string specifying the operation to be performed in the condition. Valid values
      #
      ...
      # 'CRM_OBJECT_PROPERTY'.
      #
      # @see HubSpotSDK::Models::Condition#filter_type
      module FilterType
      ...
      # 'ENDS_WITH', 'IN', 'NOT_IN', 'IS_EMPTY', and 'IS_NOT_EMPTY'.
      #
      # @see HubSpotSDK::Models::Condition#operator
      module Operator
        extend HubSpotSDK::Internal::Type::Enum
