...
module HubspotSDK
  module Models
    module Webhooks
      # @see HubspotSDK::Resources::Webhooks::Webhooks#get_next_journal_local_by_offset
      class WebhookGetNextJournalLocalByOffsetParams < HubspotSDK::Internal::Type::BaseModel
