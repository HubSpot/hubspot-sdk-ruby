...
module HubspotSDK
  module Models
    module Webhooks
      # @see HubspotSDK::Resources::Webhooks::Webhooks#get_local_journal_next_by_offset
      class WebhookGetLocalJournalNextByOffsetParams < HubspotSDK::Internal::Type::BaseModel
