...
module HubspotSDK
  module Models
    module Webhooks
      # @see HubspotSDK::Resources::Webhooks#get_local_journal_batch_after_offset
      class WebhookGetLocalJournalBatchAfterOffsetParams < HubspotSDK::Internal::Type::BaseModel
