...
module HubspotSDK
  module Models
    module Automation
      # @see HubspotSDK::Resources::Automation::Actions#delete
      class ActionDeleteParams < HubspotSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, HubspotSDK::Models::Automation::ActionDeleteParams::FunctionType]
        required :function_type, enum: -> { HubspotSDK::Automation::ActionDeleteParams::FunctionType }
