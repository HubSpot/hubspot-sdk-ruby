  ...
  module Models
    module Automation
      class APIPlatformFlowCreateRequest < HubspotSDK::Internal::Type::BaseModel
        ...
        required :actions,
                 -> { HubspotSDK::Internal::Type::ArrayOf[union: HubspotSDK::Automation::APIPlatformFlowCreateRequest::Action] }
        ...
        required :data_sources,
                 -> {
                   HubspotSDK::Internal::Type::ArrayOf[union: HubspotSDK::Automation::APIPlatformFlowCreateRequest::DataSource]
                 },
                 api_name: :dataSources

        # @!attribute flow_type
        #
        #   @return [Symbol, HubspotSDK::Models::Automation::APIPlatformFlowCreateRequest::FlowType]
        required :flow_type,
                 enum: -> { HubspotSDK::Automation::APIPlatformFlowCreateRequest::FlowType },
                 api_name: :flowType
        ...
        # @!attribute type
        #
        #   @return [Symbol, HubspotSDK::Models::Automation::APIPlatformFlowCreateRequest::Type]
        required :type, enum: -> { HubspotSDK::Automation::APIPlatformFlowCreateRequest::Type }
        ...
        optional :enrollment_criteria,
                 union: -> { HubspotSDK::Automation::APIPlatformFlowCreateRequest::EnrollmentCriteria },
        ...
        optional :enrollment_schedule,
                 union: -> { HubspotSDK::Automation::APIPlatformFlowCreateRequest::EnrollmentSchedule },
        ...
        optional :suppression_filter_branch,
                 union: -> { HubspotSDK::Automation::APIPlatformFlowCreateRequest::SuppressionFilterBranch },
        ...
        # @!method initialize(actions:, blocked_dates:, custom_properties:, data_sources:, flow_type:, is_enabled:, object_type_id:, time_windows:, type:, description: nil, enrollment_criteria: nil, enrollment_schedule: nil, name: nil, start_action_id: nil, suppression_filter_branch: nil, uuid: nil)
        ...
        #   @param flow_type [Symbol, HubspotSDK::Models::Automation::APIPlatformFlowCreateRequest::FlowType]
        #   @param is_enabled [Boolean]
        #   @param object_type_id [String]
        #   @param time_windows [Array<HubspotSDK::Models::Automation::APITimeWindow>]
        #   @param type [Symbol, HubspotSDK::Models::Automation::APIPlatformFlowCreateRequest::Type]
        ...
        # @see HubspotSDK::Models::Automation::APIPlatformFlowCreateRequest#flow_type
        module FlowType
        ...
        # @see HubspotSDK::Models::Automation::APIPlatformFlowCreateRequest#type
        module Type
          extend HubspotSDK::Internal::Type::Enum
        ...
        # @see HubspotSDK::Models::Automation::APIPlatformFlowCreateRequest#enrollment_criteria
        ...
        # @see HubspotSDK::Models::Automation::APIPlatformFlowCreateRequest#enrollment_schedule
        ...
        # @see HubspotSDK::Models::Automation::APIPlatformFlowCreateRequest#suppression_filter_branch
