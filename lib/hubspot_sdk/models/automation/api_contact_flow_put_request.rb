  ...
  module Models
    module Automation
      class APIContactFlowPutRequest < HubspotSDK::Internal::Type::BaseModel
        ...
        required :actions,
                 -> { HubspotSDK::Internal::Type::ArrayOf[union: HubspotSDK::Automation::APIContactFlowPutRequest::Action] }
        ...
        # @!attribute type
        #
        #   @return [Symbol, HubspotSDK::Models::Automation::APIContactFlowPutRequest::Type]
        required :type, enum: -> { HubspotSDK::Automation::APIContactFlowPutRequest::Type }
        ...
        optional :enrollment_criteria,
                 union: -> { HubspotSDK::Automation::APIContactFlowPutRequest::EnrollmentCriteria },
        ...
        optional :enrollment_schedule,
                 union: -> { HubspotSDK::Automation::APIContactFlowPutRequest::EnrollmentSchedule },
        ...
        optional :event_anchor,
                 union: -> { HubspotSDK::Automation::APIContactFlowPutRequest::EventAnchor },
        ...
        optional :goal_filter_branch,
                 union: -> { HubspotSDK::Automation::APIContactFlowPutRequest::GoalFilterBranch },
        ...
        # @!method initialize(actions:, blocked_dates:, can_enroll_from_salesforce:, custom_properties:, is_enabled:, revision_id:, suppression_list_ids:, time_windows:, type:, description: nil, enrollment_criteria: nil, enrollment_schedule: nil, event_anchor: nil, goal_filter_branch: nil, name: nil, start_action_id: nil, un_enrollment_setting: nil, uuid: nil)
        ...
        #   @param type [Symbol, HubspotSDK::Models::Automation::APIContactFlowPutRequest::Type]
        ...
        # @see HubspotSDK::Models::Automation::APIContactFlowPutRequest#type
        module Type
        ...
        # @see HubspotSDK::Models::Automation::APIContactFlowPutRequest#enrollment_criteria
        ...
        # @see HubspotSDK::Models::Automation::APIContactFlowPutRequest#enrollment_schedule
        ...
        # @see HubspotSDK::Models::Automation::APIContactFlowPutRequest#event_anchor
        module EventAnchor
          extend HubspotSDK::Internal::Type::Union
        ...
        # @see HubspotSDK::Models::Automation::APIContactFlowPutRequest#goal_filter_branch
