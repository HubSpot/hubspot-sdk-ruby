  ...
  module Models
    module Automation
      ...
      class ActionGetByFunctionTypeParams < HubspotSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, HubspotSDK::Models::Automation::ActionGetByFunctionTypeParams::FunctionType]
        required :function_type, enum: -> { HubspotSDK::Automation::ActionGetByFunctionTypeParams::FunctionType }
