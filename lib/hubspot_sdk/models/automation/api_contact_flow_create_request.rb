...
module HubspotSDK
  module Models
    module Automation
      class APIContactFlowCreateRequest < HubspotSDK::Internal::Type::BaseModel
        # @!attribute actions
        #
        ...
        required :actions,
                 -> { HubspotSDK::Internal::Type::ArrayOf[union: HubspotSDK::Automation::APIContactFlowCreateRequest::Action] }
        ...
        required :data_sources,
                 -> {
                   HubspotSDK::Internal::Type::ArrayOf[union: HubspotSDK::Automation::APIContactFlowCreateRequest::DataSource]
                 },
                 api_name: :dataSources

        # @!attribute flow_type
        #
        #   @return [Symbol, HubspotSDK::Models::Automation::APIContactFlowCreateRequest::FlowType]
        required :flow_type,
                 enum: -> { HubspotSDK::Automation::APIContactFlowCreateRequest::FlowType },
                 api_name: :flowType
        ...
        # @!attribute type
        #
        #   @return [Symbol, HubspotSDK::Models::Automation::APIContactFlowCreateRequest::Type]
        required :type, enum: -> { HubspotSDK::Automation::APIContactFlowCreateRequest::Type }
        ...
        optional :enrollment_criteria,
                 union: -> { HubspotSDK::Automation::APIContactFlowCreateRequest::EnrollmentCriteria },
        ...
        optional :enrollment_schedule,
                 union: -> { HubspotSDK::Automation::APIContactFlowCreateRequest::EnrollmentSchedule },
        ...
        optional :event_anchor,
                 union: -> { HubspotSDK::Automation::APIContactFlowCreateRequest::EventAnchor },
        ...
        optional :goal_filter_branch,
                 union: -> { HubspotSDK::Automation::APIContactFlowCreateRequest::GoalFilterBranch },
        ...
        # @!method initialize(actions:, blocked_dates:, can_enroll_from_salesforce:, custom_properties:, data_sources:, flow_type:, is_enabled:, object_type_id:, suppression_list_ids:, time_windows:, type:, description: nil, enrollment_criteria: nil, enrollment_schedule: nil, event_anchor: nil, goal_filter_branch: nil, name: nil, start_action_id: nil, un_enrollment_setting: nil, uuid: nil)
        ...
        #   @param flow_type [Symbol, HubspotSDK::Models::Automation::APIContactFlowCreateRequest::FlowType]
        #   @param is_enabled [Boolean]
        #   @param object_type_id [String]
        #   @param suppression_list_ids [Array<Integer>]
        #   @param time_windows [Array<HubspotSDK::Models::Automation::APITimeWindow>]
        #   @param type [Symbol, HubspotSDK::Models::Automation::APIContactFlowCreateRequest::Type]
        ...
        # @see HubspotSDK::Models::Automation::APIContactFlowCreateRequest#flow_type
        module FlowType
        ...
        # @see HubspotSDK::Models::Automation::APIContactFlowCreateRequest#type
        module Type
          extend HubspotSDK::Internal::Type::Enum
        ...
        # @see HubspotSDK::Models::Automation::APIContactFlowCreateRequest#enrollment_criteria
        ...
        # @see HubspotSDK::Models::Automation::APIContactFlowCreateRequest#enrollment_schedule
        ...
        # @see HubspotSDK::Models::Automation::APIContactFlowCreateRequest#event_anchor
        module EventAnchor
          extend HubspotSDK::Internal::Type::Union
        ...
        # @see HubspotSDK::Models::Automation::APIContactFlowCreateRequest#goal_filter_branch
