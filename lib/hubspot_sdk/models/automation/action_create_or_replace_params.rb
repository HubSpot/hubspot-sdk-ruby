...
module HubspotSDK
  module Models
    module Automation
      ...
      class ActionCreateOrReplaceParams < HubspotSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, HubspotSDK::Models::Automation::ActionCreateOrReplaceParams::FunctionType]
        required :function_type, enum: -> { HubspotSDK::Automation::ActionCreateOrReplaceParams::FunctionType }
        ...
        #   @param function_type [Symbol, HubspotSDK::Models::Automation::ActionCreateOrReplaceParams::FunctionType]
