...
class HubspotSDK::Test::Resources::BusinessUnits::BusinessUnitsTest < HubspotSDK::Test::ResourceTest
  def test_get_by_user_id
    skip("Mock server tests are disabled")

    response = @hubspot.business_units.business_units.get_by_user_id("userId")
