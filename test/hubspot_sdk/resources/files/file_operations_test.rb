...
class HubspotSDK::Test::Resources::Files::FileOperationsTest < HubspotSDK::Test::ResourceTest
  def test_update
    skip("Prism tests are disabled")

    response = @hubspot.files.file_operations.update("321669910225")
  ...
  def test_delete
    ...
    response = @hubspot.files.file_operations.delete("321669910225")
  ...
  def test_gdpr_delete
    ...
    response = @hubspot.files.file_operations.gdpr_delete("321669910225")
  ...
  def test_get
    ...
    response = @hubspot.files.file_operations.get("321669910225")
  ...
  def test_get_import_task_status
    ...
    response = @hubspot.files.file_operations.get_import_task_status("taskId")
  ...
  def test_get_signed_url
    ...
    response = @hubspot.files.file_operations.get_signed_url("321669910225")
  ...
  def test_import_from_url_async_required_params
    ...
    response = @hubspot.files.file_operations.import_from_url_async(access: :HIDDEN_INDEXABLE, url: "url")
  ...
  def test_replace
    ...
    response = @hubspot.files.file_operations.replace("321669910225")
  ...
  def test_search
    ...
    response = @hubspot.files.file_operations.search
  ...
  def test_upload
    ...
    response = @hubspot.files.file_operations.upload
