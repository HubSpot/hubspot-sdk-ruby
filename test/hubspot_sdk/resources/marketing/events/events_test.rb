...
class HubspotSDK::Test::Resources::Marketing::Events::EventsTest < HubspotSDK::Test::ResourceTest
  def test_cancel_by_external_event_id_required_params
    skip("Mock server tests are disabled")

    response =
      @hubspot.marketing.events.events.cancel_by_external_event_id(
        "externalEventId",
  ...
  def test_complete_by_external_event_id_required_params
    ...
    response =
      @hubspot.marketing.events.events.complete_by_external_event_id(
        "externalEventId",
        external_account_id: "externalAccountId",
