...
class HubspotSDK::Test::Resources::Webhooks::WebhookSubscriptionsTest < HubspotSDK::Test::ResourceTest
  def test_create_crm_snapshot_required_params
    skip("Mock server tests are disabled")

    response =
      @hubspot.webhooks.webhook_subscriptions.create_crm_snapshot(
  ...
  def test_create_journal_subscription_required_params
    ...
    response =
      @hubspot.webhooks.webhook_subscriptions.create_journal_subscription(
  ...
  def test_create_subscription_required_params
    ...
    response =
      @hubspot.webhooks.webhook_subscriptions.create_subscription(
        0,
        active: true,
  ...
  def test_create_subscription_filter_required_params
    ...
    response =
      @hubspot.webhooks.webhook_subscriptions.create_subscription_filter(
  ...
  def test_delete_journal_subscription
    ...
    response = @hubspot.webhooks.webhook_subscriptions.delete_journal_subscription(0)
  ...
  def test_delete_portal_subscriptions
    ...
    response = @hubspot.webhooks.webhook_subscriptions.delete_portal_subscriptions(0)
  ...
  def test_delete_settings
    ...
    response = @hubspot.webhooks.webhook_subscriptions.delete_settings(0)
  ...
  def test_delete_subscription_required_params
    ...
    response = @hubspot.webhooks.webhook_subscriptions.delete_subscription(0, app_id: 0)
  ...
  def test_delete_subscription_filter
    ...
    response = @hubspot.webhooks.webhook_subscriptions.delete_subscription_filter(0)
  ...
  def test_get_journal_earliest
    ...
    response = @hubspot.webhooks.webhook_subscriptions.get_journal_earliest
  ...
  def test_get_journal_latest
    ...
    response = @hubspot.webhooks.webhook_subscriptions.get_journal_latest
  ...
  def test_get_journal_next_by_offset
    ...
    response = @hubspot.webhooks.webhook_subscriptions.get_journal_next_by_offset("offset")
  ...
  def test_get_journal_status
    ...
    response =
      @hubspot.webhooks.webhook_subscriptions.get_journal_status("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
  ...
  def test_get_local_journal_earliest
    ...
    response = @hubspot.webhooks.webhook_subscriptions.get_local_journal_earliest
  ...
  def test_get_local_journal_latest
    ...
    response = @hubspot.webhooks.webhook_subscriptions.get_local_journal_latest
  ...
  def test_get_local_journal_next_by_offset
    ...
    response = @hubspot.webhooks.webhook_subscriptions.get_local_journal_next_by_offset("offset")
  ...
  def test_get_local_journal_status
    ...
    response =
      @hubspot.webhooks.webhook_subscriptions.get_local_journal_status("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
  ...
  def test_get_settings
    ...
    response = @hubspot.webhooks.webhook_subscriptions.get_settings(0)
  ...
  def test_get_subscription_required_params
    ...
    response = @hubspot.webhooks.webhook_subscriptions.get_subscription(0, app_id: 0)
  ...
  def test_get_subscription_filter
    ...
    response = @hubspot.webhooks.webhook_subscriptions.get_subscription_filter(0)
  ...
  def test_get_subscription_filter_for_subscription
    ...
    response = @hubspot.webhooks.webhook_subscriptions.get_subscription_filter_for_subscription(0)
  ...
  def test_list_journal_subscriptions
    ...
    response = @hubspot.webhooks.webhook_subscriptions.list_journal_subscriptions
  ...
  def test_list_subscriptions
    ...
    response = @hubspot.webhooks.webhook_subscriptions.list_subscriptions(0)
  ...
  def test_update_settings_required_params
    ...
    response =
      @hubspot.webhooks.webhook_subscriptions.update_settings(
        0,
  ...
  def test_update_subscription_required_params
    ...
    response = @hubspot.webhooks.webhook_subscriptions.update_subscription(0, app_id: 0)
