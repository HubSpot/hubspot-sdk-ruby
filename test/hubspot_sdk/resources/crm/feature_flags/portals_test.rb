...
class HubspotSDK::Test::Resources::CRM::FeatureFlags::PortalsTest < HubspotSDK::Test::ResourceTest
  def test_update_required_params
    ...
    response =
      @hub_spot.crm.feature_flags.portals.update(0, app_id: 0, flag_name: "flagName", flag_state: :OFF)
  ...
  def test_delete_required_params
    ...
    response = @hub_spot.crm.feature_flags.portals.delete(0, app_id: 0, flag_name: "flagName")
  ...
  def test_batch_delete_required_params
    ...
    response = @hub_spot.crm.feature_flags.portals.batch_delete("flagName", app_id: 0, portal_ids: [0])
  ...
  def test_batch_upsert_required_params
    ...
    response =
      @hub_spot.crm.feature_flags.portals.batch_upsert(
        "flagName",
        app_id: 0,
  ...
  def test_get_required_params
    ...
    response = @hub_spot.crm.feature_flags.portals.get(0, app_id: 0, flag_name: "flagName")
