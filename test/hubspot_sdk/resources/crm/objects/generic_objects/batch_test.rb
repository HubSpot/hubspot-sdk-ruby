...
class HubspotSDK::Test::Resources::Crm::Objects::GenericObjects::BatchTest < HubspotSDK::Test::ResourceTest
  def test_create_required_params
    skip("Mock server tests are disabled")

    response =
      @hubspot.crm.objects.generic_objects.batch.create(
        "objectType",
        inputs: [
          {
            associations: [
  ...
  def test_update_required_params
    ...
    response =
      @hubspot.crm.objects.generic_objects.batch.update(
        "objectType",
  ...
  def test_delete_required_params
    ...
    response = @hubspot.crm.objects.generic_objects.batch.delete("objectType", inputs: [{id: "430001"}])
  ...
  def test_get_required_params
    ...
    response =
      @hubspot.crm.objects.generic_objects.batch.get(
        "objectType",
        inputs: [{id: "430001"}],
        properties: ["string"],
  ...
  def test_upsert_required_params
    ...
    response =
      @hubspot.crm.objects.generic_objects.batch.upsert(
        "objectType",
        inputs: [{id: "id", properties: {foo: "string"}}]
      )
