...
class HubSpotSDK::Test::Resources::Crm::Objects::SubscriptionsTest < HubSpotSDK::Test::ResourceTest
  def test_create_required_params
    skip("Mock server tests are disabled")

    response =
      @hubspot.crm.objects.subscriptions.create(
        associations: [
          {
            to: {id: "id"},
  ...
  def test_update_required_params
    ...
    response = @hubspot.crm.objects.subscriptions.update("subscriptionId", properties: {foo: "string"})
  ...
  def test_list
    ...
    response = @hubspot.crm.objects.subscriptions.list
  ...
  def test_delete
    ...
    response = @hubspot.crm.objects.subscriptions.delete("subscriptionId")
  ...
  def test_get
    ...
    response = @hubspot.crm.objects.subscriptions.get("subscriptionId")
  ...
  def test_search_required_params
    ...
    response =
      @hubspot.crm.objects.subscriptions.search(
        after: "after",
