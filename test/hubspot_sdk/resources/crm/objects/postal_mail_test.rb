...
class HubspotSDK::Test::Resources::Crm::Objects::PostalMailTest < HubspotSDK::Test::ResourceTest
  def test_create_required_params
    ...
    response =
      @hubspot.crm.objects.postal_mail.create(
        inputs: [
          {
            associations: [
              {
  ...
  def test_update_required_params
    ...
    response = @hubspot.crm.objects.postal_mail.update(inputs: [{id: "id", properties: {foo: "string"}}])
  ...
  def test_delete_required_params
    ...
    response = @hubspot.crm.objects.postal_mail.delete(inputs: [{id: "430001"}])
  ...
  def test_get_required_params
    ...
    response =
      @hubspot.crm.objects.postal_mail.get(
        inputs: [{id: "430001"}],
        properties: ["string"],
  ...
  def test_search_required_params
    ...
    response =
      @hubspot.crm.objects.postal_mail.search(
        after: "after",
  ...
  def test_upsert_required_params
    ...
    response = @hubspot.crm.objects.postal_mail.upsert(inputs: [{id: "id", properties: {foo: "string"}}])
