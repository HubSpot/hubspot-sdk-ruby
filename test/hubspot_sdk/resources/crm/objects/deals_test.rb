...
class HubSpotSDK::Test::Resources::Crm::Objects::DealsTest < HubSpotSDK::Test::ResourceTest
  def test_create_required_params
    skip("Mock server tests are disabled")

    response =
      @hubspot.crm.objects.deals.create(
        associations: [
          {
            to: {id: "id"},
  ...
  def test_update_required_params
    ...
    response = @hubspot.crm.objects.deals.update("dealId", properties: {foo: "string"})
  ...
  def test_search_required_params
    ...
    response =
      @hubspot.crm.objects.deals.search(
        after: "after",
