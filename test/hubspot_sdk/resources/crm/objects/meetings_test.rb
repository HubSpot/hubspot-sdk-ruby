...
class HubSpotSDK::Test::Resources::Crm::Objects::MeetingsTest < HubSpotSDK::Test::ResourceTest
  def test_create_required_params
    skip("Mock server tests are disabled")

    response =
      @hubspot.crm.objects.meetings.create(
        associations: [
          {
            to: {id: "id"},
  ...
  def test_update_required_params
    ...
    response = @hubspot.crm.objects.meetings.update("meetingId", properties: {foo: "string"})
  ...
  def test_search_required_params
    ...
    response =
      @hubspot.crm.objects.meetings.search(
        after: "after",
