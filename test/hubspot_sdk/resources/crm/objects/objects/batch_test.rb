...
class HubspotSDK::Test::Resources::Crm::Objects::Objects::BatchTest < HubspotSDK::Test::ResourceTest
  def test_create_required_params
    skip("Mock server tests are disabled")

    response =
      @hubspot.crm.objects.objects.batch.create(
        "objectType",
        inputs: [
          {
            associations: [
  ...
  def test_delete_required_params
    ...
    response = @hubspot.crm.objects.objects.batch.delete("objectType", inputs: [{id: "430001"}])
