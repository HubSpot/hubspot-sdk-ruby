...
class HubspotSDK::Test::Resources::CRM::Objects::Fees::BatchTest < HubspotSDK::Test::ResourceTest
  def test_create_required_params
    skip("Prism tests are disabled")

    response = @hub_spot.crm.objects.fees.batch.create(inputs: [{properties: {foo: "string"}}])
  ...
  def test_update_required_params
    ...
    response = @hub_spot.crm.objects.fees.batch.update(inputs: [{id: "id", properties: {foo: "string"}}])
  ...
  def test_delete_required_params
    ...
    response = @hub_spot.crm.objects.fees.batch.delete(inputs: [{id: "id"}])
  ...
  def test_get_required_params
    ...
    response =
      @hub_spot.crm.objects.fees.batch.get(
        inputs: [{id: "id"}],
        properties: ["string"],
  ...
  def test_upsert_required_params
    ...
    response = @hub_spot.crm.objects.fees.batch.upsert(inputs: [{id: "id", properties: {foo: "string"}}])
