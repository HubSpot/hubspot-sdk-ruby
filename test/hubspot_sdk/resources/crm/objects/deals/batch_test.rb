...
class HubspotSDK::Test::Resources::Crm::Objects::Deals::BatchTest < HubspotSDK::Test::ResourceTest
  def test_create_required_params
    ...
    response = @hubspot.crm.objects.deals.batch.create(inputs: [{properties: {foo: "string"}}])
  ...
  def test_update_required_params
    ...
    response = @hubspot.crm.objects.deals.batch.update(inputs: [{id: "id", properties: {foo: "string"}}])
  ...
  def test_delete_required_params
    ...
    response = @hubspot.crm.objects.deals.batch.delete(inputs: [{id: "id"}])
  ...
  def test_get_required_params
    ...
    response =
      @hubspot.crm.objects.deals.batch.get(
        inputs: [{id: "id"}],
        properties: ["string"],
  ...
  def test_upsert_required_params
    ...
    response = @hubspot.crm.objects.deals.batch.upsert(inputs: [{id: "id", properties: {foo: "string"}}])
