...
class HubspotSDK::Test::Resources::Crm::Objects::ListingsTest < HubspotSDK::Test::ResourceTest
  ...
  def test_update_required_params
    ...
    response = @hubspot.crm.objects.listings.update(inputs: [{id: "id", properties: {foo: "string"}}])
  ...
  def test_delete_required_params
    ...
    response = @hubspot.crm.objects.listings.delete(inputs: [{id: "430001"}])
  ...
  def test_get_required_params
    ...
    response =
      @hubspot.crm.objects.listings.get(
        inputs: [{id: "430001"}],
        properties: ["string"],
  ...
  def test_upsert_required_params
    ...
    response = @hubspot.crm.objects.listings.upsert(inputs: [{id: "id", properties: {foo: "string"}}])
