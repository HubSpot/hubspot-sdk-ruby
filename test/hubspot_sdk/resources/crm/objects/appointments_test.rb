...
class HubspotSDK::Test::Resources::CRM::Objects::AppointmentsTest < HubspotSDK::Test::ResourceTest
  def test_create_required_params
    skip("Prism tests are disabled")

    response = @hub_spot.crm.objects.appointments.create(properties: {foo: "string"})
  ...
  def test_update_required_params
    ...
    response =
      @hub_spot.crm.objects.appointments.update(
        "appointmentId",
        properties: {
  ...
  def test_list
    ...
    response = @hub_spot.crm.objects.appointments.list
  ...
  def test_delete
    ...
    response = @hub_spot.crm.objects.appointments.delete("appointmentId")
  ...
  def test_get
    ...
    response = @hub_spot.crm.objects.appointments.get("appointmentId")
  ...
  def test_search
    ...
    response = @hub_spot.crm.objects.appointments.search
