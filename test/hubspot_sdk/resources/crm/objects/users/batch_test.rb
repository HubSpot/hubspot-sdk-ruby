...
class HubSpotSDK::Test::Resources::Crm::Objects::Users::BatchTest < HubSpotSDK::Test::ResourceTest
  def test_create_required_params
    skip("Mock server tests are disabled")

    response =
      @hubspot.crm.objects.users.batch.create(
        inputs: [
          {
            associations: [
              {
  ...
  def test_update_required_params
    ...
    response = @hubspot.crm.objects.users.batch.update(inputs: [{id: "id", properties: {foo: "string"}}])
  ...
  def test_delete_required_params
    ...
    response = @hubspot.crm.objects.users.batch.delete(inputs: [{id: "430001"}])
  ...
  def test_get_required_params
    ...
    response =
      @hubspot.crm.objects.users.batch.get(
        inputs: [{id: "430001"}],
        properties: ["string"],
  ...
  def test_upsert_required_params
    ...
    response = @hubspot.crm.objects.users.batch.upsert(inputs: [{id: "id", properties: {foo: "string"}}])
