...
class HubspotSDK::Test::Resources::Crm::Objects::Projects::AssociationsTest < HubspotSDK::Test::ResourceTest
  def test_update_required_params
    skip("Prism tests are disabled")

    response =
      @hubspot.crm.objects.projects.associations.update(
        "associationType",
  ...
  def test_list_required_params
    ...
    response = @hubspot.crm.objects.projects.associations.list("toObjectType", project_id: "projectId")
  ...
  def test_delete_required_params
    ...
    response =
      @hubspot.crm.objects.projects.associations.delete(
        "associationType",
        project_id: "projectId",
        to_object_type: "toObjectType",
        to_object_id: "toObjectId"
