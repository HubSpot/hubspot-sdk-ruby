...
class HubSpotSDK::Test::Resources::Crm::Objects::ProjectsTest < HubSpotSDK::Test::ResourceTest
  def test_create_required_params
    skip("Mock server tests are disabled")

    response =
      @hubspot.crm.objects.projects.create(
        associations: [
          {
            to: {id: "id"},
  ...
  def test_update_required_params
    ...
    response = @hubspot.crm.objects.projects.update("projectId", properties: {foo: "string"})
  ...
  def test_list
    ...
    response = @hubspot.crm.objects.projects.list
  ...
  def test_delete
    ...
    response = @hubspot.crm.objects.projects.delete("projectId")
  ...
  def test_get
    ...
    response = @hubspot.crm.objects.projects.get("projectId")
  ...
  def test_merge_required_params
    ...
    response =
      @hubspot.crm.objects.projects.merge(
  ...
  def test_search_required_params
    ...
    response =
      @hubspot.crm.objects.projects.search(
        after: "after",
