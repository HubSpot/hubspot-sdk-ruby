...
class HubspotSDK::Test::Resources::Crm::Objects::CoursesTest < HubspotSDK::Test::ResourceTest
  def test_create_required_params
    skip("Mock server tests are disabled")

    response =
      @hubspot.crm.objects.courses.create(
        associations: [
          {
            to: {id: "id"},
  ...
  def test_update_required_params
    ...
    response = @hubspot.crm.objects.courses.update("courseId", properties: {foo: "string"})
  ...
  def test_search_required_params
    ...
    response =
      @hubspot.crm.objects.courses.search(
        after: "after",
