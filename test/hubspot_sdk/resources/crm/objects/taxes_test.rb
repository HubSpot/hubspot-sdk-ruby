...
class HubspotSDK::Test::Resources::Crm::Objects::TaxesTest < HubspotSDK::Test::ResourceTest
  def test_create_required_params
    ...
    response =
      @hubspot.crm.objects.taxes.create(
        inputs: [
          {
            associations: [
              {
  ...
  def test_update_required_params
    ...
    response = @hubspot.crm.objects.taxes.update(inputs: [{id: "id", properties: {foo: "string"}}])
  ...
  def test_delete_required_params
    ...
    response = @hubspot.crm.objects.taxes.delete(inputs: [{id: "430001"}])
  ...
  def test_search_required_params
    ...
    response =
      @hubspot.crm.objects.taxes.search(
        after: "after",
  ...
  def test_upsert_required_params
    ...
    response = @hubspot.crm.objects.taxes.upsert(inputs: [{id: "id", properties: {foo: "string"}}])
