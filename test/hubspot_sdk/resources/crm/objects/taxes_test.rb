...
class HubspotSDK::Test::Resources::CRM::Objects::TaxesTest < HubspotSDK::Test::ResourceTest
  def test_create_required_params
    ...
    response = @hub_spot.crm.objects.taxes.create(properties: {foo: "string"})
  ...
  def test_update_required_params
    ...
    response =
      @hub_spot.crm.objects.taxes.update(
        "taxId",
        properties: {
  ...
  def test_list
    ...
    response = @hub_spot.crm.objects.taxes.list
  ...
  def test_delete
    ...
    response = @hub_spot.crm.objects.taxes.delete("taxId")
  ...
  def test_get
    ...
    response = @hub_spot.crm.objects.taxes.get("taxId")
  ...
  def test_search
    ...
    response = @hub_spot.crm.objects.taxes.search
