...
class HubspotSDK::Test::Resources::Crm::Objects::ServicesTest < HubspotSDK::Test::ResourceTest
  def test_create_required_params
    skip("Mock server tests are disabled")

    response =
      @hubspot.crm.objects.services.create(
        inputs: [
          {
            associations: [
              {
  ...
  def test_update_required_params
    ...
    response = @hubspot.crm.objects.services.update(inputs: [{id: "id", properties: {foo: "string"}}])
  ...
  def test_list
    ...
    response = @hubspot.crm.objects.services.list
  ...
  def test_delete_required_params
    ...
    response = @hubspot.crm.objects.services.delete(inputs: [{id: "430001"}])
  ...
  def test_get_required_params
    ...
    response =
      @hubspot.crm.objects.services.get(
        inputs: [{id: "430001"}],
        properties: ["string"],
  ...
  def test_search_required_params
    ...
    response =
      @hubspot.crm.objects.services.search(
        after: "after",
  ...
  def test_upsert_required_params
    ...
    response = @hubspot.crm.objects.services.upsert(inputs: [{id: "id", properties: {foo: "string"}}])
