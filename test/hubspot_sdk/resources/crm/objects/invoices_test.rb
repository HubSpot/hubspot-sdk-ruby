...
class HubspotSDK::Test::Resources::CRM::Objects::InvoicesTest < HubspotSDK::Test::ResourceTest
  def test_create_required_params
    ...
    response = @hub_spot.crm.objects.invoices.create(properties: {foo: "string"})
  ...
  def test_update_required_params
    ...
    response =
      @hub_spot.crm.objects.invoices.update(
        "invoiceId",
        properties: {
  ...
  def test_list
    ...
    response = @hub_spot.crm.objects.invoices.list
  ...
  def test_delete
    ...
    response = @hub_spot.crm.objects.invoices.delete("invoiceId")
  ...
  def test_get
    ...
    response = @hub_spot.crm.objects.invoices.get("invoiceId")
  ...
  def test_search
    ...
    response = @hub_spot.crm.objects.invoices.search
