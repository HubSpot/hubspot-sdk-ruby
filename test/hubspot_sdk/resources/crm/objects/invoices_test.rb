...
class HubspotSDK::Test::Resources::Crm::Objects::InvoicesTest < HubspotSDK::Test::ResourceTest
  def test_create_required_params
    ...
    response = @hubspot.crm.objects.invoices.create(properties: {foo: "string"})
  ...
  def test_update_required_params
    ...
    response = @hubspot.crm.objects.invoices.update("invoiceId", properties: {foo: "string"})
  ...
  def test_delete
    ...
    response = @hubspot.crm.objects.invoices.delete("invoiceId")
  ...
  def test_get
    ...
    response = @hubspot.crm.objects.invoices.get("invoiceId")
  ...
  def test_search
    ...
    response = @hubspot.crm.objects.invoices.search
