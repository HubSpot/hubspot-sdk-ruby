...
class HubspotSDK::Test::Resources::Crm::Objects::Quotes::BasicTest < HubspotSDK::Test::ResourceTest
  def test_create_required_params
    skip("Mock server tests are disabled")

    response =
      @hubspot.crm.objects.quotes.basic.create(
        inputs: [
          {
            associations: [
              {
  ...
  def test_update_required_params
    ...
    response = @hubspot.crm.objects.quotes.basic.update(inputs: [{id: "id", properties: {foo: "string"}}])
  ...
  def test_delete_required_params
    ...
    response = @hubspot.crm.objects.quotes.basic.delete(inputs: [{id: "430001"}])
  ...
  def test_get_required_params
    ...
    response =
      @hubspot.crm.objects.quotes.basic.get(
        inputs: [{id: "430001"}],
        properties: ["string"],
  ...
  def test_upsert_required_params
    ...
    response = @hubspot.crm.objects.quotes.basic.upsert(inputs: [{id: "id", properties: {foo: "string"}}])
