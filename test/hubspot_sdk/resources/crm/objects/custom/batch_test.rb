...
class HubspotSDK::Test::Resources::CRM::Objects::Custom::BatchTest < HubspotSDK::Test::ResourceTest
  def test_create_required_params
    skip("Prism tests are disabled")

    response =
      @hub_spot.crm.objects.custom.batch.create("objectType", inputs: [{properties: {foo: "string"}}])
  ...
  def test_update_required_params
    ...
    response =
      @hub_spot.crm.objects.custom.batch.update(
        "objectType",
  ...
  def test_delete_required_params
    ...
    response = @hub_spot.crm.objects.custom.batch.delete("objectType", inputs: [{id: "id"}])
  ...
  def test_get_required_params
    ...
    response =
      @hub_spot.crm.objects.custom.batch.get(
        "objectType",
        inputs: [{id: "id"}],
        properties: ["string"],
  ...
  def test_upsert_required_params
    ...
    response =
      @hub_spot.crm.objects.custom.batch.upsert(
        "objectType",
        inputs: [{id: "id", properties: {foo: "string"}}]
      )
