...
class HubspotSDK::Test::Resources::Crm::Objects::UsersTest < HubspotSDK::Test::ResourceTest
  ...
  def test_update_required_params
    ...
    response = @hubspot.crm.objects.users.update(inputs: [{id: "id", properties: {foo: "string"}}])
  ...
  def test_delete_required_params
    ...
    response = @hubspot.crm.objects.users.delete(inputs: [{id: "430001"}])
  ...
  def test_upsert_required_params
    ...
    response = @hubspot.crm.objects.users.upsert(inputs: [{id: "id", properties: {foo: "string"}}])
