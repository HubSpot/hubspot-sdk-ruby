...
class HubspotSDK::Test::Resources::Crm::Objects::ObjectsTest < HubspotSDK::Test::ResourceTest
  def test_create_required_params
    skip("Prism tests are disabled")

    response =
      @hubspot.crm.objects.objects.create(
        "objectType",
        associations: [
          {
            to: {id: "37295"},
  ...
  def test_update_required_params
    ...
    response =
      @hubspot.crm.objects.objects.update("objectId", object_type: "objectType", properties: {foo: "string"})
  ...
  def test_search_required_params
    ...
    response =
      @hubspot.crm.objects.objects.search(
        "objectType",
        after: "after",
