...
class HubspotSDK::Test::Resources::CRM::Objects::TasksTest < HubspotSDK::Test::ResourceTest
  def test_create_required_params
    ...
    response = @hub_spot.crm.objects.tasks.create(properties: {foo: "string"})
  ...
  def test_update_required_params
    ...
    response =
      @hub_spot.crm.objects.tasks.update(
        "taskId",
        properties: {
  ...
  def test_list
    ...
    response = @hub_spot.crm.objects.tasks.list
  ...
  def test_delete
    ...
    response = @hub_spot.crm.objects.tasks.delete("taskId")
  ...
  def test_get
    ...
    response = @hub_spot.crm.objects.tasks.get("taskId")
  ...
  def test_search
    ...
    response = @hub_spot.crm.objects.tasks.search
