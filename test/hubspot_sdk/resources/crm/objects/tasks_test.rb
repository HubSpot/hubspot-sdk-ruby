...
class HubspotSDK::Test::Resources::Crm::Objects::TasksTest < HubspotSDK::Test::ResourceTest
  def test_create_required_params
    ...
    response = @hubspot.crm.objects.tasks.create(properties: {foo: "string"})
  ...
  def test_update_required_params
    ...
    response = @hubspot.crm.objects.tasks.update("taskId", properties: {foo: "string"})
  ...
  def test_list
    ...
    response = @hubspot.crm.objects.tasks.list
  ...
  def test_delete
    ...
    response = @hubspot.crm.objects.tasks.delete("taskId")
  ...
  def test_get
    ...
    response = @hubspot.crm.objects.tasks.get("taskId")
  ...
  def test_search
    ...
    response = @hubspot.crm.objects.tasks.search
