...
class HubspotSDK::Test::Resources::Crm::Objects::Carts::BatchTest < HubspotSDK::Test::ResourceTest
  def test_create_required_params
    skip("Mock server tests are disabled")

    response =
      @hubspot.crm.objects.carts.batch.create(
        inputs: [
          {
            associations: [
              {
  ...
  def test_delete_required_params
    ...
    response = @hubspot.crm.objects.carts.batch.delete(inputs: [{id: "430001"}])
