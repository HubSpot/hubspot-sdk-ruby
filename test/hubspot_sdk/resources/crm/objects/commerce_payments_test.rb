...
class HubspotSDK::Test::Resources::CRM::Objects::CommercePaymentsTest < HubspotSDK::Test::ResourceTest
  def test_create_required_params
    skip("Prism tests are disabled")

    response = @hub_spot.crm.objects.commerce_payments.create(properties: {foo: "string"})
  ...
  def test_update_required_params
    ...
    response =
      @hub_spot.crm.objects.commerce_payments.update(
        "commercePaymentId",
        properties: {
  ...
  def test_list
    ...
    response = @hub_spot.crm.objects.commerce_payments.list
  ...
  def test_delete
    ...
    response = @hub_spot.crm.objects.commerce_payments.delete("commercePaymentId")
  ...
  def test_get
    ...
    response = @hub_spot.crm.objects.commerce_payments.get("commercePaymentId")
  ...
  def test_search
    ...
    response = @hub_spot.crm.objects.commerce_payments.search
