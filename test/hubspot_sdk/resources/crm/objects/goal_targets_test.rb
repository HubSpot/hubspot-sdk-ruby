...
class HubspotSDK::Test::Resources::Crm::Objects::GoalTargetsTest < HubspotSDK::Test::ResourceTest
  def test_create_required_params
    skip("Prism tests are disabled")

    response =
      @hubspot.crm.objects.goal_targets.create(
        associations: [
          {
            to: {id: "37295"},
  ...
  def test_update_required_params
    ...
    response = @hubspot.crm.objects.goal_targets.update("goalTargetId", properties: {foo: "string"})
  ...
  def test_search_required_params
    ...
    response =
      @hubspot.crm.objects.goal_targets.search(
        after: "after",
