...
class HubspotSDK::Test::Resources::CRM::Objects::NotesTest < HubspotSDK::Test::ResourceTest
  def test_create_required_params
    ...
    response = @hub_spot.crm.objects.notes.create(properties: {foo: "string"})
  ...
  def test_update_required_params
    ...
    response =
      @hub_spot.crm.objects.notes.update(
        "noteId",
        properties: {
  ...
  def test_list
    ...
    response = @hub_spot.crm.objects.notes.list
  ...
  def test_delete
    ...
    response = @hub_spot.crm.objects.notes.delete("noteId")
  ...
  def test_get
    ...
    response = @hub_spot.crm.objects.notes.get("noteId")
  ...
  def test_search
    ...
    response = @hub_spot.crm.objects.notes.search
