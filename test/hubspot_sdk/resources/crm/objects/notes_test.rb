...
class HubspotSDK::Test::Resources::Crm::Objects::NotesTest < HubspotSDK::Test::ResourceTest
  def test_create_required_params
    ...
    response = @hubspot.crm.objects.notes.create(properties: {foo: "string"})
  ...
  def test_update_required_params
    ...
    response =
      @hubspot.crm.objects.notes.update(
        "noteId",
        properties: {
  ...
  def test_delete
    ...
    response = @hubspot.crm.objects.notes.delete("noteId")
  ...
  def test_search
    ...
    response = @hubspot.crm.objects.notes.search
