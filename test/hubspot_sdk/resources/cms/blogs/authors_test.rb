...
class HubspotSDK::Test::Resources::Cms::Blogs::AuthorsTest < HubspotSDK::Test::ResourceTest
  def test_create_required_params
    ...
    response =
      @hub_spot.cms.blogs.authors.create(
        id: "id",
        avatar: "avatar",
        bio: "bio",
  ...
  def test_update_required_params
    ...
    response =
      @hub_spot.cms.blogs.authors.update(
        "objectId",
        id: "id",
        avatar: "avatar",
        bio: "bio",
  ...
  def test_list
    ...
    response = @hub_spot.cms.blogs.authors.list
  ...
  def test_delete
    ...
    response = @hub_spot.cms.blogs.authors.delete("objectId")
  ...
  def test_attach_to_lang_group_required_params
    ...
    response =
      @hub_spot.cms.blogs.authors.attach_to_lang_group(
        id: "id",
        language: "language",
  ...
  def test_create_batch_required_params
    ...
    response =
      @hub_spot.cms.blogs.authors.create_batch(
        inputs: [
          {
            id: "id",
            avatar: "avatar",
  ...
  def test_create_language_variation_required_params
    ...
    response =
      @hub_spot.cms.blogs.authors.create_language_variation(
        id: "id",
        blog_author: {
          id: "id",
          avatar: "avatar",
  ...
  def test_delete_batch_required_params
    ...
    response = @hub_spot.cms.blogs.authors.delete_batch(inputs: ["string"])
  ...
  def test_detach_from_lang_group_required_params
    ...
    response = @hub_spot.cms.blogs.authors.detach_from_lang_group(id: "id")
  ...
  def test_get
    ...
    response = @hub_spot.cms.blogs.authors.get("objectId")
  ...
  def test_get_batch_required_params
    ...
    response = @hub_spot.cms.blogs.authors.get_batch(inputs: ["string"])
  ...
  def test_set_new_lang_primary_required_params
    ...
    response = @hub_spot.cms.blogs.authors.set_new_lang_primary(id: "id")
  ...
  def test_update_batch_required_params
    ...
    response = @hub_spot.cms.blogs.authors.update_batch(inputs: [{}])
  ...
  def test_update_languages_required_params
    ...
    response =
      @hub_spot.cms.blogs.authors.update_languages(languages: {foo: "string"}, primary_id: "primaryId")
