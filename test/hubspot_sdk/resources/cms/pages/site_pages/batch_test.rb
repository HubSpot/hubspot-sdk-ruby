...
class HubSpotSDK::Test::Resources::Cms::Pages::SitePages::BatchTest < HubSpotSDK::Test::ResourceTest
  def test_create_site_pages_required_params
    skip("Mock server tests are disabled")

    response =
      @hubspot.cms.pages.site_pages.batch.create_site_pages(
        inputs: [
          {
            id: "id",
  ...
  def test_delete_site_pages_required_params
    ...
    response = @hubspot.cms.pages.site_pages.batch.delete_site_pages(inputs: ["string"])
  ...
  def test_get_site_pages_required_params
    ...
    response = @hubspot.cms.pages.site_pages.batch.get_site_pages(inputs: ["string"])
  ...
  def test_update_site_pages_required_params
    ...
    response = @hubspot.cms.pages.site_pages.batch.update_site_pages(inputs: [{}])
