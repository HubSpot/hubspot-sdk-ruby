...
class HubSpotSDK::Test::Resources::Cms::Pages::SitePages::AbTestTest < HubSpotSDK::Test::ResourceTest
  def test_create_site_page_variation_required_params
    skip("Mock server tests are disabled")

    response =
      @hubspot.cms.pages.site_pages.ab_test.create_site_page_variation(
  ...
  def test_end_site_page_test_required_params
    ...
    response =
      @hubspot.cms.pages.site_pages.ab_test.end_site_page_test(ab_test_id: "abTestId", winner_id: "winnerId")
  ...
  def test_rerun_site_page_test_required_params
    ...
    response =
      @hubspot.cms.pages.site_pages.ab_test.rerun_site_page_test(
        ab_test_id: "abTestId",
