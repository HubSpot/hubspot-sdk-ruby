...
class HubSpotSDK::Test::Resources::Cms::Pages::SitePages::RevisionsTest < HubSpotSDK::Test::ResourceTest
  def test_get_site_page_revision_required_params
    skip("Mock server tests are disabled")

    response =
      @hubspot.cms.pages.site_pages.revisions.get_site_page_revision("revisionId", object_id_: "objectId")
  ...
  def test_list_site_page_revisions
    ...
    response = @hubspot.cms.pages.site_pages.revisions.list_site_page_revisions("objectId")
  ...
  def test_restore_site_page_revision_required_params
    ...
    response =
      @hubspot.cms.pages.site_pages.revisions.restore_site_page_revision("revisionId", object_id_: "objectId")
  ...
  def test_restore_site_page_revision_to_draft_required_params
    ...
    response =
      @hubspot.cms.pages.site_pages.revisions.restore_site_page_revision_to_draft(0, object_id_: "objectId")
