...
class HubSpotSDK::Test::Resources::Cms::Pages::SitePages::DraftTest < HubSpotSDK::Test::ResourceTest
  def test_get_draft
    skip("Mock server tests are disabled")

    response = @hubspot.cms.pages.site_pages.draft.get_draft("objectId")
  ...
  def test_publish_draft
    ...
    response = @hubspot.cms.pages.site_pages.draft.publish_draft("objectId")
  ...
  def test_reset_site_page_draft
    ...
    response = @hubspot.cms.pages.site_pages.draft.reset_site_page_draft("objectId")
  ...
  def test_update_draft_required_params
    ...
    response =
      @hubspot.cms.pages.site_pages.draft.update_draft(
        "objectId",
        id: "id",
