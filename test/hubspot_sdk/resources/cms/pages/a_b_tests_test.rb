...
class HubspotSDK::Test::Resources::Cms::Pages::AbTestsTest < HubspotSDK::Test::ResourceTest
  def test_create_ab_test_variation_required_params
    ...
    response =
      @hubspot.cms.pages.a_b_tests.create_ab_test_variation(
  ...
  def test_end_ab_test_required_params
    ...
    response = @hubspot.cms.pages.a_b_tests.end_ab_test(ab_test_id: "abTestId", winner_id: "winnerId")
  ...
  def test_rerun_ab_test_required_params
    ...
    response =
      @hubspot.cms.pages.a_b_tests.rerun_ab_test(ab_test_id: "abTestId", variation_id: "variationId")
