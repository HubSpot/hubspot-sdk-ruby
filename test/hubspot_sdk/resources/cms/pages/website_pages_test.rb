...
class HubSpotSDK::Test::Resources::Cms::Pages::WebsitePagesTest < HubSpotSDK::Test::ResourceTest
  def test_create_required_params
    skip("Mock server tests are disabled")

    response =
      @hubspot.cms.pages.website_pages.create(
        id: "id",
  ...
  def test_update_required_params
    ...
    response =
      @hubspot.cms.pages.website_pages.update(
        "objectId",
        id: "id",
        ab_status: :automated_loser_variant,
        ab_test_id: "abTestId",
  ...
  def test_list
    ...
    response = @hubspot.cms.pages.website_pages.list
  ...
  def test_delete
    ...
    response = @hubspot.cms.pages.website_pages.delete("objectId")
  ...
  def test_clone__required_params
    ...
    response = @hubspot.cms.pages.website_pages.clone_(id: "id")
  ...
  def test_get
    ...
    response = @hubspot.cms.pages.website_pages.get("objectId")
  ...
  def test_get_draft
    ...
    response = @hubspot.cms.pages.website_pages.get_draft("objectId")
  ...
  def test_publish_draft
    ...
    response = @hubspot.cms.pages.website_pages.publish_draft("objectId")
  ...
  def test_schedule_required_params
    ...
    response = @hubspot.cms.pages.website_pages.schedule(id: "id", publish_date: "2019-12-27T18:11:19.117Z")
  ...
  def test_set_new_lang_primary_required_params
    ...
    response = @hubspot.cms.pages.website_pages.set_new_lang_primary(id: "id")
  ...
  def test_update_draft_required_params
    ...
    response =
      @hubspot.cms.pages.website_pages.update_draft(
        "objectId",
        id: "id",
        ab_status: :automated_loser_variant,
        ab_test_id: "abTestId",
