...
class HubSpotSDK::Test::Resources::Cms::Pages::LandingPages::MultiLanguageTest < HubSpotSDK::Test::ResourceTest
  def test_attach_to_lang_group_required_params
    skip("Mock server tests are disabled")

    response =
      @hubspot.cms.pages.landing_pages.multi_language.attach_to_lang_group(
        id: "id",
        language: :aa,
  ...
  def test_create_language_variation_required_params
    ...
    response = @hubspot.cms.pages.landing_pages.multi_language.create_language_variation(id: "id")
  ...
  def test_set_new_lang_primary_required_params
    ...
    response = @hubspot.cms.pages.landing_pages.multi_language.set_new_lang_primary(id: "id")
  ...
  def test_update_languages_required_params
    ...
    response =
      @hubspot.cms.pages.landing_pages.multi_language.update_languages(
        languages: {foo: :aa},
        primary_id: "primaryId"
      )
