...
class HubSpotSDK::Test::Resources::Cms::Pages::LandingPages::DraftTest < HubSpotSDK::Test::ResourceTest
  def test_update_required_params
    skip("Mock server tests are disabled")

    response =
      @hubspot.cms.pages.landing_pages.draft.update(
        "objectId",
        id: "id",
  ...
  def test_get
    ...
    response = @hubspot.cms.pages.landing_pages.draft.get("objectId")
  ...
  def test_push_live
    ...
    response = @hubspot.cms.pages.landing_pages.draft.push_live("objectId")
  ...
  def test_reset
    ...
    response = @hubspot.cms.pages.landing_pages.draft.reset("objectId")
