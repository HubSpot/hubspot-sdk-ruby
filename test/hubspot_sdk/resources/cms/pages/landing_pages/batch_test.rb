...
class HubSpotSDK::Test::Resources::Cms::Pages::LandingPages::BatchTest < HubSpotSDK::Test::ResourceTest
  def test_create_landing_pages_required_params
    skip("Mock server tests are disabled")

    response =
      @hubspot.cms.pages.landing_pages.batch.create_landing_pages(
        inputs: [
          {
            id: "id",
  ...
  def test_delete_landing_pages_required_params
    ...
    response = @hubspot.cms.pages.landing_pages.batch.delete_landing_pages(inputs: ["string"])
  ...
  def test_get_landing_pages_required_params
    ...
    response = @hubspot.cms.pages.landing_pages.batch.get_landing_pages(inputs: ["string"])
  ...
  def test_update_landing_pages_required_params
    ...
    response = @hubspot.cms.pages.landing_pages.batch.update_landing_pages(inputs: [{}])
