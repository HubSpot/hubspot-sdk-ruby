...
class HubSpotSDK::Test::Resources::Cms::Pages::LandingPages::AbTestTest < HubSpotSDK::Test::ResourceTest
  def test_create_landing_page_variation_required_params
    skip("Mock server tests are disabled")

    response =
      @hubspot.cms.pages.landing_pages.ab_test.create_landing_page_variation(
  ...
  def test_end_landing_page_test_required_params
    ...
    response =
      @hubspot.cms.pages.landing_pages.ab_test.end_landing_page_test(
        ab_test_id: "abTestId",
        winner_id: "winnerId"
      )
  ...
  def test_rerun_landing_page_test_required_params
    ...
    response =
      @hubspot.cms.pages.landing_pages.ab_test.rerun_landing_page_test(
        ab_test_id: "abTestId",
