...
class HubSpotSDK::Test::Resources::Cms::Pages::LandingPages::RevisionsTest < HubSpotSDK::Test::ResourceTest
  def test_get_landing_page_revision_required_params
    skip("Mock server tests are disabled")

    response =
      @hubspot.cms.pages.landing_pages.revisions.get_landing_page_revision(
        "revisionId",
        object_id_: "objectId"
      )
  ...
  def test_list_landing_page_revisions
    ...
    response = @hubspot.cms.pages.landing_pages.revisions.list_landing_page_revisions("objectId")
  ...
  def test_restore_landing_page_revision_required_params
    ...
    response =
      @hubspot.cms.pages.landing_pages.revisions.restore_landing_page_revision(
        "revisionId",
        object_id_: "objectId"
      )
  ...
  def test_restore_landing_page_revision_to_draft_required_params
    ...
    response =
      @hubspot.cms.pages.landing_pages.revisions.restore_landing_page_revision_to_draft(
        0,
        object_id_: "objectId"
      )
