...
class HubspotSDK::Test::Resources::Cms::MediaBridge::IntegratorSettingsTest < HubspotSDK::Test::ResourceTest
  def test_create_object_definition_required_params
    ...
    response =
      @hub_spot.cms.media_bridge.integrator_settings.create_object_definition("appId", media_types: [:VIDEO])
  ...
  def test_create_oembed_domain_required_params
    ...
    response =
      @hub_spot.cms.media_bridge.integrator_settings.create_oembed_domain(
        "appId",
  ...
  def test_delete_oembed_domain
    ...
    response = @hub_spot.cms.media_bridge.integrator_settings.delete_oembed_domain("appId")
  ...
  def test_get_event_visibility_settings
    ...
    response = @hub_spot.cms.media_bridge.integrator_settings.get_event_visibility_settings("appId")
  ...
  def test_get_object_definitions_by_media_type_required_params
    ...
    response =
      @hub_spot.cms.media_bridge.integrator_settings.get_object_definitions_by_media_type(
        "mediaType",
        app_id: "appId"
      )
  ...
  def test_get_oembed_domain_required_params
    ...
    response =
      @hub_spot.cms.media_bridge.integrator_settings.get_oembed_domain("oEmbedDomainId", app_id: "appId")
  ...
  def test_list_oembed_domains
    ...
    response = @hub_spot.cms.media_bridge.integrator_settings.list_oembed_domains("appId")
  ...
  def test_register_app_name_required_params
    ...
    response = @hub_spot.cms.media_bridge.integrator_settings.register_app_name("appId", updated_at: 0)
  ...
  def test_update_app_name_required_params
    ...
    response = @hub_spot.cms.media_bridge.integrator_settings.update_app_name("appId", updated_at: 0)
  ...
  def test_update_event_visibility_settings_required_params
    ...
    response =
      @hub_spot.cms.media_bridge.integrator_settings.update_event_visibility_settings(
        "appId",
        event_type: :ALL,
        updated_at: 0
      )
  ...
  def test_update_oembed_domain_required_params
    ...
    response =
      @hub_spot.cms.media_bridge.integrator_settings.update_oembed_domain(
        "oEmbedDomainId",
        app_id: "appId",
        endpoints: {discovery: true, schemes: ["string"], url: "url"}
      )
