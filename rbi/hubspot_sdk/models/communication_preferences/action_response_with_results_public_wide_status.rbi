  ...
  module Models
    module CommunicationPreferences
      class ActionResponseWithResultsPublicWideStatus < HubSpotSDK::Internal::Type::BaseModel
        ...
        sig do
          returns(
            HubSpotSDK::CommunicationPreferences::ActionResponseWithResultsPublicWideStatus::Status::TaggedSymbol
          )
        end
        ...
        sig do
          params(
            ...
            started_at: Time,
            status:
              HubSpotSDK::CommunicationPreferences::ActionResponseWithResultsPublicWideStatus::Status::OrSymbol,
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                HubSpotSDK::CommunicationPreferences::ActionResponseWithResultsPublicWideStatus::Status
              )
            end
