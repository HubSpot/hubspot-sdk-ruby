...
module HubspotSDK
  module Models
    class PublicNotAnyFilterBranch < HubspotSDK::Internal::Type::BaseModel
      ...
      sig do
        returns(
          HubspotSDK::PublicNotAnyFilterBranch::FilterBranchType::OrSymbol
        )
      end
      ...
      module FilterBranch
        ...
        sig do
          override.returns(
            T::Array[
              HubspotSDK::PublicNotAnyFilterBranch::FilterBranch::Variants
            ]
          )
        end
        def self.variants
      ...
      module FilterBranchType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              HubspotSDK::PublicNotAnyFilterBranch::FilterBranchType
            )
          end
        ...
        NOT_ANY =
          T.let(
            :NOT_ANY,
            HubspotSDK::PublicNotAnyFilterBranch::FilterBranchType::TaggedSymbol
          )
      ...
      module Filter
        ...
        sig do
          override.returns(
            T::Array[HubspotSDK::PublicNotAnyFilterBranch::Filter::Variants]
          )
        end
        def self.variants
        end
