...
module HubspotSDK
  module Models
    class PublicAndFilterBranch < HubspotSDK::Internal::Type::BaseModel
      ...
      sig do
        returns(HubspotSDK::PublicAndFilterBranch::FilterBranchType::OrSymbol)
      end
      ...
      sig do
        params(
          ...
          filter_branch_type:
            HubspotSDK::PublicAndFilterBranch::FilterBranchType::OrSymbol,
          filters:
            T::Array[
              T.any(
      ...
      module FilterBranch
        ...
        sig do
          override.returns(
            T::Array[HubspotSDK::PublicAndFilterBranch::FilterBranch::Variants]
          )
        end
        def self.variants
        end
      ...
      module FilterBranchType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, HubspotSDK::PublicAndFilterBranch::FilterBranchType)
          end
        ...
        AND =
          T.let(
            :AND,
            HubspotSDK::PublicAndFilterBranch::FilterBranchType::TaggedSymbol
          )
      ...
      module Filter
        ...
        sig do
          override.returns(
            T::Array[HubspotSDK::PublicAndFilterBranch::Filter::Variants]
          )
        end
        def self.variants
        end
