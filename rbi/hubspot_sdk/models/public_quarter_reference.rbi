...
module HubspotSDK
  module Models
    class PublicQuarterReference < HubspotSDK::Internal::Type::BaseModel
      ...
      sig do
        returns(HubspotSDK::PublicQuarterReference::ReferenceType::OrSymbol)
      end
      ...
      sig do
        params(
          ...
          month: Integer,
          reference_type:
            HubspotSDK::PublicQuarterReference::ReferenceType::OrSymbol,
          hour: Integer,
          millisecond: Integer,
          minute: Integer,
          second: Integer
      ...
      module ReferenceType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, HubspotSDK::PublicQuarterReference::ReferenceType)
          end
        ...
        QUARTER =
          T.let(
            :QUARTER,
            HubspotSDK::PublicQuarterReference::ReferenceType::TaggedSymbol
          )
