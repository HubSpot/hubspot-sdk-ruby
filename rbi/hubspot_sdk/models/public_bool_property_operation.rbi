...
module HubspotSDK
  module Models
    class PublicBoolPropertyOperation < HubspotSDK::Internal::Type::BaseModel
      ...
      sig do
        returns(
          HubspotSDK::PublicBoolPropertyOperation::OperationType::OrSymbol
        )
      end
      ...
      module OperationType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              HubspotSDK::PublicBoolPropertyOperation::OperationType
            )
          end
        ...
        BOOL =
          T.let(
            :BOOL,
            HubspotSDK::PublicBoolPropertyOperation::OperationType::TaggedSymbol
          )
