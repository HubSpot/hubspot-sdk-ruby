  ...
  module Models
    module Marketing
      class FileField < HubspotSDK::Internal::Type::BaseModel
        ...
        sig { returns(HubspotSDK::Marketing::FileField::FieldType::OrSymbol) }
        ...
        sig do
          params(
            allow_multiple_files: T::Boolean,
            dependent_fields: T::Array[HubspotSDK::Marketing::DependentField],
            field_type: HubspotSDK::Marketing::FileField::FieldType::OrSymbol,
            hidden: T::Boolean,
            label: String,
            name: String,
        ...
        module FieldType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, HubspotSDK::Marketing::FileField::FieldType)
            end
          ...
          FILE =
            T.let(
              :file,
              HubspotSDK::Marketing::FileField::FieldType::TaggedSymbol
            )
