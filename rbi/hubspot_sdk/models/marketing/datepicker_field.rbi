  ...
  module Models
    module Marketing
      class DatepickerField < HubspotSDK::Internal::Type::BaseModel
        ...
        sig do
          returns(HubspotSDK::Marketing::DatepickerField::FieldType::OrSymbol)
        end
        ...
        sig do
          params(
            ...
            field_type:
              HubspotSDK::Marketing::DatepickerField::FieldType::OrSymbol,
            hidden: T::Boolean,
            label: String,
            name: String,
        ...
        module FieldType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, HubspotSDK::Marketing::DatepickerField::FieldType)
            end
          ...
          DATEPICKER =
            T.let(
              :datepicker,
              HubspotSDK::Marketing::DatepickerField::FieldType::TaggedSymbol
            )
