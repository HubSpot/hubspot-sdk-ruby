    ...
    module Marketing
      module Subscriptions
        class ActionResponseWithResultsPublicStatus < HubspotSDK::Internal::Type::BaseModel
          ...
          sig do
            returns(
              HubspotSDK::Marketing::Subscriptions::ActionResponseWithResultsPublicStatus::Status::TaggedSymbol
            )
          end
          ...
          sig do
            params(
              ...
              started_at: Time,
              status:
                HubspotSDK::Marketing::Subscriptions::ActionResponseWithResultsPublicStatus::Status::OrSymbol,
          ...
          module Status
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  HubspotSDK::Marketing::Subscriptions::ActionResponseWithResultsPublicStatus::Status
                )
              end
