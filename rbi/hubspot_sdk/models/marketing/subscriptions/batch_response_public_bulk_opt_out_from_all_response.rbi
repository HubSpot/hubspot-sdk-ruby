    ...
    module Marketing
      module Subscriptions
        class BatchResponsePublicBulkOptOutFromAllResponse < HubspotSDK::Internal::Type::BaseModel
          ...
          sig do
            returns(
              HubspotSDK::Marketing::Subscriptions::BatchResponsePublicBulkOptOutFromAllResponse::Status::TaggedSymbol
            )
          end
          ...
          sig do
            params(
              ...
              results:
                T::Array[
                  HubspotSDK::Marketing::Subscriptions::PublicBulkOptOutFromAllResponse::OrHash
                ],
              started_at: Time,
              status:
                HubspotSDK::Marketing::Subscriptions::BatchResponsePublicBulkOptOutFromAllResponse::Status::OrSymbol,
          ...
          module Status
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  HubspotSDK::Marketing::Subscriptions::BatchResponsePublicBulkOptOutFromAllResponse::Status
                )
              end
