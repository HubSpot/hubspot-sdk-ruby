    ...
    module Marketing
      module Subscriptions
        class ActionResponseWithResultsPublicWideStatus < HubspotSDK::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T::Array[HubspotSDK::Marketing::Subscriptions::PublicWideStatus]
            )
          end
          ...
          sig do
            returns(
              HubspotSDK::Marketing::Subscriptions::ActionResponseWithResultsPublicWideStatus::Status::TaggedSymbol
            )
          end
          ...
          sig do
            params(
              ...
              results:
                T::Array[
                  HubspotSDK::Marketing::Subscriptions::PublicWideStatus::OrHash
                ],
              started_at: Time,
              status:
                HubspotSDK::Marketing::Subscriptions::ActionResponseWithResultsPublicWideStatus::Status::OrSymbol,
          ...
          module Status
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  HubspotSDK::Marketing::Subscriptions::ActionResponseWithResultsPublicWideStatus::Status
                )
              end
