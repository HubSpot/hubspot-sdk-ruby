      ...
      module Subscriptions
        class BatchResponsePublicWideStatusBulkResponseWithErrors < HubspotSDK::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                HubspotSDK::Marketing::Subscriptions::BatchResponsePublicWideStatusBulkResponseWithErrors,
          ...
          sig do
            returns(
              HubspotSDK::Marketing::Subscriptions::BatchResponsePublicWideStatusBulkResponseWithErrors::Status::OrSymbol
            )
          end
          ...
          module Status
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  HubspotSDK::Marketing::Subscriptions::BatchResponsePublicWideStatusBulkResponseWithErrors::Status
                )
              end
            ...
            CANCELED =
              T.let(
                :CANCELED,
                HubspotSDK::Marketing::Subscriptions::BatchResponsePublicWideStatusBulkResponseWithErrors::Status::TaggedSymbol
              )
            COMPLETE =
              T.let(
                :COMPLETE,
