  ...
  module Models
    module Marketing
      class FormDefinitionBase < HubspotSDK::Internal::Type::BaseModel
        ...
        sig do
          returns(
            HubspotSDK::Marketing::FormDefinitionBase::FormType::TaggedSymbol
          )
        end
        ...
        sig do
          returns(
            HubspotSDK::Marketing::FormDefinitionBase::LegalConsentOptions::Variants
          )
        end
        ...
        sig do
          params(
            ...
            form_type:
              HubspotSDK::Marketing::FormDefinitionBase::FormType::OrSymbol,
        ...
        module FormType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, HubspotSDK::Marketing::FormDefinitionBase::FormType)
            end
