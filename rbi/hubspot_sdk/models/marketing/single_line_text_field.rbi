  ...
  module Models
    module Marketing
      class SingleLineTextField < HubspotSDK::Internal::Type::BaseModel
        ...
        sig do
          returns(
            HubspotSDK::Marketing::SingleLineTextField::FieldType::OrSymbol
          )
        end
        ...
        module FieldType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                HubspotSDK::Marketing::SingleLineTextField::FieldType
              )
            end
          ...
          SINGLE_LINE_TEXT =
            T.let(
              :single_line_text,
              HubspotSDK::Marketing::SingleLineTextField::FieldType::TaggedSymbol
            )
