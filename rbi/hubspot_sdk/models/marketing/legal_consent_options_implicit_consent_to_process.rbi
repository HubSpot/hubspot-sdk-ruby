  ...
  module Models
    module Marketing
      class LegalConsentOptionsImplicitConsentToProcess < HubspotSDK::Internal::Type::BaseModel
        ...
        sig do
          returns(
            HubspotSDK::Marketing::LegalConsentOptionsImplicitConsentToProcess::Type::OrSymbol
          )
        end
        attr_accessor :type
        ...
        module Type
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                HubspotSDK::Marketing::LegalConsentOptionsImplicitConsentToProcess::Type
              )
            end
          ...
          IMPLICIT_CONSENT_TO_PROCESS =
            T.let(
              :implicit_consent_to_process,
              HubspotSDK::Marketing::LegalConsentOptionsImplicitConsentToProcess::Type::TaggedSymbol
            )
