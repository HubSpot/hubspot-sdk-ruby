    ...
    module Marketing
      class HubSpotFormDefinitionCreateRequest < HubspotSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              HubspotSDK::Marketing::HubSpotFormDefinitionCreateRequest,
        ...
        sig do
          returns(
            HubspotSDK::Marketing::HubSpotFormDefinitionCreateRequest::FormType::OrSymbol
          )
        end
        ...
        module FormType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                HubspotSDK::Marketing::HubSpotFormDefinitionCreateRequest::FormType
              )
            end
          ...
          HUBSPOT =
            T.let(
              :hubspot,
              HubspotSDK::Marketing::HubSpotFormDefinitionCreateRequest::FormType::TaggedSymbol
            )
        ...
        module LegalConsentOptions
          ...
          sig do
            override.returns(
              T::Array[
                HubspotSDK::Marketing::HubSpotFormDefinitionCreateRequest::LegalConsentOptions::Variants
              ]
            )
          end
          def self.variants
