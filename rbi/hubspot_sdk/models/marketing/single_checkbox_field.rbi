  ...
  module Models
    module Marketing
      class SingleCheckboxField < HubspotSDK::Internal::Type::BaseModel
        ...
        sig do
          returns(
            HubspotSDK::Marketing::SingleCheckboxField::FieldType::OrSymbol
          )
        end
        ...
        module FieldType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                HubspotSDK::Marketing::SingleCheckboxField::FieldType
              )
            end
          ...
          SINGLE_CHECKBOX =
            T.let(
              :single_checkbox,
              HubspotSDK::Marketing::SingleCheckboxField::FieldType::TaggedSymbol
            )
