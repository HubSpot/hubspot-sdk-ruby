    ...
    module Marketing
      class CollectionResponseFormDefinitionBaseForwardPaging < HubspotSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              HubspotSDK::Marketing::CollectionResponseFormDefinitionBaseForwardPaging,
              HubspotSDK::Internal::AnyHash
            )
          end

        sig { returns(T::Array[HubspotSDK::Marketing::HubSpotFormDefinition]) }
        ...
        sig do
          params(
            results:
              T::Array[HubspotSDK::Marketing::HubSpotFormDefinition::OrHash],
        ...
        sig do
          override.returns(
            {
              results: T::Array[HubspotSDK::Marketing::HubSpotFormDefinition],
