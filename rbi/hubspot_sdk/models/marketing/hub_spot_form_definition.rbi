  ...
  module Models
    module Marketing
      class HubSpotFormDefinition < HubspotSDK::Internal::Type::BaseModel
        ...
        sig do
          returns(
            HubspotSDK::Marketing::HubSpotFormDefinition::FormType::TaggedSymbol
          )
        end
        ...
        sig do
          returns(
            HubspotSDK::Marketing::HubSpotFormDefinition::LegalConsentOptions::Variants
          )
        end
        ...
        sig do
          params(
            ...
            form_type:
              HubspotSDK::Marketing::HubSpotFormDefinition::FormType::OrSymbol,
        ...
        module FormType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                HubspotSDK::Marketing::HubSpotFormDefinition::FormType
              )
            end
