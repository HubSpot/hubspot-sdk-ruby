  ...
  module Models
    module Marketing
      class RadioField < HubspotSDK::Internal::Type::BaseModel
        ...
        sig { returns(HubspotSDK::Marketing::RadioField::FieldType::OrSymbol) }
        ...
        sig do
          params(
            ...
            field_type: HubspotSDK::Marketing::RadioField::FieldType::OrSymbol,
            hidden: T::Boolean,
            label: String,
            name: String,
          ...
          override.returns(
            {
              ...
              dependent_fields: T::Array[HubspotSDK::Marketing::DependentField],
              field_type:
                HubspotSDK::Marketing::RadioField::FieldType::OrSymbol,
              hidden: T::Boolean,
              label: String,
              name: String,
              object_type_id: String,
        ...
        module FieldType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, HubspotSDK::Marketing::RadioField::FieldType)
            end
          ...
          RADIO =
            T.let(
              :radio,
              HubspotSDK::Marketing::RadioField::FieldType::TaggedSymbol
            )
