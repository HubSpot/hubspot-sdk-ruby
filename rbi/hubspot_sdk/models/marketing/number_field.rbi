  ...
  module Models
    module Marketing
      class NumberField < HubspotSDK::Internal::Type::BaseModel
        ...
        sig { returns(HubspotSDK::Marketing::NumberField::FieldType::OrSymbol) }
        ...
        sig { returns(T.nilable(HubspotSDK::Marketing::NumberFieldValidation)) }
        attr_reader :validation

        sig do
          params(
            validation: HubspotSDK::Marketing::NumberFieldValidation::OrHash
          ).void
        end
        ...
        sig do
          params(
            ...
            field_type: HubspotSDK::Marketing::NumberField::FieldType::OrSymbol,
            hidden: T::Boolean,
            label: String,
            name: String,
          ...
          override.returns(
            {
              dependent_fields: T::Array[HubspotSDK::Marketing::DependentField],
              field_type:
                HubspotSDK::Marketing::NumberField::FieldType::OrSymbol,
              hidden: T::Boolean,
              label: String,
              name: String,
              object_type_id: String,
              ...
              description: String,
              placeholder: String,
              validation: HubspotSDK::Marketing::NumberFieldValidation
            }
          )
        end
        def to_hash
        ...
        module FieldType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, HubspotSDK::Marketing::NumberField::FieldType)
            end
          ...
          NUMBER =
            T.let(
              :number,
              HubspotSDK::Marketing::NumberField::FieldType::TaggedSymbol
            )
