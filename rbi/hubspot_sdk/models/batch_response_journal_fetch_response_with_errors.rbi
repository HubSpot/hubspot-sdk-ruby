  ...
  module Models
    class BatchResponseJournalFetchResponseWithErrors < HubSpotSDK::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            HubSpotSDK::BatchResponseJournalFetchResponseWithErrors,
      ...
      sig do
        returns(
          HubSpotSDK::BatchResponseJournalFetchResponseWithErrors::Status::OrSymbol
        )
      end
      ...
      sig do
        params(
          completed_at: Time,
          results: T::Array[HubSpotSDK::JournalFetchResponse::OrHash],
          started_at: Time,
          status:
            HubSpotSDK::BatchResponseJournalFetchResponseWithErrors::Status::OrSymbol,
      ...
      sig do
        override.returns(
          {
            completed_at: Time,
            results: T::Array[HubSpotSDK::JournalFetchResponse],
            started_at: Time,
            status:
              HubSpotSDK::BatchResponseJournalFetchResponseWithErrors::Status::OrSymbol,
      ...
      module Status
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              HubSpotSDK::BatchResponseJournalFetchResponseWithErrors::Status
            )
          end
        ...
        CANCELED =
          T.let(
            :CANCELED,
            HubSpotSDK::BatchResponseJournalFetchResponseWithErrors::Status::TaggedSymbol
          )
        COMPLETE =
          T.let(
            :COMPLETE,
