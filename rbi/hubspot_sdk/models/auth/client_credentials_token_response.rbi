  ...
  module Models
    module Auth
      class ClientCredentialsTokenResponse < HubSpotSDK::Internal::Type::BaseModel
        ...
        sig do
          returns(
            HubSpotSDK::Auth::ClientCredentialsTokenResponse::TokenUse::TaggedSymbol
          )
        end
        ...
        sig do
          params(
            ...
            token_type: String,
            token_use:
              HubSpotSDK::Auth::ClientCredentialsTokenResponse::TokenUse::OrSymbol,
            hub_id: Integer,
            id_token: String,
        ...
        module TokenUse
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                HubSpotSDK::Auth::ClientCredentialsTokenResponse::TokenUse
              )
            end
