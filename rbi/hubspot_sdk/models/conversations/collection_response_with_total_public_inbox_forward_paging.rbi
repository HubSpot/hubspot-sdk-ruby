  ...
  module Models
    module Conversations
      class CollectionResponseWithTotalPublicInboxForwardPaging < HubspotSDK::Internal::Type::BaseModel
        ...
        sig { returns(T::Array[HubspotSDK::Conversations::PublicInbox]) }
        ...
        sig do
          params(
            results: T::Array[HubspotSDK::Conversations::PublicInbox::OrHash],
            total: Integer,
        ...
        sig do
          override.returns(
            {
              results: T::Array[HubspotSDK::Conversations::PublicInbox],
              total: Integer,
