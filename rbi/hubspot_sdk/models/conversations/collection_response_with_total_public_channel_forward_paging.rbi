  ...
  module Models
    module Conversations
      class CollectionResponseWithTotalPublicChannelForwardPaging < HubspotSDK::Internal::Type::BaseModel
        ...
        sig { returns(T::Array[HubspotSDK::Conversations::PublicChannel]) }
        ...
        sig do
          params(
            results: T::Array[HubspotSDK::Conversations::PublicChannel::OrHash],
            total: Integer,
        ...
        sig do
          override.returns(
            {
              results: T::Array[HubspotSDK::Conversations::PublicChannel],
              total: Integer,
