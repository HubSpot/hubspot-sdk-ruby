...
module HubspotSDK
  module Models
    class PublicRestrictedFilterBranch < HubspotSDK::Internal::Type::BaseModel
      ...
      sig do
        returns(
          HubspotSDK::PublicRestrictedFilterBranch::FilterBranchType::OrSymbol
        )
      end
      ...
      module FilterBranch
        ...
        sig do
          override.returns(
            T::Array[
              HubspotSDK::PublicRestrictedFilterBranch::FilterBranch::Variants
            ]
          )
        end
        def self.variants
      ...
      module FilterBranchType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              HubspotSDK::PublicRestrictedFilterBranch::FilterBranchType
            )
          end
        ...
        RESTRICTED =
          T.let(
            :RESTRICTED,
            HubspotSDK::PublicRestrictedFilterBranch::FilterBranchType::TaggedSymbol
          )
      ...
      module Filter
        ...
        sig do
          override.returns(
            T::Array[HubspotSDK::PublicRestrictedFilterBranch::Filter::Variants]
          )
        end
        def self.variants
        end
