  ...
  module Models
    class BatchResponseJournalFetchResponse < HubSpotSDK::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            HubSpotSDK::BatchResponseJournalFetchResponse,
      ...
      sig do
        returns(
          HubSpotSDK::BatchResponseJournalFetchResponse::Status::TaggedSymbol
        )
      end
      ...
      sig do
        params(
          ...
          started_at: Time,
          status:
            HubSpotSDK::BatchResponseJournalFetchResponse::Status::OrSymbol,
      ...
      module Status
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, HubSpotSDK::BatchResponseJournalFetchResponse::Status)
          end
