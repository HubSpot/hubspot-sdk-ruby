...
module HubspotSDK
  module Models
    class PublicFiscalQuarterReference < HubspotSDK::Internal::Type::BaseModel
      ...
      sig do
        returns(
          HubspotSDK::PublicFiscalQuarterReference::ReferenceType::OrSymbol
        )
      end
      ...
      module ReferenceType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              HubspotSDK::PublicFiscalQuarterReference::ReferenceType
            )
          end
        ...
        FISCAL_QUARTER =
          T.let(
            :FISCAL_QUARTER,
            HubspotSDK::PublicFiscalQuarterReference::ReferenceType::TaggedSymbol
          )
