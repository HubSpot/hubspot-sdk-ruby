...
module HubspotSDK
  module Models
    class PublicCtaAnalyticsFilter < HubspotSDK::Internal::Type::BaseModel
      ...
      sig do
        returns(HubspotSDK::PublicCtaAnalyticsFilter::FilterType::OrSymbol)
      end
      ...
      sig do
        params(
          cta_name: String,
          filter_type:
            HubspotSDK::PublicCtaAnalyticsFilter::FilterType::OrSymbol,
          operator: String,
          coalescing_refine_by:
            T.any(
              HubspotSDK::PublicNumOccurrencesRefineBy::OrHash,
      ...
      module FilterType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, HubspotSDK::PublicCtaAnalyticsFilter::FilterType)
          end
        ...
        CTA =
          T.let(
            :CTA,
            HubspotSDK::PublicCtaAnalyticsFilter::FilterType::TaggedSymbol
          )
      ...
      module CoalescingRefineBy
        ...
        sig do
          override.returns(
            T::Array[
              HubspotSDK::PublicCtaAnalyticsFilter::CoalescingRefineBy::Variants
            ]
          )
        end
        def self.variants
      ...
      module PruningRefineBy
        ...
        sig do
          override.returns(
            T::Array[
              HubspotSDK::PublicCtaAnalyticsFilter::PruningRefineBy::Variants
            ]
          )
        end
        def self.variants
