      ...
      module Objects
        class BatchResponsePublicDefaultAssociation < HubspotSDK::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                HubspotSDK::Crm::Objects::BatchResponsePublicDefaultAssociation,
          ...
          sig do
            returns(
              T::Array[HubspotSDK::Crm::Objects::PublicDefaultAssociation]
            )
          end
          ...
          sig do
            returns(
              HubspotSDK::Crm::Objects::BatchResponsePublicDefaultAssociation::Status::OrSymbol
            )
          end
          ...
          sig do
            params(
              ...
              results:
                T::Array[
                  HubspotSDK::Crm::Objects::PublicDefaultAssociation::OrHash
                ],
              started_at: Time,
              status:
                HubspotSDK::Crm::Objects::BatchResponsePublicDefaultAssociation::Status::OrSymbol,
          ...
          module Status
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  HubspotSDK::Crm::Objects::BatchResponsePublicDefaultAssociation::Status
                )
              end
            ...
            CANCELED =
              T.let(
                :CANCELED,
                HubspotSDK::Crm::Objects::BatchResponsePublicDefaultAssociation::Status::TaggedSymbol
              )
            COMPLETE =
              T.let(
                :COMPLETE,
