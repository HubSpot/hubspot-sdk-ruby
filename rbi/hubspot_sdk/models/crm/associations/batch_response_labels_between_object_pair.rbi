    ...
    module Crm
      module Associations
        class BatchResponseLabelsBetweenObjectPair < HubspotSDK::Internal::Type::BaseModel
          ...
          sig do
            returns(
              HubspotSDK::Crm::Associations::BatchResponseLabelsBetweenObjectPair::Status::TaggedSymbol
            )
          end
          ...
          sig do
            params(
              completed_at: Time,
              results:
                T::Array[HubspotSDK::Crm::LabelsBetweenObjectPair::OrHash],
              started_at: Time,
              status:
                HubspotSDK::Crm::Associations::BatchResponseLabelsBetweenObjectPair::Status::OrSymbol,
          ...
          module Status
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  HubspotSDK::Crm::Associations::BatchResponseLabelsBetweenObjectPair::Status
                )
              end
