...
module HubspotSDK
  module Models
    module Crm
      module Associations
        class AssociationsV4SimplePublicObjectInputForCreate < HubspotSDK::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                HubspotSDK::Crm::Associations::AssociationsV4SimplePublicObjectInputForCreate,
