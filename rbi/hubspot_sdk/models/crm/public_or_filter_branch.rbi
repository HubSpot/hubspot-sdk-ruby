  ...
  module Models
    module Crm
      class PublicOrFilterBranch < HubSpotSDK::Internal::Type::BaseModel
        ...
        sig do
          returns(
            HubSpotSDK::Crm::PublicOrFilterBranch::FilterBranchType::OrSymbol
          )
        end
        ...
        module FilterBranch
          ...
          sig do
            override.returns(
              T::Array[
                HubSpotSDK::Crm::PublicOrFilterBranch::FilterBranch::Variants
              ]
            )
          end
          def self.variants
        ...
        module FilterBranchType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                HubSpotSDK::Crm::PublicOrFilterBranch::FilterBranchType
              )
            end
          ...
          OR =
            T.let(
              :OR,
              HubSpotSDK::Crm::PublicOrFilterBranch::FilterBranchType::TaggedSymbol
            )
        ...
        module Filter
          ...
          sig do
            override.returns(
              T::Array[HubSpotSDK::Crm::PublicOrFilterBranch::Filter::Variants]
            )
          end
          def self.variants
          end
