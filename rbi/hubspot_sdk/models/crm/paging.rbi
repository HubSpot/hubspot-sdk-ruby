  ...
  module Models
    module Crm
      class Paging < HubspotSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(HubspotSDK::Crm::Paging, HubspotSDK::Internal::AnyHash)
          end
        ...
        sig { returns(T.nilable(HubspotSDK::Crm::PreviousPage)) }
        attr_reader :prev

        sig { params(prev: HubspotSDK::Crm::PreviousPage::OrHash).void }
        attr_writer :prev

        sig do
          params(
            next_: HubspotSDK::NextPage::OrHash,
            prev: HubspotSDK::Crm::PreviousPage::OrHash
        ...
        sig do
          override.returns(
            { next_: HubspotSDK::NextPage, prev: HubspotSDK::Crm::PreviousPage }
          )
        end
        def to_hash
        end
