  ...
  module Models
    module Crm
      class PublicAndFilterBranch < HubSpotSDK::Internal::Type::BaseModel
        ...
        sig do
          returns(
            HubSpotSDK::Crm::PublicAndFilterBranch::FilterBranchType::OrSymbol
          )
        end
        ...
        module FilterBranch
          ...
          sig do
            override.returns(
              T::Array[
                HubSpotSDK::Crm::PublicAndFilterBranch::FilterBranch::Variants
              ]
            )
          end
          def self.variants
        ...
        module FilterBranchType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                HubSpotSDK::Crm::PublicAndFilterBranch::FilterBranchType
              )
            end
          ...
          AND =
            T.let(
              :AND,
              HubSpotSDK::Crm::PublicAndFilterBranch::FilterBranchType::TaggedSymbol
            )
        ...
        module Filter
          ...
          sig do
            override.returns(
              T::Array[HubSpotSDK::Crm::PublicAndFilterBranch::Filter::Variants]
            )
          end
          def self.variants
          end
