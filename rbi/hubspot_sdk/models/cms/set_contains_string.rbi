  ...
  module Models
    module Cms
      class SetContainsString < HubspotSDK::Internal::Type::BaseModel
        ...
        sig do
          returns(HubspotSDK::Cms::SetContainsString::StringToCheck::Variants)
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[HubspotSDK::Cms::SetContainsString::Input::Variants]
            )
          )
        end
        attr_reader :inputs
          ...
          override.returns(
            {
              ...
              string_to_check:
                HubspotSDK::Cms::SetContainsString::StringToCheck::Variants,
              inputs:
                T::Array[HubspotSDK::Cms::SetContainsString::Input::Variants],
              property_name: String,
              value: T::Boolean
