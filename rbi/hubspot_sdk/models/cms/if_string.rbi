  ...
  module Models
    module Cms
      class IfString < HubSpotSDK::Internal::Type::BaseModel
        ...
        sig { returns(HubSpotSDK::Cms::IfString::IfExpression::Variants) }
        ...
        sig do
          returns(
            T.nilable(HubSpotSDK::Cms::IfString::ElseExpression::Variants)
          )
        end
        ...
        sig do
          returns(
            T.nilable(T::Array[HubSpotSDK::Cms::IfString::Input::Variants])
          )
        end
        attr_reader :inputs
        ...
        sig do
          override.returns(
            {
              enclosed_in_parentheses: T::Boolean,
              if_expression: HubSpotSDK::Cms::IfString::IfExpression::Variants,
              operator: HubSpotSDK::Cms::IfString::Operator::TaggedSymbol,
              else_expression:
                HubSpotSDK::Cms::IfString::ElseExpression::Variants,
              inputs: T::Array[HubSpotSDK::Cms::IfString::Input::Variants],
              property_name: String,
              value: String
            }
          )
        ...
        module IfExpression
          ...
          sig do
            override.returns(
              T::Array[HubSpotSDK::Cms::IfString::IfExpression::Variants]
            )
          end
          def self.variants
          end
        ...
        module ElseExpression
          ...
          sig do
            override.returns(
              T::Array[HubSpotSDK::Cms::IfString::ElseExpression::Variants]
            )
          end
          def self.variants
          end
        ...
        module Input
          ...
          sig do
            override.returns(
              T::Array[HubSpotSDK::Cms::IfString::Input::Variants]
            )
          end
          def self.variants
          end
