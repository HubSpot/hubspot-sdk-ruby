    ...
    module Cms
      class BatchResponsePropertyWithErrors < HubspotSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              HubspotSDK::Cms::BatchResponsePropertyWithErrors,
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                HubspotSDK::Cms::BatchResponsePropertyWithErrors::Status
              )
            end
          ...
          PENDING =
            T.let(
              :PENDING,
              HubspotSDK::Cms::BatchResponsePropertyWithErrors::Status::TaggedSymbol
            )
          PROCESSING =
            T.let(
              :PROCESSING,
