  ...
  module Models
    module Cms
      class MinNumbers < HubSpotSDK::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(T::Array[HubSpotSDK::Cms::MinNumbers::Input::Variants])
          )
        end
        attr_reader :inputs
          ...
          override.returns(
            {
              ...
              inputs: T::Array[HubSpotSDK::Cms::MinNumbers::Input::Variants],
              property_name: String,
              value: Float
            }
          )
        ...
        module Input
          ...
          sig do
            override.returns(
              T::Array[HubSpotSDK::Cms::MinNumbers::Input::Variants]
            )
          end
          def self.variants
          end
