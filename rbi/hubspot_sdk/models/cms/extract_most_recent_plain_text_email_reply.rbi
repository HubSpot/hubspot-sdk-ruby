  ...
  module Models
    module Cms
      class ExtractMostRecentPlainTextEmailReply < HubSpotSDK::Internal::Type::BaseModel
        ...
        sig do
          returns(
            HubSpotSDK::Cms::ExtractMostRecentPlainTextEmailReply::Operator::TaggedSymbol
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                HubSpotSDK::Cms::ExtractMostRecentPlainTextEmailReply::Input::Variants
              ]
            )
          )
        end
        ...
        sig do
          params(
            operator:
              HubSpotSDK::Cms::ExtractMostRecentPlainTextEmailReply::Operator::OrSymbol,
            inputs:
              T::Array[
                T.any(
                  HubSpotSDK::Cms::ConstantBoolean::OrHash,
        ...
        module Operator
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                HubSpotSDK::Cms::ExtractMostRecentPlainTextEmailReply::Operator
              )
            end
