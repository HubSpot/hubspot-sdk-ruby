  ...
  module Models
    module Cms
      class SubtractTime < HubspotSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(HubspotSDK::Cms::SubtractTime, HubspotSDK::Internal::AnyHash)
          end

        sig { returns(HubspotSDK::Cms::SubtractTime::Operator::TaggedSymbol) }
        attr_accessor :operator

        sig { returns(HubspotSDK::Cms::SubtractTime::StringToCheck::Variants) }
        attr_accessor :string_to_check

        sig do
          returns(
            T.nilable(T::Array[HubspotSDK::Cms::SubtractTime::Input::Variants])
          )
        end
        attr_reader :inputs
        ...
        sig do
          params(
            operator: HubspotSDK::Cms::SubtractTime::Operator::OrSymbol,
            string_to_check:
              T.any(
                HubspotSDK::Cms::ConstantBoolean::OrHash,
                HubspotSDK::Cms::ConstantNumber::OrHash,
        ...
        sig do
          override.returns(
            {
              operator: HubspotSDK::Cms::SubtractTime::Operator::TaggedSymbol,
              string_to_check:
                HubspotSDK::Cms::SubtractTime::StringToCheck::Variants,
              inputs: T::Array[HubspotSDK::Cms::SubtractTime::Input::Variants],
              property_name: String,
              value: Float
            }
          )
        ...
        module Operator
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, HubspotSDK::Cms::SubtractTime::Operator)
            end
          ...
          SUBTRACT_TIME =
            T.let(
              :SUBTRACT_TIME,
              HubspotSDK::Cms::SubtractTime::Operator::TaggedSymbol
            )

          sig do
            override.returns(
              T::Array[HubspotSDK::Cms::SubtractTime::Operator::TaggedSymbol]
            )
          end
          def self.values
          end
        ...
        module StringToCheck
          ...
          sig do
            override.returns(
              T::Array[HubspotSDK::Cms::SubtractTime::StringToCheck::Variants]
            )
          end
          def self.variants
          end
        ...
        module Input
          ...
          sig do
            override.returns(
              T::Array[HubspotSDK::Cms::SubtractTime::Input::Variants]
            )
          end
          def self.variants
          end
