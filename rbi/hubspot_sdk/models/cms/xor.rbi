  ...
  module Models
    module Cms
      class Xor < HubSpotSDK::Internal::Type::BaseModel
        ...
        sig { returns(HubSpotSDK::Cms::Xor::Operator::TaggedSymbol) }
        attr_accessor :operator

        sig do
          returns(T.nilable(T::Array[HubSpotSDK::Cms::Xor::Input::Variants]))
        end
        attr_reader :inputs
        ...
        sig do
          override.returns(
            {
              enclosed_in_parentheses: T::Boolean,
              operator: HubSpotSDK::Cms::Xor::Operator::TaggedSymbol,
              inputs: T::Array[HubSpotSDK::Cms::Xor::Input::Variants],
              property_name: String,
              value: T::Boolean
            }
          )
        ...
        module Input
          ...
          sig do
            override.returns(T::Array[HubSpotSDK::Cms::Xor::Input::Variants])
          end
          def self.variants
          end
        end
