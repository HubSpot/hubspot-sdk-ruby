  ...
  module Models
    module Cms
      class ExtractMostRecentEmailReplyText < HubspotSDK::Internal::Type::BaseModel
        ...
        sig do
          returns(
            HubspotSDK::Cms::ExtractMostRecentEmailReplyText::Operator::TaggedSymbol
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                HubspotSDK::Cms::ExtractMostRecentEmailReplyText::Input::Variants
              ]
            )
          )
        end
        ...
        sig do
          params(
            operator:
              HubspotSDK::Cms::ExtractMostRecentEmailReplyText::Operator::OrSymbol,
            inputs:
              T::Array[
                T.any(
                  HubspotSDK::Cms::ConstantBoolean,
        ...
        module Operator
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                HubspotSDK::Cms::ExtractMostRecentEmailReplyText::Operator
              )
            end
