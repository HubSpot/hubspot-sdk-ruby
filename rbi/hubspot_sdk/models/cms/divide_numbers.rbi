  ...
  module Models
    module Cms
      class DivideNumbers < HubSpotSDK::Internal::Type::BaseModel
        ...
        sig { returns(HubSpotSDK::Cms::DivideNumbers::Operator::TaggedSymbol) }
        attr_accessor :operator

        sig do
          returns(
            T.nilable(T::Array[HubSpotSDK::Cms::DivideNumbers::Input::Variants])
          )
        end
        attr_reader :inputs
        ...
        sig do
          override.returns(
            {
              enclosed_in_parentheses: T::Boolean,
              operator: HubSpotSDK::Cms::DivideNumbers::Operator::TaggedSymbol,
              inputs: T::Array[HubSpotSDK::Cms::DivideNumbers::Input::Variants],
              property_name: String,
              value: Float
            }
          )
        ...
        module Input
          ...
          sig do
            override.returns(
              T::Array[HubSpotSDK::Cms::DivideNumbers::Input::Variants]
            )
          end
          def self.variants
          end
