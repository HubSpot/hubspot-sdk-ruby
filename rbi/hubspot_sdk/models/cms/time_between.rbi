...
module HubSpotSDK
  module Models
    module Cms
      class TimeBetween < HubSpotSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(HubSpotSDK::Cms::TimeBetween, HubSpotSDK::Internal::AnyHash)
          end

        sig { returns(HubSpotSDK::Cms::TimeBetween::Operator::TaggedSymbol) }
        attr_accessor :operator

        sig do
          returns(
            T.nilable(T::Array[HubSpotSDK::Cms::TimeBetween::Input::Variants])
          )
        end
        attr_reader :inputs
        ...
        sig do
          params(
            operator: HubSpotSDK::Cms::TimeBetween::Operator::OrSymbol,
            inputs:
              T::Array[
                T.any(
                  HubSpotSDK::Cms::ConstantBoolean::OrHash,
        ...
        sig do
          override.returns(
            {
              operator: HubSpotSDK::Cms::TimeBetween::Operator::TaggedSymbol,
              inputs: T::Array[HubSpotSDK::Cms::TimeBetween::Input::Variants],
              property_name: String,
              value: Float
            }
          )
        ...
        module Operator
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, HubSpotSDK::Cms::TimeBetween::Operator)
            end
          ...
          TIME_BETWEEN =
            T.let(
              :TIME_BETWEEN,
              HubSpotSDK::Cms::TimeBetween::Operator::TaggedSymbol
            )

          sig do
            override.returns(
              T::Array[HubSpotSDK::Cms::TimeBetween::Operator::TaggedSymbol]
            )
          end
          def self.values
          end
        ...
        module Input
          ...
          sig do
            override.returns(
              T::Array[HubSpotSDK::Cms::TimeBetween::Input::Variants]
            )
          end
          def self.variants
          end
