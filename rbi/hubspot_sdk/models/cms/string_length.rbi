  ...
  module Models
    module Cms
      class StringLength < HubSpotSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(HubSpotSDK::Cms::StringLength, HubSpotSDK::Internal::AnyHash)
          end

        sig { returns(HubSpotSDK::Cms::StringLength::Operator::TaggedSymbol) }
        attr_accessor :operator

        sig do
          returns(
            T.nilable(T::Array[HubSpotSDK::Cms::StringLength::Input::Variants])
          )
        end
        attr_reader :inputs
        ...
        sig do
          params(
            operator: HubSpotSDK::Cms::StringLength::Operator::OrSymbol,
            inputs:
              T::Array[
                T.any(
                  HubSpotSDK::Cms::ConstantBoolean::OrHash,
        ...
        sig do
          override.returns(
            {
              operator: HubSpotSDK::Cms::StringLength::Operator::TaggedSymbol,
              inputs: T::Array[HubSpotSDK::Cms::StringLength::Input::Variants],
              property_name: String,
              value: Float
            }
          )
        ...
        module Operator
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, HubSpotSDK::Cms::StringLength::Operator)
            end
          ...
          STRING_LENGTH =
            T.let(
              :STRING_LENGTH,
              HubSpotSDK::Cms::StringLength::Operator::TaggedSymbol
            )

          sig do
            override.returns(
              T::Array[HubSpotSDK::Cms::StringLength::Operator::TaggedSymbol]
            )
          end
          def self.values
          end
        ...
        module Input
          ...
          sig do
            override.returns(
              T::Array[HubSpotSDK::Cms::StringLength::Input::Variants]
            )
          end
          def self.variants
          end
