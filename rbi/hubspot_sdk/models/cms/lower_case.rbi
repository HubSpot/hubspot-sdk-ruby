  ...
  module Models
    module Cms
      class LowerCase < HubSpotSDK::Internal::Type::BaseModel
        ...
        sig { returns(HubSpotSDK::Cms::LowerCase::Operator::TaggedSymbol) }
        attr_accessor :operator

        sig do
          returns(
            T.nilable(T::Array[HubSpotSDK::Cms::LowerCase::Input::Variants])
          )
        end
        attr_reader :inputs
        ...
        sig do
          override.returns(
            {
              operator: HubSpotSDK::Cms::LowerCase::Operator::TaggedSymbol,
              inputs: T::Array[HubSpotSDK::Cms::LowerCase::Input::Variants],
              property_name: String,
              value: String
            }
          )
        ...
        module Input
          ...
          sig do
            override.returns(
              T::Array[HubSpotSDK::Cms::LowerCase::Input::Variants]
            )
          end
          def self.variants
          end
