  ...
  module Models
    module Cms
      class UpperCase < HubSpotSDK::Internal::Type::BaseModel
        ...
        sig { returns(HubSpotSDK::Cms::UpperCase::Operator::TaggedSymbol) }
        attr_accessor :operator

        sig do
          returns(
            T.nilable(T::Array[HubSpotSDK::Cms::UpperCase::Input::Variants])
          )
        end
        attr_reader :inputs
        ...
        sig do
          override.returns(
            {
              operator: HubSpotSDK::Cms::UpperCase::Operator::TaggedSymbol,
              inputs: T::Array[HubSpotSDK::Cms::UpperCase::Input::Variants],
              property_name: String,
              value: String
            }
          )
        ...
        module Input
          ...
          sig do
            override.returns(
              T::Array[HubSpotSDK::Cms::UpperCase::Input::Variants]
            )
          end
          def self.variants
          end
