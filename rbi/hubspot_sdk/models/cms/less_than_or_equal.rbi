  ...
  module Models
    module Cms
      class LessThanOrEqual < HubSpotSDK::Internal::Type::BaseModel
        ...
        sig { returns(HubSpotSDK::Cms::LessThanOrEqual::Operator::OrSymbol) }
        ...
        sig do
          params(
            operator: HubSpotSDK::Cms::LessThanOrEqual::Operator::OrSymbol,
            inputs:
              T::Array[
                T.any(
                  HubSpotSDK::Cms::ConstantBoolean::OrHash,
        ...
        module Operator
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, HubSpotSDK::Cms::LessThanOrEqual::Operator)
            end
          ...
          LESS_THAN_OR_EQUAL =
            T.let(
              :LESS_THAN_OR_EQUAL,
              HubSpotSDK::Cms::LessThanOrEqual::Operator::TaggedSymbol
            )

          sig do
            override.returns(
              T::Array[HubSpotSDK::Cms::LessThanOrEqual::Operator::TaggedSymbol]
            )
          end
          def self.values
          end
        ...
        module Input
          ...
          sig do
            override.returns(
              T::Array[HubSpotSDK::Cms::LessThanOrEqual::Input::Variants]
            )
          end
          def self.variants
          end
