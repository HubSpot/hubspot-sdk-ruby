  ...
  module Models
    module Cms
      class IsBlank < HubSpotSDK::Internal::Type::BaseModel
        ...
        sig { returns(HubSpotSDK::Cms::IsBlank::Operator::TaggedSymbol) }
        attr_accessor :operator

        sig do
          returns(
            T.nilable(T::Array[HubSpotSDK::Cms::IsBlank::Input::Variants])
          )
        end
        attr_reader :inputs
        ...
        sig do
          override.returns(
            {
              operator: HubSpotSDK::Cms::IsBlank::Operator::TaggedSymbol,
              inputs: T::Array[HubSpotSDK::Cms::IsBlank::Input::Variants],
              property_name: String,
              value: T::Boolean
            }
          )
        ...
        module Input
          ...
          sig do
            override.returns(
              T::Array[HubSpotSDK::Cms::IsBlank::Input::Variants]
            )
          end
          def self.variants
          end
