  ...
  module Models
    module Cms
      class CreateAudioObjectRequest < HubspotSDK::Internal::Type::BaseModel
        ...
        sig do
          returns(
            HubspotSDK::Cms::CreateAudioObjectRequest::MediaType::OrSymbol
          )
        end
        ...
        module MediaType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                HubspotSDK::Cms::CreateAudioObjectRequest::MediaType
              )
            end
          ...
          AUDIO =
            T.let(
              :AUDIO,
              HubspotSDK::Cms::CreateAudioObjectRequest::MediaType::TaggedSymbol
            )
