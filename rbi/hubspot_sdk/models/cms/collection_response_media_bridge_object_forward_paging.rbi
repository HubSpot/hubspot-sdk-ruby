    ...
    module Cms
      class CollectionResponseMediaBridgeObjectForwardPaging < HubspotSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              HubspotSDK::Cms::CollectionResponseMediaBridgeObjectForwardPaging,
              HubspotSDK::Internal::AnyHash
            )
          end

        sig { returns(T::Array[HubspotSDK::Cms::MediaBridgeObject]) }
        ...
        sig do
          params(
            results: T::Array[HubspotSDK::Cms::MediaBridgeObject::OrHash],
        ...
        sig do
          override.returns(
            {
              results: T::Array[HubspotSDK::Cms::MediaBridgeObject],
