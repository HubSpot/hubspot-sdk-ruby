  ...
  module Models
    module Cms
      class AbsoluteValue < HubSpotSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(HubSpotSDK::Cms::AbsoluteValue, HubSpotSDK::Internal::AnyHash)
          end

        sig { returns(HubSpotSDK::Cms::AbsoluteValue::Operator::TaggedSymbol) }
        attr_accessor :operator

        sig do
          returns(
            T.nilable(T::Array[HubSpotSDK::Cms::AbsoluteValue::Input::Variants])
          )
        end
        attr_reader :inputs
        ...
        sig do
          params(
            operator: HubSpotSDK::Cms::AbsoluteValue::Operator::OrSymbol,
            inputs:
              T::Array[
                T.any(
                  HubSpotSDK::Cms::ConstantBoolean::OrHash,
        ...
        sig do
          override.returns(
            {
              operator: HubSpotSDK::Cms::AbsoluteValue::Operator::TaggedSymbol,
              inputs: T::Array[HubSpotSDK::Cms::AbsoluteValue::Input::Variants],
              property_name: String,
              value: Float
            }
          )
        ...
        module Operator
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, HubSpotSDK::Cms::AbsoluteValue::Operator)
            end
          ...
          ABSOLUTE_VALUE =
            T.let(
              :ABSOLUTE_VALUE,
              HubSpotSDK::Cms::AbsoluteValue::Operator::TaggedSymbol
            )

          sig do
            override.returns(
              T::Array[HubSpotSDK::Cms::AbsoluteValue::Operator::TaggedSymbol]
            )
          end
          def self.values
          end
        ...
        module Input
          ...
          sig do
            override.returns(
              T::Array[HubSpotSDK::Cms::AbsoluteValue::Input::Variants]
            )
          end
          def self.variants
          end
