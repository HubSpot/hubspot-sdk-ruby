  ...
  module Models
    module Cms
      class LessThan < HubspotSDK::Internal::Type::BaseModel
        ...
        sig { returns(HubspotSDK::Cms::LessThan::Operator::TaggedSymbol) }
        attr_accessor :operator

        sig do
          returns(
            T.nilable(T::Array[HubspotSDK::Cms::LessThan::Input::Variants])
          )
        end
        attr_reader :inputs
        ...
        sig do
          override.returns(
            {
              operator: HubspotSDK::Cms::LessThan::Operator::TaggedSymbol,
              inputs: T::Array[HubspotSDK::Cms::LessThan::Input::Variants],
              property_name: String,
              value: T::Boolean
            }
          )
        ...
        module Input
          ...
          sig do
            override.returns(
              T::Array[HubspotSDK::Cms::LessThan::Input::Variants]
            )
          end
          def self.variants
          end
