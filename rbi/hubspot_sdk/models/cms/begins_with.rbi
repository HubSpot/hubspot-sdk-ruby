  ...
  module Models
    module Cms
      class BeginsWith < HubspotSDK::Internal::Type::BaseModel
        ...
        sig { returns(HubspotSDK::Cms::BeginsWith::StringToCheck::Variants) }
        attr_accessor :string_to_check

        sig do
          returns(
            T.nilable(T::Array[HubspotSDK::Cms::BeginsWith::Input::Variants])
          )
        end
        attr_reader :inputs
          ...
          override.returns(
            {
              ...
              string_to_check:
                HubspotSDK::Cms::BeginsWith::StringToCheck::Variants,
              inputs: T::Array[HubspotSDK::Cms::BeginsWith::Input::Variants],
              property_name: String,
              value: T::Boolean
            }
          )
        ...
        module StringToCheck
          ...
          sig do
            override.returns(
              T::Array[HubspotSDK::Cms::BeginsWith::StringToCheck::Variants]
            )
          end
          def self.variants
          end
        ...
        module Input
          ...
          sig do
            override.returns(
              T::Array[HubspotSDK::Cms::BeginsWith::Input::Variants]
            )
          end
          def self.variants
          end
