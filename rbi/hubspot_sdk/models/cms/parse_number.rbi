  ...
  module Models
    module Cms
      class ParseNumber < HubSpotSDK::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(T::Array[HubSpotSDK::Cms::ParseNumber::Input::Variants])
          )
        end
        attr_reader :inputs
          ...
          override.returns(
            {
              ...
              inputs: T::Array[HubSpotSDK::Cms::ParseNumber::Input::Variants],
              property_name: String,
              value: Float
            }
          )
        ...
        module Input
          ...
          sig do
            override.returns(
              T::Array[HubSpotSDK::Cms::ParseNumber::Input::Variants]
            )
          end
          def self.variants
          end
