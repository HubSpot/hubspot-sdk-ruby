  ...
  module Models
    module Cms
      class Or < HubspotSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(HubspotSDK::Cms::Or, HubspotSDK::Internal::AnyHash)
          end

        sig { returns(T::Boolean) }
        attr_accessor :enclosed_in_parentheses

        sig { returns(HubspotSDK::Cms::Or::Operator::TaggedSymbol) }
        attr_accessor :operator

        sig do
          returns(T.nilable(T::Array[HubspotSDK::Cms::Or::Input::Variants]))
        end
        attr_reader :inputs
        ...
        sig do
          params(
            ...
            operator: HubspotSDK::Cms::Or::Operator::OrSymbol,
            inputs:
              T::Array[
                T.any(
                  HubspotSDK::Cms::ConstantBoolean,
        ...
        sig do
          override.returns(
            {
              enclosed_in_parentheses: T::Boolean,
              operator: HubspotSDK::Cms::Or::Operator::TaggedSymbol,
              inputs: T::Array[HubspotSDK::Cms::Or::Input::Variants],
              property_name: String,
              value: T::Boolean
            }
          )
        ...
        module Operator
          ...
          TaggedSymbol =
            T.type_alias { T.all(Symbol, HubspotSDK::Cms::Or::Operator) }
          OrSymbol = T.type_alias { T.any(Symbol, String) }

          OR = T.let(:OR, HubspotSDK::Cms::Or::Operator::TaggedSymbol)

          sig do
            override.returns(
              T::Array[HubspotSDK::Cms::Or::Operator::TaggedSymbol]
            )
          end
          def self.values
          end
        ...
        module Input
          ...
          sig do
            override.returns(T::Array[HubspotSDK::Cms::Or::Input::Variants])
          end
          def self.variants
          end
        end
