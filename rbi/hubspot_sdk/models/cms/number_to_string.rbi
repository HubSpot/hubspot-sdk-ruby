    ...
    module Cms
      class NumberToString < HubSpotSDK::Internal::Type::BaseModel
        ...
        module Operator
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, HubSpotSDK::Cms::NumberToString::Operator)
            end
          ...
          NUMBER_TO_STRING =
            T.let(
              :NUMBER_TO_STRING,
              HubSpotSDK::Cms::NumberToString::Operator::TaggedSymbol
            )

          sig do
            override.returns(
              T::Array[HubSpotSDK::Cms::NumberToString::Operator::TaggedSymbol]
            )
          end
          def self.values
          end
        ...
        module Input
          ...
          sig do
            override.returns(
              T::Array[HubSpotSDK::Cms::NumberToString::Input::Variants]
            )
          end
          def self.variants
          end
