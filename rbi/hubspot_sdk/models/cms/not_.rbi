  ...
  module Models
    module Cms
      class Not < HubSpotSDK::Internal::Type::BaseModel
        ...
        sig { returns(HubSpotSDK::Cms::Not::Operator::TaggedSymbol) }
        attr_accessor :operator

        sig do
          returns(T.nilable(T::Array[HubSpotSDK::Cms::Not::Input::Variants]))
        end
        attr_reader :inputs
        ...
        sig do
          override.returns(
            {
              operator: HubSpotSDK::Cms::Not::Operator::TaggedSymbol,
              inputs: T::Array[HubSpotSDK::Cms::Not::Input::Variants],
              property_name: String,
              value: T::Boolean
            }
          )
        ...
        module Input
          ...
          sig do
            override.returns(T::Array[HubSpotSDK::Cms::Not::Input::Variants])
          end
          def self.variants
          end
        end
