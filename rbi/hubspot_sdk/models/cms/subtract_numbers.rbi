...
module HubSpotSDK
  module Models
    module Cms
      class SubtractNumbers < HubSpotSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
        ...
        sig do
          returns(HubSpotSDK::Cms::SubtractNumbers::Operator::TaggedSymbol)
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[HubSpotSDK::Cms::SubtractNumbers::Input::Variants]
            )
          )
        end
        attr_reader :inputs
        ...
        sig do
          params(
            ...
            operator: HubSpotSDK::Cms::SubtractNumbers::Operator::OrSymbol,
            inputs:
              T::Array[
                T.any(
                  HubSpotSDK::Cms::ConstantBoolean::OrHash,
          ...
          override.returns(
            {
              enclosed_in_parentheses: T::Boolean,
              operator:
                HubSpotSDK::Cms::SubtractNumbers::Operator::TaggedSymbol,
              inputs:
                T::Array[HubSpotSDK::Cms::SubtractNumbers::Input::Variants],
              property_name: String,
              value: Float
        ...
        module Operator
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, HubSpotSDK::Cms::SubtractNumbers::Operator)
            end
          ...
          sig do
            override.returns(
              T::Array[HubSpotSDK::Cms::SubtractNumbers::Operator::TaggedSymbol]
            )
          end
          def self.values
          end
