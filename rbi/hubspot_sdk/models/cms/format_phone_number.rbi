  ...
  module Models
    module Cms
      class FormatPhoneNumber < HubspotSDK::Internal::Type::BaseModel
        ...
        sig do
          returns(HubspotSDK::Cms::FormatPhoneNumber::Operator::TaggedSymbol)
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[HubspotSDK::Cms::FormatPhoneNumber::Input::Variants]
            )
          )
        end
        attr_reader :inputs
        ...
        sig do
          params(
            operator: HubspotSDK::Cms::FormatPhoneNumber::Operator::OrSymbol,
            inputs:
              T::Array[
                T.any(
                  HubspotSDK::Cms::ConstantBoolean::OrHash,
        ...
        sig do
          override.returns(
            {
              operator:
                HubspotSDK::Cms::FormatPhoneNumber::Operator::TaggedSymbol,
              inputs:
                T::Array[HubspotSDK::Cms::FormatPhoneNumber::Input::Variants],
              property_name: String,
              value: String
        ...
        module Operator
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, HubspotSDK::Cms::FormatPhoneNumber::Operator)
            end
