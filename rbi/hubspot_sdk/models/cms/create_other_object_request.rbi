  ...
  module Models
    module Cms
      class CreateOtherObjectRequest < HubspotSDK::Internal::Type::BaseModel
        ...
        sig do
          returns(
            HubspotSDK::Cms::CreateOtherObjectRequest::MediaType::OrSymbol
          )
        end
        ...
        module MediaType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                HubspotSDK::Cms::CreateOtherObjectRequest::MediaType
              )
            end
          ...
          OTHER =
            T.let(
              :OTHER,
              HubspotSDK::Cms::CreateOtherObjectRequest::MediaType::TaggedSymbol
            )
