  ...
  module Models
    module Cms
      class HasEmailReply < HubspotSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(HubspotSDK::Cms::HasEmailReply, HubspotSDK::Internal::AnyHash)
          end

        sig { returns(HubspotSDK::Cms::HasEmailReply::Operator::TaggedSymbol) }
        attr_accessor :operator

        sig do
          returns(
            T.nilable(T::Array[HubspotSDK::Cms::HasEmailReply::Input::Variants])
          )
        end
        attr_reader :inputs
        ...
        sig do
          params(
            operator: HubspotSDK::Cms::HasEmailReply::Operator::OrSymbol,
            inputs:
              T::Array[
                T.any(
                  HubspotSDK::Cms::ConstantBoolean,
        ...
        sig do
          override.returns(
            {
              operator: HubspotSDK::Cms::HasEmailReply::Operator::TaggedSymbol,
              inputs: T::Array[HubspotSDK::Cms::HasEmailReply::Input::Variants],
              property_name: String,
              value: T::Boolean
            }
          )
        ...
        module Operator
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, HubspotSDK::Cms::HasEmailReply::Operator)
            end
          ...
          HAS_EMAIL_REPLY =
            T.let(
              :HAS_EMAIL_REPLY,
              HubspotSDK::Cms::HasEmailReply::Operator::TaggedSymbol
            )

          sig do
            override.returns(
              T::Array[HubspotSDK::Cms::HasEmailReply::Operator::TaggedSymbol]
            )
          end
          def self.values
          end
        ...
        module Input
          ...
          sig do
            override.returns(
              T::Array[HubspotSDK::Cms::HasEmailReply::Input::Variants]
            )
          end
          def self.variants
          end
