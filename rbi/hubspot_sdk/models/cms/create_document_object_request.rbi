  ...
  module Models
    module Cms
      class CreateDocumentObjectRequest < HubspotSDK::Internal::Type::BaseModel
        ...
        sig do
          returns(
            HubspotSDK::Cms::CreateDocumentObjectRequest::MediaType::OrSymbol
          )
        end
        ...
        module MediaType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                HubspotSDK::Cms::CreateDocumentObjectRequest::MediaType
              )
            end
          ...
          DOCUMENT =
            T.let(
              :DOCUMENT,
              HubspotSDK::Cms::CreateDocumentObjectRequest::MediaType::TaggedSymbol
            )
