  ...
  module Models
    module Cms
      class PeriodToWeeks < HubSpotSDK::Internal::Type::BaseModel
        ...
        sig { returns(HubSpotSDK::Cms::PeriodToWeeks::Operator::TaggedSymbol) }
        attr_accessor :operator

        sig do
          returns(
            T.nilable(T::Array[HubSpotSDK::Cms::PeriodToWeeks::Input::Variants])
          )
        end
        attr_reader :inputs
        ...
        sig do
          override.returns(
            {
              operator: HubSpotSDK::Cms::PeriodToWeeks::Operator::TaggedSymbol,
              inputs: T::Array[HubSpotSDK::Cms::PeriodToWeeks::Input::Variants],
              property_name: String,
              value: Float
            }
          )
        ...
        module Input
          ...
          sig do
            override.returns(
              T::Array[HubSpotSDK::Cms::PeriodToWeeks::Input::Variants]
            )
          end
          def self.variants
          end
