  ...
  module Models
    module Cms
      class AddTime < HubSpotSDK::Internal::Type::BaseModel
        ...
        sig { returns(HubSpotSDK::Cms::AddTime::StringToCheck::Variants) }
        attr_accessor :string_to_check

        sig do
          returns(
            T.nilable(T::Array[HubSpotSDK::Cms::AddTime::Input::Variants])
          )
        end
        attr_reader :inputs
          ...
          override.returns(
            {
              ...
              string_to_check:
                HubSpotSDK::Cms::AddTime::StringToCheck::Variants,
              inputs: T::Array[HubSpotSDK::Cms::AddTime::Input::Variants],
              property_name: String,
              value: Float
            }
          )
        ...
        module StringToCheck
          ...
          sig do
            override.returns(
              T::Array[HubSpotSDK::Cms::AddTime::StringToCheck::Variants]
            )
          end
          def self.variants
          end
        ...
        module Input
          ...
          sig do
            override.returns(
              T::Array[HubSpotSDK::Cms::AddTime::Input::Variants]
            )
          end
          def self.variants
          end
