  ...
  module Models
    module Cms
      class CreateImageObjectRequest < HubspotSDK::Internal::Type::BaseModel
        ...
        sig do
          returns(
            HubspotSDK::Cms::CreateImageObjectRequest::MediaType::OrSymbol
          )
        end
        ...
        module MediaType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                HubspotSDK::Cms::CreateImageObjectRequest::MediaType
              )
            end
          ...
          IMAGE =
            T.let(
              :IMAGE,
              HubspotSDK::Cms::CreateImageObjectRequest::MediaType::TaggedSymbol
            )
