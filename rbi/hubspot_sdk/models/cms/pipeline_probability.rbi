  ...
  module Models
    module Cms
      class PipelineProbability < HubSpotSDK::Internal::Type::BaseModel
        ...
        sig do
          returns(HubSpotSDK::Cms::PipelineProbability::Operator::OrSymbol)
        end
        ...
        sig do
          params(
            operator: HubSpotSDK::Cms::PipelineProbability::Operator::OrSymbol,
            inputs:
              T::Array[
                T.any(
                  HubSpotSDK::Cms::ConstantBoolean::OrHash,
        ...
        sig do
          override.returns(
            {
              operator:
                HubSpotSDK::Cms::PipelineProbability::Operator::OrSymbol,
              inputs:
                T::Array[
                  T.any(
                    HubSpotSDK::Cms::ConstantBoolean,
        ...
        module Operator
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, HubSpotSDK::Cms::PipelineProbability::Operator)
            end
          ...
          PIPELINE_PROBABILITY =
            T.let(
              :PIPELINE_PROBABILITY,
              HubSpotSDK::Cms::PipelineProbability::Operator::TaggedSymbol
            )
        ...
        module Input
          ...
          sig do
            override.returns(
              T::Array[HubSpotSDK::Cms::PipelineProbability::Input::Variants]
            )
          end
          def self.variants
          end
