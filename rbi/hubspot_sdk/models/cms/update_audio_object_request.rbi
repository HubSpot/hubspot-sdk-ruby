  ...
  module Models
    module Cms
      class UpdateAudioObjectRequest < HubspotSDK::Internal::Type::BaseModel
        ...
        sig do
          returns(
            HubspotSDK::Cms::UpdateAudioObjectRequest::MediaType::OrSymbol
          )
        end
        ...
        module MediaType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                HubspotSDK::Cms::UpdateAudioObjectRequest::MediaType
              )
            end
          ...
          AUDIO =
            T.let(
              :AUDIO,
              HubspotSDK::Cms::UpdateAudioObjectRequest::MediaType::TaggedSymbol
            )
