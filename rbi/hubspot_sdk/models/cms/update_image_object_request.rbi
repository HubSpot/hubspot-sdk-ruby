  ...
  module Models
    module Cms
      class UpdateImageObjectRequest < HubspotSDK::Internal::Type::BaseModel
        ...
        sig do
          returns(
            HubspotSDK::Cms::UpdateImageObjectRequest::MediaType::OrSymbol
          )
        end
        ...
        module MediaType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                HubspotSDK::Cms::UpdateImageObjectRequest::MediaType
              )
            end
          ...
          IMAGE =
            T.let(
              :IMAGE,
              HubspotSDK::Cms::UpdateImageObjectRequest::MediaType::TaggedSymbol
            )
