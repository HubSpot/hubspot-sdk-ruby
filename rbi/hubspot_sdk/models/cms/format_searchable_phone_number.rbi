  ...
  module Models
    module Cms
      class FormatSearchablePhoneNumber < HubSpotSDK::Internal::Type::BaseModel
        ...
        sig do
          returns(
            HubSpotSDK::Cms::FormatSearchablePhoneNumber::Operator::TaggedSymbol
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                HubSpotSDK::Cms::FormatSearchablePhoneNumber::Input::Variants
              ]
            )
          )
        end
        ...
        sig do
          params(
            operator:
              HubSpotSDK::Cms::FormatSearchablePhoneNumber::Operator::OrSymbol,
            inputs:
              T::Array[
                T.any(
                  HubSpotSDK::Cms::ConstantBoolean::OrHash,
        ...
        module Operator
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                HubSpotSDK::Cms::FormatSearchablePhoneNumber::Operator
              )
            end
