    ...
    module Cms
      class MultiplyNumbers < HubSpotSDK::Internal::Type::BaseModel
        ...
        module Operator
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, HubSpotSDK::Cms::MultiplyNumbers::Operator)
            end
          ...
          sig do
            override.returns(
              T::Array[HubSpotSDK::Cms::MultiplyNumbers::Operator::TaggedSymbol]
            )
          end
          def self.values
          end
        ...
        module Input
          ...
          sig do
            override.returns(
              T::Array[HubSpotSDK::Cms::MultiplyNumbers::Input::Variants]
            )
          end
          def self.variants
          end
