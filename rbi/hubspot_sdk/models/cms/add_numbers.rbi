  ...
  module Models
    module Cms
      class AddNumbers < HubspotSDK::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(T::Array[HubspotSDK::Cms::AddNumbers::Input::Variants])
          )
        end
        attr_reader :inputs
          ...
          override.returns(
            {
              ...
              inputs: T::Array[HubspotSDK::Cms::AddNumbers::Input::Variants],
              property_name: String,
              value: Float
            }
          )
        ...
        module Input
          ...
          sig do
            override.returns(
              T::Array[HubspotSDK::Cms::AddNumbers::Input::Variants]
            )
          end
          def self.variants
          end
