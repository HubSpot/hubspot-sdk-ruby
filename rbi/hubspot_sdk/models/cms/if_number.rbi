  ...
  module Models
    module Cms
      class IfNumber < HubspotSDK::Internal::Type::BaseModel
        ...
        sig { returns(HubspotSDK::Cms::IfNumber::IfExpression::Variants) }
        ...
        sig do
          returns(
            T.nilable(HubspotSDK::Cms::IfNumber::ElseExpression::Variants)
          )
        end
        ...
        sig do
          returns(
            T.nilable(T::Array[HubspotSDK::Cms::IfNumber::Input::Variants])
          )
        end
        attr_reader :inputs
        ...
        sig do
          override.returns(
            {
              enclosed_in_parentheses: T::Boolean,
              if_expression: HubspotSDK::Cms::IfNumber::IfExpression::Variants,
              operator: HubspotSDK::Cms::IfNumber::Operator::TaggedSymbol,
              else_expression:
                HubspotSDK::Cms::IfNumber::ElseExpression::Variants,
              inputs: T::Array[HubspotSDK::Cms::IfNumber::Input::Variants],
              property_name: String,
              value: Float
            }
          )
        ...
        module IfExpression
          ...
          sig do
            override.returns(
              T::Array[HubspotSDK::Cms::IfNumber::IfExpression::Variants]
            )
          end
          def self.variants
          end
        ...
        module ElseExpression
          ...
          sig do
            override.returns(
              T::Array[HubspotSDK::Cms::IfNumber::ElseExpression::Variants]
            )
          end
          def self.variants
          end
        ...
        module Input
          ...
          sig do
            override.returns(
              T::Array[HubspotSDK::Cms::IfNumber::Input::Variants]
            )
          end
          def self.variants
          end
