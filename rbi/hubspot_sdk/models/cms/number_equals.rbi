  ...
  module Models
    module Cms
      class NumberEquals < HubSpotSDK::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(T::Array[HubSpotSDK::Cms::NumberEquals::Input::Variants])
          )
        end
        attr_reader :inputs
          ...
          override.returns(
            {
              ...
              inputs: T::Array[HubSpotSDK::Cms::NumberEquals::Input::Variants],
              property_name: String,
              value: T::Boolean
            }
          )
        ...
        module Input
          ...
          sig do
            override.returns(
              T::Array[HubSpotSDK::Cms::NumberEquals::Input::Variants]
            )
          end
          def self.variants
          end
