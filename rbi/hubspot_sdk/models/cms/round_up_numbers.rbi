  ...
  module Models
    module Cms
      class RoundUpNumbers < HubSpotSDK::Internal::Type::BaseModel
        ...
        sig { returns(HubSpotSDK::Cms::RoundUpNumbers::Operator::TaggedSymbol) }
        attr_accessor :operator

        sig do
          returns(
            T.nilable(
              T::Array[HubSpotSDK::Cms::RoundUpNumbers::Input::Variants]
            )
          )
        end
        attr_reader :inputs
        ...
        sig do
          override.returns(
            {
              operator: HubSpotSDK::Cms::RoundUpNumbers::Operator::TaggedSymbol,
              inputs:
                T::Array[HubSpotSDK::Cms::RoundUpNumbers::Input::Variants],
              property_name: String,
              value: Float
