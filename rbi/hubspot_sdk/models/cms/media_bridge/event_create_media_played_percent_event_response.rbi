    ...
    module Cms
      module MediaBridge
        class EventCreateMediaPlayedPercentEventResponse < HubspotSDK::Internal::Type::BaseModel
          ...
          sig do
            returns(
              HubspotSDK::Models::Cms::MediaBridge::EventCreateMediaPlayedPercentEventResponse::MediaType::TaggedSymbol
            )
          end
          ...
          sig do
            params(
              ...
              media_name: String,
              media_type:
                HubspotSDK::Models::Cms::MediaBridge::EventCreateMediaPlayedPercentEventResponse::MediaType::OrSymbol,
          ...
          module MediaType
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  HubspotSDK::Models::Cms::MediaBridge::EventCreateMediaPlayedPercentEventResponse::MediaType
                )
              end
