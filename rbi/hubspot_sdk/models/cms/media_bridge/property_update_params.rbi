      ...
      module MediaBridge
        class PropertyUpdateParams < HubspotSDK::Internal::Type::BaseModel
          ...
          OrHash =
            T.type_alias do
              T.any(
                HubspotSDK::Cms::MediaBridge::PropertyUpdateParams,
          ...
          module FieldType
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  HubspotSDK::Cms::MediaBridge::PropertyUpdateParams::FieldType
                )
              end
            ...
            BOOLEANCHECKBOX =
              T.let(
                :booleancheckbox,
                HubspotSDK::Cms::MediaBridge::PropertyUpdateParams::FieldType::TaggedSymbol
              )
          ...
          module Type
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  HubspotSDK::Cms::MediaBridge::PropertyUpdateParams::Type
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            BOOL =
              T.let(
                :bool,
                HubspotSDK::Cms::MediaBridge::PropertyUpdateParams::Type::TaggedSymbol
              )
            DATE =
              T.let(
                :date,
