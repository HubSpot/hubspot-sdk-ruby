    ...
    module Cms
      module MediaBridge
        class EventCreateMediaPlayedEventResponse < HubspotSDK::Internal::Type::BaseModel
          ...
          sig do
            returns(
              HubspotSDK::Models::Cms::MediaBridge::EventCreateMediaPlayedEventResponse::MediaType::TaggedSymbol
            )
          end
          ...
          sig do
            returns(
              HubspotSDK::Models::Cms::MediaBridge::EventCreateMediaPlayedEventResponse::State::TaggedSymbol
            )
          end
          attr_accessor :state
          ...
          sig do
            params(
              ...
              media_name: String,
              media_type:
                HubspotSDK::Models::Cms::MediaBridge::EventCreateMediaPlayedEventResponse::MediaType::OrSymbol,
              occurred_timestamp: Integer,
              portal_id: Integer,
              provider_id: Integer,
              session_id: String,
              state:
                HubspotSDK::Models::Cms::MediaBridge::EventCreateMediaPlayedEventResponse::State::OrSymbol,
              iframe_url: String,
              media_url: String,
              page_id: Integer,
              page_name: String,
          ...
          module MediaType
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  HubspotSDK::Models::Cms::MediaBridge::EventCreateMediaPlayedEventResponse::MediaType
                )
              end
          ...
          module State
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  HubspotSDK::Models::Cms::MediaBridge::EventCreateMediaPlayedEventResponse::State
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
