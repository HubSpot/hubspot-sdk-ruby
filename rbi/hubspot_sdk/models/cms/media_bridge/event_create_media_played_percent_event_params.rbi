      ...
      module MediaBridge
        class EventCreateMediaPlayedPercentEventParams < HubspotSDK::Internal::Type::BaseModel
          ...
          OrHash =
            T.type_alias do
              T.any(
                HubspotSDK::Cms::MediaBridge::EventCreateMediaPlayedPercentEventParams,
          ...
          module MediaType
            ...
            VIDEO =
              T.let(
                :VIDEO,
                HubspotSDK::Cms::MediaBridge::EventCreateMediaPlayedPercentEventParams::MediaType::TaggedSymbol
              )
            AUDIO =
              T.let(
                :AUDIO,
