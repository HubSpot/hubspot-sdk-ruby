  ...
  module Models
    module Cms
      class Month < HubSpotSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(HubSpotSDK::Cms::Month, HubSpotSDK::Internal::AnyHash)
          end

        sig { returns(HubSpotSDK::Cms::Month::Operator::TaggedSymbol) }
        attr_accessor :operator

        sig do
          returns(T.nilable(T::Array[HubSpotSDK::Cms::Month::Input::Variants]))
        end
        attr_reader :inputs
        ...
        sig do
          params(
            operator: HubSpotSDK::Cms::Month::Operator::OrSymbol,
            inputs:
              T::Array[
                T.any(
                  HubSpotSDK::Cms::ConstantBoolean::OrHash,
        ...
        sig do
          override.returns(
            {
              operator: HubSpotSDK::Cms::Month::Operator::TaggedSymbol,
              inputs: T::Array[HubSpotSDK::Cms::Month::Input::Variants],
              property_name: String,
              value: Float
            }
          )
        ...
        module Operator
          ...
          TaggedSymbol =
            T.type_alias { T.all(Symbol, HubSpotSDK::Cms::Month::Operator) }
          OrSymbol = T.type_alias { T.any(Symbol, String) }

          MONTH = T.let(:MONTH, HubSpotSDK::Cms::Month::Operator::TaggedSymbol)

          sig do
            override.returns(
              T::Array[HubSpotSDK::Cms::Month::Operator::TaggedSymbol]
            )
          end
          def self.values
          end
        ...
        module Input
          ...
          sig do
            override.returns(T::Array[HubSpotSDK::Cms::Month::Input::Variants])
          end
          def self.variants
          end
        end
