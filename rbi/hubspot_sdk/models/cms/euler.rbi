  ...
  module Models
    module Cms
      class Euler < HubspotSDK::Internal::Type::BaseModel
        ...
        sig do
          returns(T.nilable(T::Array[HubspotSDK::Cms::Euler::Input::Variants]))
        end
        attr_reader :inputs
          ...
          override.returns(
            {
              ...
              inputs: T::Array[HubspotSDK::Cms::Euler::Input::Variants],
              property_name: String,
              value: Float
            }
          )
        ...
        module Input
          ...
          sig do
            override.returns(T::Array[HubspotSDK::Cms::Euler::Input::Variants])
          end
          def self.variants
          end
        end
