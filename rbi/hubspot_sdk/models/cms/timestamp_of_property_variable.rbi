  ...
  module Models
    module Cms
      class TimestampOfPropertyVariable < HubspotSDK::Internal::Type::BaseModel
        ...
        sig do
          returns(
            HubspotSDK::Cms::TimestampOfPropertyVariable::Operator::TaggedSymbol
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                HubspotSDK::Cms::TimestampOfPropertyVariable::Input::Variants
              ]
            )
          )
        end
        ...
        sig do
          params(
            operator:
              HubspotSDK::Cms::TimestampOfPropertyVariable::Operator::OrSymbol,
            inputs:
              T::Array[
                T.any(
                  HubspotSDK::Cms::ConstantBoolean,
        ...
        module Operator
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                HubspotSDK::Cms::TimestampOfPropertyVariable::Operator
              )
            end
