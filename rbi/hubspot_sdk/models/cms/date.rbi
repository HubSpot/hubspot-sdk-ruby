  ...
  module Models
    module Cms
      class Date < HubspotSDK::Internal::Type::BaseModel
        ...
        sig { returns(HubspotSDK::Cms::Date::Operator::TaggedSymbol) }
        attr_accessor :operator

        sig do
          returns(T.nilable(T::Array[HubspotSDK::Cms::Date::Input::Variants]))
        end
        attr_reader :inputs
        ...
        sig do
          override.returns(
            {
              operator: HubspotSDK::Cms::Date::Operator::TaggedSymbol,
              inputs: T::Array[HubspotSDK::Cms::Date::Input::Variants],
              property_name: String,
              value: Float
            }
          )
        ...
        module Input
          ...
          sig do
            override.returns(T::Array[HubspotSDK::Cms::Date::Input::Variants])
          end
          def self.variants
          end
        end
