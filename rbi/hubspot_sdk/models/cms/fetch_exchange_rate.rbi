  ...
  module Models
    module Cms
      class FetchExchangeRate < HubspotSDK::Internal::Type::BaseModel
        ...
        sig do
          returns(HubspotSDK::Cms::FetchExchangeRate::Operator::TaggedSymbol)
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[HubspotSDK::Cms::FetchExchangeRate::Input::Variants]
            )
          )
        end
        attr_reader :inputs
        ...
        sig do
          params(
            operator: HubspotSDK::Cms::FetchExchangeRate::Operator::OrSymbol,
            inputs:
              T::Array[
                T.any(
                  HubspotSDK::Cms::ConstantBoolean::OrHash,
        ...
        sig do
          override.returns(
            {
              operator:
                HubspotSDK::Cms::FetchExchangeRate::Operator::TaggedSymbol,
              inputs:
                T::Array[HubspotSDK::Cms::FetchExchangeRate::Input::Variants],
              property_name: String,
              value: Float
        ...
        module Operator
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, HubspotSDK::Cms::FetchExchangeRate::Operator)
            end
