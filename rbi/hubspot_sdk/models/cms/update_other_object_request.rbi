  ...
  module Models
    module Cms
      class UpdateOtherObjectRequest < HubspotSDK::Internal::Type::BaseModel
        ...
        sig do
          returns(
            HubspotSDK::Cms::UpdateOtherObjectRequest::MediaType::OrSymbol
          )
        end
        ...
        module MediaType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                HubspotSDK::Cms::UpdateOtherObjectRequest::MediaType
              )
            end
          ...
          OTHER =
            T.let(
              :OTHER,
              HubspotSDK::Cms::UpdateOtherObjectRequest::MediaType::TaggedSymbol
            )
