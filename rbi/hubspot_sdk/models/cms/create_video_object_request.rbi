  ...
  module Models
    module Cms
      class CreateVideoObjectRequest < HubspotSDK::Internal::Type::BaseModel
        ...
        sig do
          returns(
            HubspotSDK::Cms::CreateVideoObjectRequest::MediaType::OrSymbol
          )
        end
        ...
        module MediaType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                HubspotSDK::Cms::CreateVideoObjectRequest::MediaType
              )
            end
          ...
          VIDEO =
            T.let(
              :VIDEO,
              HubspotSDK::Cms::CreateVideoObjectRequest::MediaType::TaggedSymbol
            )
