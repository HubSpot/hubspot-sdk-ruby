  ...
  module Models
    module Cms
      class ConcatStrings < HubSpotSDK::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(T::Array[HubSpotSDK::Cms::ConcatStrings::Input::Variants])
          )
        end
        attr_reader :inputs
          ...
          override.returns(
            {
              ...
              inputs: T::Array[HubSpotSDK::Cms::ConcatStrings::Input::Variants],
              property_name: String,
              value: String
            }
          )
        ...
        module Input
          ...
          sig do
            override.returns(
              T::Array[HubSpotSDK::Cms::ConcatStrings::Input::Variants]
            )
          end
          def self.variants
          end
