  ...
  module Models
    module Cms
      class MoreThan < HubspotSDK::Internal::Type::BaseModel
        ...
        sig { returns(HubspotSDK::Cms::MoreThan::Operator::TaggedSymbol) }
        attr_accessor :operator

        sig do
          returns(
            T.nilable(T::Array[HubspotSDK::Cms::MoreThan::Input::Variants])
          )
        end
        attr_reader :inputs
        ...
        sig do
          override.returns(
            {
              operator: HubspotSDK::Cms::MoreThan::Operator::TaggedSymbol,
              inputs: T::Array[HubspotSDK::Cms::MoreThan::Input::Variants],
              property_name: String,
              value: T::Boolean
            }
          )
        ...
        module Input
          ...
          sig do
            override.returns(
              T::Array[HubspotSDK::Cms::MoreThan::Input::Variants]
            )
          end
          def self.variants
          end
