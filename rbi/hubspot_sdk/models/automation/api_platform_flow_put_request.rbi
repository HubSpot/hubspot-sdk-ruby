  ...
  module Models
    module Automation
      class APIPlatformFlowPutRequest < HubspotSDK::Internal::Type::BaseModel
        ...
        sig do
          returns(
            HubspotSDK::Automation::APIPlatformFlowPutRequest::Type::OrSymbol
          )
        end
        attr_accessor :type
        ...
        module Action
          ...
          sig do
            override.returns(
              T::Array[
                HubspotSDK::Automation::APIPlatformFlowPutRequest::Action::Variants
              ]
            )
          end
          def self.variants
        ...
        module Type
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                HubspotSDK::Automation::APIPlatformFlowPutRequest::Type
              )
            end
          ...
          CONTACT_FLOW =
            T.let(
              :CONTACT_FLOW,
              HubspotSDK::Automation::APIPlatformFlowPutRequest::Type::TaggedSymbol
            )
          PLATFORM_FLOW =
            T.let(
              :PLATFORM_FLOW,
        ...
        module EnrollmentCriteria
          ...
          sig do
            override.returns(
              T::Array[
                HubspotSDK::Automation::APIPlatformFlowPutRequest::EnrollmentCriteria::Variants
              ]
            )
          end
          def self.variants
        ...
        module EnrollmentSchedule
          ...
          sig do
            override.returns(
              T::Array[
                HubspotSDK::Automation::APIPlatformFlowPutRequest::EnrollmentSchedule::Variants
              ]
            )
          end
          def self.variants
        ...
        module SuppressionFilterBranch
          ...
          sig do
            override.returns(
              T::Array[
                HubspotSDK::Automation::APIPlatformFlowPutRequest::SuppressionFilterBranch::Variants
              ]
            )
          end
          def self.variants
