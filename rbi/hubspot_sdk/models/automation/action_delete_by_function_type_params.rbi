    ...
    module Automation
      class ActionDeleteByFunctionTypeParams < HubspotSDK::Internal::Type::BaseModel
        ...
        OrHash =
          T.type_alias do
            T.any(
              HubspotSDK::Automation::ActionDeleteByFunctionTypeParams,
        ...
        module FunctionType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                HubspotSDK::Automation::ActionDeleteByFunctionTypeParams::FunctionType
              )
            end
          ...
          POST_ACTION_EXECUTION =
            T.let(
              :POST_ACTION_EXECUTION,
              HubspotSDK::Automation::ActionDeleteByFunctionTypeParams::FunctionType::TaggedSymbol
            )
          POST_FETCH_OPTIONS =
            T.let(
              :POST_FETCH_OPTIONS,
