  ...
  module Models
    module Automation
      class APIContactFlowCreateRequest < HubspotSDK::Internal::Type::BaseModel
        ...
        sig do
          returns(
            HubspotSDK::Automation::APIContactFlowCreateRequest::FlowType::OrSymbol
          )
        end
        ...
        sig do
          returns(
            HubspotSDK::Automation::APIContactFlowCreateRequest::Type::OrSymbol
          )
        end
        attr_accessor :type
        ...
        module Action
          ...
          sig do
            override.returns(
              T::Array[
                HubspotSDK::Automation::APIContactFlowCreateRequest::Action::Variants
              ]
            )
          end
          def self.variants
        ...
        module DataSource
          ...
          sig do
            override.returns(
              T::Array[
                HubspotSDK::Automation::APIContactFlowCreateRequest::DataSource::Variants
              ]
            )
          end
          def self.variants
        ...
        module FlowType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                HubspotSDK::Automation::APIContactFlowCreateRequest::FlowType
              )
            end
          ...
          WORKFLOW =
            T.let(
              :WORKFLOW,
              HubspotSDK::Automation::APIContactFlowCreateRequest::FlowType::TaggedSymbol
            )
          ACTION_SET =
            T.let(
              :ACTION_SET,
        ...
        module Type
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                HubspotSDK::Automation::APIContactFlowCreateRequest::Type
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          CONTACT_FLOW =
            T.let(
              :CONTACT_FLOW,
              HubspotSDK::Automation::APIContactFlowCreateRequest::Type::TaggedSymbol
            )
          PLATFORM_FLOW =
            T.let(
              :PLATFORM_FLOW,
        ...
        module EnrollmentCriteria
          ...
          sig do
            override.returns(
              T::Array[
                HubspotSDK::Automation::APIContactFlowCreateRequest::EnrollmentCriteria::Variants
              ]
            )
          end
          def self.variants
        ...
        module EnrollmentSchedule
          ...
          sig do
            override.returns(
              T::Array[
                HubspotSDK::Automation::APIContactFlowCreateRequest::EnrollmentSchedule::Variants
              ]
            )
          end
          def self.variants
        ...
        module EventAnchor
          ...
          sig do
            override.returns(
              T::Array[
                HubspotSDK::Automation::APIContactFlowCreateRequest::EventAnchor::Variants
              ]
            )
          end
          def self.variants
        ...
        module GoalFilterBranch
          ...
          sig do
            override.returns(
              T::Array[
                HubspotSDK::Automation::APIContactFlowCreateRequest::GoalFilterBranch::Variants
              ]
            )
          end
          def self.variants
