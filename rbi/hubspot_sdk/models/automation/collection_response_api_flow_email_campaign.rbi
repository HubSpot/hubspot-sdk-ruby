  ...
  module Models
    module Automation
      class CollectionResponseAPIFlowEmailCampaign < HubspotSDK::Internal::Type::BaseModel
        ...
        sig { returns(T::Array[HubspotSDK::Automation::APIFlowEmailCampaign]) }
        ...
        sig do
          params(
            results:
              T::Array[HubspotSDK::Automation::APIFlowEmailCampaign::OrHash],
        ...
        sig do
          override.returns(
            {
              results: T::Array[HubspotSDK::Automation::APIFlowEmailCampaign],
