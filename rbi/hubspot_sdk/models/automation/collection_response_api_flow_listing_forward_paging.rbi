    ...
    module Automation
      class CollectionResponseAPIFlowListingForwardPaging < HubspotSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              HubspotSDK::Automation::CollectionResponseAPIFlowListingForwardPaging,
              HubspotSDK::Internal::AnyHash
            )
          end

        sig { returns(T::Array[HubspotSDK::Automation::APIFlowListing]) }
        ...
        sig do
          params(
            results: T::Array[HubspotSDK::Automation::APIFlowListing::OrHash],
        ...
        sig do
          override.returns(
            {
              results: T::Array[HubspotSDK::Automation::APIFlowListing],
