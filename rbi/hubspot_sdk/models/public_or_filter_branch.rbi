...
module HubspotSDK
  module Models
    class PublicOrFilterBranch < HubspotSDK::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(HubspotSDK::PublicOrFilterBranch, HubspotSDK::Internal::AnyHash)
        end
      ...
      sig do
        returns(HubspotSDK::PublicOrFilterBranch::FilterBranchType::OrSymbol)
      end
      ...
      sig do
        params(
          ...
          filter_branch_type:
            HubspotSDK::PublicOrFilterBranch::FilterBranchType::OrSymbol,
          filters:
            T::Array[
              T.any(
      ...
      module FilterBranch
        ...
        sig do
          override.returns(
            T::Array[HubspotSDK::PublicOrFilterBranch::FilterBranch::Variants]
          )
        end
        def self.variants
        end
      ...
      module FilterBranchType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, HubspotSDK::PublicOrFilterBranch::FilterBranchType)
          end
        ...
        OR =
          T.let(
            :OR,
            HubspotSDK::PublicOrFilterBranch::FilterBranchType::TaggedSymbol
          )
      ...
      module Filter
        ...
        sig do
          override.returns(
            T::Array[HubspotSDK::PublicOrFilterBranch::Filter::Variants]
          )
        end
        def self.variants
        end
