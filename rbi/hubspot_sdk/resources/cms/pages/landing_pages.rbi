  ...
  module Resources
    class Cms
      class Pages
        class LandingPages
          sig do
            returns(HubSpotSDK::Resources::Cms::Pages::LandingPages::AbTest)
          end
          attr_reader :ab_test

          sig do
            returns(HubSpotSDK::Resources::Cms::Pages::LandingPages::Batch)
          end
          attr_reader :batch

          sig do
            returns(HubSpotSDK::Resources::Cms::Pages::LandingPages::Draft)
          end
          attr_reader :draft

          sig do
            returns(HubSpotSDK::Resources::Cms::Pages::LandingPages::Folders)
          end
          attr_reader :folders

          sig do
            returns(
              HubSpotSDK::Resources::Cms::Pages::LandingPages::MultiLanguage
            )
          end
          attr_reader :multi_language

          sig do
            returns(HubSpotSDK::Resources::Cms::Pages::LandingPages::Revisions)
          end
