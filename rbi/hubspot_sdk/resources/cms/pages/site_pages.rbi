...
module HubSpotSDK
  module Resources
    class Cms
      class Pages
        class SitePages
          sig { returns(HubSpotSDK::Resources::Cms::Pages::SitePages::AbTest) }
          attr_reader :ab_test

          sig { returns(HubSpotSDK::Resources::Cms::Pages::SitePages::Batch) }
          attr_reader :batch

          sig { returns(HubSpotSDK::Resources::Cms::Pages::SitePages::Draft) }
          attr_reader :draft

          sig do
            returns(HubSpotSDK::Resources::Cms::Pages::SitePages::MultiLanguage)
          end
          attr_reader :multi_language

          sig do
            returns(HubSpotSDK::Resources::Cms::Pages::SitePages::Revisions)
          end
